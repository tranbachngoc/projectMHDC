        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                if (AccessHelper::hasRouteAccess('extensions/upload')) {
                    echo CHtml::link(Yii::t('extensions', 'Upload extension'), '#extension-upload-modal', array('class' => 'btn btn-primary btn-xs', 'data-toggle' => 'modal', 'title' => Yii::t('extensions', 'Upload extension')));
                }
                ?>
                <?php echo HtmlHelper::accessLink(Yii::t('app', 'Refresh'), array('extensions/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
