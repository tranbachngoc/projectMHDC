...
class DeliveryServer extends ActiveRecord
{
    ...
    */
    ...
    public function getParamsArray(array $params = array())
    {
        ...
        if (empty($params['skipDetectInfoFromDeliveryObject']) && ($object = $this->getDeliveryObject())) {
            if (is_object($object) && $object instanceof Campaign) {
                $_fromName   = !empty($params['fromNameCustom']) ? $params['fromNameCustom'] : $object->from_name;
                $_fromEmail  = !empty($params['fromEmailCustom']) ? $params['fromEmailCustom'] : $object->from_email;
                $_replyEmail = !empty($params['replyToCustom']) ? $params['replyToCustom'] : $object->reply_to;
            ...
            if (is_object($object) && $object instanceof Lists && !empty($object->default)) {
                $_fromName   = !empty($params['fromNameCustom']) ? $params['fromNameCustom'] : $object->default->from_name;
                $_fromEmail  = !empty($params['fromEmailCustom']) ? $params['fromEmailCustom'] : $object->default->from_email;
                $_replyEmail = !empty($params['replyToCustom']) ? $params['replyToCustom'] : $object->default->reply_to;
