...
class OptionCommon extends OptionBase
{
    ...
    public $support_forum_url = MW_SUPPORT_FORUM_URL;
    ...
    {
        $rules = array(
            array('site_name, site_tagline, clean_urls, site_status, site_offline_message, api_status, backend_page_size, customer_page_size, default_mailer, show_backend_timeinfo, show_customer_timeinfo', 'required'),
            ...
            array('check_version_update, show_backend_timeinfo, show_customer_timeinfo', 'in', 'range' => array_keys($this->getYesNoOptions())),
            array('default_mailer', 'in', 'range' => array_keys($this->getSystemMailers())),
            array('company_info', 'safe'),
            array('support_forum_url', 'url'),
        );
    ...
    public function attributeLabels()
    {
        $labels = array(
            ...
            'support_forum_url'     => Yii::t('settings', 'Support forum url'),
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'support_forum_url'     => Yii::t('settings', 'Leave empty to disable the left side menu item for Support forum.'),
