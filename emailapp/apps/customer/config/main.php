    ...
    'components' => array(
        ...
        'urlManager' => array(
            'rules' => array(
                ...
                array('list_subscribers/<action>', 'pattern' => 'lists/<list_uid:([a-z0-9]+)>/subscribers/<subscriber_uid:([a-z0-9]+)>/<action:(update|subscribe|unsubscribe|delete|campaigns)>'),
                ...
                array('lists/export_all_subscribers', 'pattern' => 'lists/all-subscribers/export'),
