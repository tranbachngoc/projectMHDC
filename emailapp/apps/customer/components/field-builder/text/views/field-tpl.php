    ...
    <div class="panel panel-default no-top-border">
        ...
        <div class="panel-footer">
            <div class="pull-right">
                ...
                <a href="javascript:;" class="btn btn-danger btn-xs btn-remove-text-field" data-field-id="<?php echo (int)$model->field_id;?>" data-message="<?php echo Yii::t('list_fields', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.');?>"><?php echo Yii::t('app', 'Remove');?></a>
                <?php } ?>
            </div>
            <div class="clearfix"><!-- --></div>
        </div>    
