...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <span class="glyphicon glyphicon-tag"></span> <?php echo $pageHeading;?>
                </h3>
            </div>
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('campaign_tags/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
