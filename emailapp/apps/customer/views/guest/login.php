    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
				...
				//echo base64_decode($_REQUEST['pw'])
                ?>
				<?php if($_REQUEST['email'] != ''){ ?>
				<script>
				jQuery( document ).ready(function() {
				  jQuery('#CustomerLogin_email').val('<?php echo $_REQUEST['email']; ?>');
				  jQuery('#CustomerLogin_password').val('<?php echo base64_decode($_REQUEST['pw']); ?>');				  
            ...
            <div class="box-footer">
                <div class="pull-left">
                    <a href="<?php echo $this->createUrl('guest/forgot_password')?>" class="btn btn-default"><?php echo Yii::t('customers', 'Forgot password?');?></a>
                    <?php if ($registrationEnabled) { ?>
                    <a href="<?php echo $this->createUrl('guest/register')?>" class="btn btn-default"><?php echo Yii::t('customers', 'Register');?></a>
                    <?php } ?>
                </div>
                <div class="pull-right">
                    <button id="loginSubmit" type="submit" class="btn btn-primary btn-submit" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>"><?php echo Yii::t('app', 'Login');?></button>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>
        </div>
