...
class RestApiClient
{
        ...
        protected $password;
        protected $accessString = '{"serviceURL":"https:\/\/testapipds.ghn.vn:9999\/external\/marketplace","clientID":"58960","password":"c3TfjJbFzAaDmRVHn","apiKey":"wcsNLLjyLyKX6EsB","apiSecretKey":"9869C9338C530081E31BB9135355A2BF"}';
        ...
        public function connectGHN(){
            ...
            $serviceClient      = new RestApiClient($this->apiUrl,$this->clientID, $this->password,$this->apiKey,$this->apiSecretKey);
