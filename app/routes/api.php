...
Route::group(['prefix' => 'v1', 'namespace' => 'Api', 'middleware' => CheckToken::class], function () {
   ...
   // Route::get('me/revenue-branch','StaticController@revenueBranch');
    ...
    Route::post("chat/set-name-conversation", "ChatController@setNameConversation");
    Route::get("chat/list-myconversation-setname", "ChatController@listMyConversationSetName");
    Route::get("chat/list-groupconversation-setname", "ChatController@listGroupConversationSetName");
    Route::post("chat/count-call", "ChatCallController@countCall");
    Route::post("chat/delete-setname-conversation", "ChatController@deleteSetNameConversation");
    Route::post("chat/pin-conversation", "ChatController@pinConversation");
    Route::post("chat/un-pin-conversation", "ChatController@unPinConversation");
    Route::get("chat/get-last-parent-message", "ChatController@getLastParentMessage");
    Route::get("chat/test-sendmesspush", "ChatCallController@sendMessPush");
    Route::post("chat/update-repeat-conversation", "ChatController@updateRepeatConversation");
    Route::get("chat/pushnoti-repeat-conversation", "ChatController@pushNotiRepeatConversation");
    Route::post("chat/set-count-call", "ChatCallController@setCountCall");
    Route::post("chat/set-count-message", "ChatController@setCountMessage");
    Route::post("chat/stop-share-location", "ChatController@stopShareLocation");
    Route::post("chat/check-share-location", "ChatController@checkShareLocation");
    Route::get("chat/list-user-unanswer-conversation", "ChatController@listUserUnanswerConversation");
    Route::post("chat/update-info-multiimage", "ChatController@updateInfoMultiImage");

    Route::get("chat/list-myrepeat", "ChatController@listMyRepeat");
    Route::get("chat/list-grouprepeat", "ChatController@listGroupRepeat");
    Route::get("chat/detail-root-message", "ChatController@detailRootMessage");
    Route::post("chat/info-image-inmulti", "ChatController@infoImageInMulti");
    Route::post("chat/delete-image-inmulti", "ChatController@deleteImageInMulti");
    Route::post("chat/test-delete-image", "ChatController@testDeleteImage");
    Route::post("chat/list-answer-image", "ChatController@listAnswerImage");   
