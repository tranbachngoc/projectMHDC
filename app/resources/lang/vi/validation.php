...
return [
    ...
    'after_or_equal' => ':attribute phải là thời gian bắt đầu sau :date.',
    ...
    'before_or_equal' => ':attribute phải là thời gian bắt đầu trước :date.',
    'between' => [
     ...
     */
    'attributes' => [
        'use_username' => 'Tên tài khoản',
        'use_id' => 'Id',
        'username' => 'Tên tài khoản',
        'use_password' => 'Mật khẩu',
        'passwordConfirmation' => 'Mật khẩu nhập lần 2',
        'use_address'=>'Địa chỉ',
        'password'=>'Mật khẩu',
        'use_email' => 'Địa chỉ email',
        'use_province' => 'Tỉnh thành',
        'use_district' => 'Quận',
        'use_mobile' => 'Số điện thoại di động',
        'id_card' => 'Số cmnd',
        'use_email' => 'Địa chỉ email',
        'tax_type' => 'Loại thuế',
        'tax_code' => 'Mã thuế',
        'bank_name' => 'Tên ngân hàng',
        'num_account' => 'Số tài khoản ngân hàng',
        'con_title' => 'Tiêu đề',
        'con_detail' => 'Chi tiết',
        'not_image' => 'Hình ảnh',
        'not_title' => 'Tiêu đề',
