...
class Gmap {
    ...
    function getHeaderJS() {
        ...
        $_headerJS .= "<script async defer src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyBW3LGXOqZc93kxribTnomv281YSJD1oK4&callback=onLoadmap\" type=\"text/javascript\"></script>";
