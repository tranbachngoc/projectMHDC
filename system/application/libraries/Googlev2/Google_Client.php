...
require_once APPPATH."libraries/Googlev2/config.php";
...
require_once APPPATH.'libraries/Googlev2/service/Google_Model.php';
require_once APPPATH.'libraries/Googlev2/service/Google_Service.php';
require_once APPPATH.'libraries/Googlev2/service/Google_ServiceResource.php';
require_once APPPATH.'libraries/Googlev2/auth/Google_AssertionCredentials.php';
require_once APPPATH.'libraries/Googlev2/auth/Google_Signer.php';
require_once APPPATH.'libraries/Googlev2/auth/Google_P12Signer.php';
require_once APPPATH.'libraries/Googlev2/service/Google_BatchRequest.php';
require_once APPPATH.'libraries/Googlev2/external/URITemplateParser.php';
require_once APPPATH.'libraries/Googlev2/auth/Google_Auth.php';
require_once APPPATH.'libraries/Googlev2/cache/Google_Cache.php';
require_once APPPATH.'libraries/Googlev2/io/Google_IO.php';
require_once(APPPATH.'libraries/Googlev2/service/Google_MediaFileUpload.php');
...
class Google_Client {
  ...
  public function getAccessToken() {
    // echo '<pre>'; var_dump($auth); echo '</pre>'; die;
