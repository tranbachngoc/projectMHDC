...
class NhanhService
{
     ...
     * @var string
     */
    protected $apiUsername = "Azibaiapi";
     ...
     * @var string
     */
    protected $secretKey = "eDdYA49GKqesDwgA568vPCY5";

    public function __construct($apiUsername, $secretKey, $developers = false)
    {
        $this->apiUsername = $apiUsername;
        $this->secretKey = $secretKey;
        if ($developers) 
        {
            $this->server = "https://dev.nhanh.vn";
        }
    }
