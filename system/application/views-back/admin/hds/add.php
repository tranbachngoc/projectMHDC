                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="55%" height="67" class="item_menu_right">
                                            ...
                                            <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url(); ?>administ/hoidap/category')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                                            ...
                                            <div class="icon_item" id="icon_item_2" onclick="CheckInput_AddHDCategory()" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                                                <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table width="900" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <form name="frmAddCategory" method="post">
                                                   <tr>
                                                    ...
                                                    <div id="parent_0" style="float: left; display: inline;">
                                                        <select id="cat_select_0" onclick="check_cat(this.value,0,'<?php echo base_url().'administ/'; ?>');" size="10">
                                                        <option value="0-<?php echo $next_index;?>">Thư mục gốc</option>
                                                        <?php if(isset($catlevel0)){
                                                            foreach($catlevel0 as $item){
                                                        ?>
                                                        <option value="<?php echo $item->cat_id.'-'.$item->cat_index;?>"><?php echo $item->cat_name;?><?php if($item->child_count >0){echo ' >';}?></option>
                                                        <?php }}?>
                                                        </select>
                                                    </div>
                                                    <div id="parent_1" style="float: left; display: none; margin-left: 15px;">
                                                ...
                                                <tr>
                                                    <td style="width:25%" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('name_add'); ?>:</td>
                                                    <td align="left">
                                                        <input type="text" name="name_category" id="name_category" value="<?php echo $name_category; ?>" maxlength="100" class="input_formpost" onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('name_category',1)" onblur="ChangeStyle('name_category',2)" />
                                                        <?php echo form_error('name_category'); ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:25%" valign="top" class="list_post"><font color="#FF0000"></font> <?php echo $this->lang->line('descr_add'); ?>:</td>
                                                    <td align="left">
                                                ...
                                                <tr>
                                                    <td style="width:25%" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('order_add'); ?>:</td>
                                                    <td align="left">
                                                        <input type="text" name="order_category" id="order_category" value="<?php if($next_order != ''){echo $next_order;}else{echo '1';} ?>" maxlength="4" class="inputorder_formpost" onkeyup="BlockChar(this,'NotNumbers')" onfocus="ChangeStyle('order_category',1)" onblur="ChangeStyle('order_category',2)" />
                                                ...
                                                <tr>
                                                    <td style="width:25%" valign="top" class="list_post"><?php echo $this->lang->line('status_add'); ?>:</td>
                                                ...
                                                <tr class="success_post">
                                                    <td colspan="2">
                                                        <p class="text-center"><a href="<?php echo base_url().'administ/hoidap/categoryadd' ?>">Click vào đây để tiếp tục</a></p>
