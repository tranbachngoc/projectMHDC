                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="5%" height="67" class="item_menu_left">
                                            <a href="<?php echo base_url(); ?>administ/user/alluser">
                                                <img src="<?php echo base_url(); ?>templates/home/images/icon/contact-icon.png" border="0" />
                                            </a>
                                        </td>
                                        <td width="40%" height="67" class="item_menu_middle">Tất cả thành viên (Thành viên thường,  Gian hàng, Affiliate)</td>
                            ...
                            <td align="center">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <!--            <option value="0"><?php //echo $this->lang->line('search_by_search'); ?></option>-->
                                        ...
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/user/alluser/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        <td width="115" align="left">
                                            <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url(); ?>administ/user/alluser/',2)" class="select_search">
                                                ...
                                                <option value="group"><?php echo $this->lang->line('groups_search'); ?></option>
                                                ...
                                                <option value="store">Thành viên Gian hàng</option>
                                                <option value="logindate">Ngày đăng nhập</option>
                                        ...
                                        <td id="DivDateSearch_8" width="60" align="left">
                                            <select name="group" id="group" class="select_datesearch">
                                                <option value="0"><?php echo $this->lang->line('group_search'); ?></option>
                                                <?php $this->load->view('admin/common/group'); ?>
                                            </select>
                                        </td>


                                        <td id="DivDateSearch_9" width="10" align="center"><b>:</b></td>
                                        <td id="DivDateSearch_10" width="60" align="left">
                                            <select name="day" id="tday" class="select_datesearch">
                                                <option value="0"><?php echo $this->lang->line('day_search'); ?></option>
                                                <?php $this->load->view('admin/common/day'); ?>
                                            </select>
                                        </td>
                                        ...
                                        <td id="DivDateSearch_12" width="60" align="left">
                                            <select name="month" id="tmonth" class="select_datesearch">
                                                <option value="0"><?php echo $this->lang->line('month_search'); ?></option>
                                                <?php $this->load->view('admin/common/month'); ?>
                                            </select>
                                        </td>
                                        ...
                                        <td id="DivDateSearch_14" width="60" align="left">
                                            <select name="year" id="tyear" class="select_datesearch">
                                                <option value="0"><?php echo $this->lang->line('year_search'); ?></option>
                                                <?php $this->load->view('admin/common/year'); ?>
                                            </select>
                                        </td>
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/user/alluser/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
										...
										<td width="125" class="title_list">Đăng nhập</td>
                                        <td width="auto" class="title_list">Xóa</td>
                                        <!--<td width="125" class="title_list">
                                    ...
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
										...
										<td class="detail_list" style="text-align:center;"><b><?php echo date('d-m-Y h:i', $userArray->use_lastest_login); ?></b></td>

                                        <td class="detail_list" style="text-align:center;"><a href="<?php echo base_url() ?>administ/user/delete/<?php echo $userArray->use_id; ?>" onclick="return confirm_delete(<?php echo $userArray->use_group; ?>)" >
...
<script type="text/javascript">
    function confirm_delete(groupID){       
        if(groupID == 1 || groupID == 2){
            ...
            return confirm('Bạn không thể xóa thành viên này!');
        }        
    }
</script>