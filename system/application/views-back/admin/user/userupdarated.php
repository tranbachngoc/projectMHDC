                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="40%" height="67" class="item_menu_middle">Danh sách yêu cầu</td>
                                        ...
                                        <td class="detail_list">
                                         ...
                                         <td class="detail_list">
                                             <?php if($userArray->status == 1){ ?>
                                                 <img src="<?php echo base_url(); ?>templates/admin/images/active.png" <?php if($userLogined != $userArray->use_id){ ?> onclick="ActionStatus('<?php echo $statusUrl; ?>/status/noaply/id/<?php echo $userArray->use_id; ?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                             <?php }else{ ?>
                                                 <img src="<?php echo base_url(); ?>templates/admin/images/deactive.png" <?php if($userLogined != $userArray->use_id){ ?> onclick="ActionStatus('<?php echo $statusUrl; ?>/status/aply/id/<?php echo $userArray->use_id; ?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                             <?php } ?>
                                        </td>
                                        <td class="detail_list">
