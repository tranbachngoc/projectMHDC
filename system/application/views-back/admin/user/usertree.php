            ...
            <tr>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="160" align="left">
                                            <input type="text" name="keyword" id="keyword" value="<?php echo $keyword; ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url(); ?>administ/user/usertree/<?php echo $this->uri->segment(4); ?>/search/username/keyword/','keyword')" />
                                        </td>
                                        <td width="120" align="left">
                                            <select name="search" id="search" onchange="ActionSearch('<?php echo base_url(); ?>administ/user/usertree/<?php echo $this->uri->segment(4); ?>/',1)" class="select_search">
                                        ...
                                        <td width="115" align="left">
                                        	 <a class="awesome" href="<?php echo base_url(); ?>administ/user/usertreetree/<?php echo $this->uri->segment(4); ?>"><i class="fa fa-cubes"></i> Xem dạng cây</a>
                                        </td>
                                        <td width="115" align="left">
                                            <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url(); ?>administ/user/usertree/<?php echo $this->uri->segment(4); ?>/',2)" class="select_search">
                ...
                -->                                <!--<option value="lastestlogin"><?php echo $this->lang->line('lastest_login_inactive'); ?></option>-->
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/user/usertree/<?php echo $this->uri->segment(4); ?>/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
