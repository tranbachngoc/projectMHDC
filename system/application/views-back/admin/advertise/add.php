                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="55%" height="67" class="item_menu_right"><?php if($successAdd == false){ ?>
                      ...
                      <div class="icon_item" id="icon_item_2" onclick="CheckInput_AddAdvertise()" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                        <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                      ...
                      <table width="100%" class="form_main" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <form name="frmAddAdvertise" method="post" enctype="multipart/form-data">
                          <tr>
                            ...
                            <td align="left"><input type="text" name="title_adv" id="title_adv" value="<?php echo $title_adv; ?>" maxlength="80" class="input_formpost"  onfocus="ChangeStyle('title_adv',2)" onblur="ChangeStyle('title_adv',2)" onkeyup="BlockChar(this,'AllSpecialChar')"  />
                              <?php echo form_error('title_adv'); ?></td>
                          </tr>
                          <tr>
                            <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> Định dạng Banner :</td>
                            <td align="left"><select id="ub_format_0" alt="Định dạng Banner" name="ub_format" style="margin-top:10px; height:20px;"  >
                                <option title="Ảnh" value="1" selected="selected">Hình ảnh</option>
                                <option title="Iframe" value="2">Iframe</option>
                              </select>
                              <script>
				function changFlashIframe(value)
				{
					...
					.iframe_file{
						clear:both;
                          ...
                          <tr>
                            <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('position_add'); ?>:</td>
                            <td align="left"><select name="position_adv" id="position_adv" class="selectposition_formpost"  onchange="thong_bao_kich_thuoc_banner(this.value)"  >
                              ...
                              <img src="<?php echo base_url(); ?>templates/admin/images/help_post.gif" onmouseover="ddrivetip('<?php echo $this->lang->line('position_tip_help_add'); ?>',190,'#F0F8FF');" onmouseout="hideddrivetip();" class="img_helppost" /></td>
                          </tr>
                          <tr>
                            <td></td>
                            <td><div id="quydinhichtuocbanner" class="form_asterisk" style="font-weight:bold; color:#F00;  padding-top:10px; padding-bottom:10px; width:100%;"> </div></td>
                          </tr>
                          <tr >
                            <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('banner_add'); ?>:</td>
                            <td align="left" style="padding-top:7px;"><div class="img_flash_file" >
                                <input type="file" name="banner_adv" id="banner_adv" value="" size="24" />
                                <img src="<?php echo base_url(); ?>templates/admin/images/help_post.gif" onmouseover="ddrivetip('<?php echo $this->lang->line('banner_tip_help_add'); ?>',355,'#F0F8FF');" onmouseout="hideddrivetip();" class="img_helppost" /><font color="#0066FF">(Dung lượng <= 1MB)</font> </div>
                              <div class="iframe_file" style="display:none" >
                                <input type="text" name="link_frame" id="link_frame"" maxlength="100" value="<?php echo $link_adv; ?>" class="input_formpost" onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('link_adv',1)" onblur="ChangeStyle('link_adv',2)" />
                              </div></td>
                          </tr>
                          <tr>
                            ...
                            <td align="left"><input type="text" name="link_adv" id="link_adv" maxlength="100" value="<?php echo $link_adv; ?>" class="input_formpost" onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('link_adv',1)" onblur="ChangeStyle('link_adv',2)" />
                              <img src="<?php echo base_url(); ?>templates/admin/images/help_post.gif" onmouseover="ddrivetip('<?php echo $this->lang->line('link_tip_help_add'); ?>',185,'#F0F8FF');" onmouseout="hideddrivetip();" class="img_helppost" /> <?php echo form_error('link_adv'); ?></td>
                          </tr>
                       ...
                       <option value="0">Chọn danh mục</option>                        
                          ...
                          <tr>
                            <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('page_add'); ?>:</td>
                            <td align="left"><table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><select name="page_adv[]" id="page_adv" class="selectpage_formpost" multiple="multiple">
                                    ...
                                    <?php /*?>
                                      <option value="product_detail" <?php if($page_adv != '' && stristr($page_adv, 'product_detail')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('product_detail_add') ?></option>
                                      <option value="ads_index" <?php if($page_adv != '' && stristr($page_adv, 'ads_index')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('ads_index_add') ?></option>
                                      <option value="ads_sub" <?php if($page_adv != '' && stristr($page_adv, 'ads_sub')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('ads_sub_add') ?></option>
                                      <option value="ads_detail" <?php if($page_adv != '' && stristr($page_adv, 'ads_detail')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('ads_detail_add') ?></option>
                                      <option value="job_index" <?php if($page_adv != '' && stristr($page_adv, 'job_index')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('job_index_add') ?></option>
                                      <option value="job_sub" <?php if($page_adv != '' && stristr($page_adv, 'job_sub')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('job_sub_add') ?></option>
                                      <option value="job_detail" <?php if($page_adv != '' && stristr($page_adv, 'job_detail')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('job_detail_add') ?></option>
                                      <option value="employ_index" <?php if($page_adv != '' && stristr($page_adv, 'employ_index')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('employ_index_add') ?></option>
                                      <option value="employ_sub" <?php if($page_adv != '' && stristr($page_adv, 'employ_sub')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('employ_sub_add') ?></option>
                                      <option value="employ_detail" <?php if($page_adv != '' && stristr($page_adv, 'employ_detail')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('employ_detail_add') ?></option>
                                      <option value="shop_index" <?php if($page_adv != '' && stristr($page_adv, 'shop_index')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('shop_index_add') ?></option>
                                      <option value="shop_sub" <?php if($page_adv != '' && stristr($page_adv, 'shop_sub')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('shop_sub_add') ?></option>
                                      <option value="shop_detail" <?php if($page_adv != '' && stristr($page_adv, 'shop_detail')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('shop_detail_add') ?></option>
                                      <option value="search" <?php if($page_adv != '' && stristr($page_adv, 'search')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('search_add') ?></option>
                                      <option value="showcart" <?php if($page_adv != '' && stristr($page_adv, 'showcart')){echo 'selected="selected"';}; ?>><?php echo $this->lang->line('showcart_add') ?></option>
                                    <?php */?>
                                    </select></td>
                                  <td><img src="<?php echo base_url(); ?>templates/admin/images/help_post.gif" onmouseover="ddrivetip('<?php echo $this->lang->line('page_tip_help_add'); ?>',225,'#F0F8FF');" onmouseout="hideddrivetip();" class="img_helppost" /></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('advertiser_add'); ?>:</td>
                            <td align="left"><input type="text" name="name_adv" id="name_adv" value="<?php echo $name_adv; ?>" maxlength="80" class="input_formpost" onkeyup="BlockChar(this,'SpecialChar'); CapitalizeNames('frmAddAdvertise','name_adv');" onfocus="ChangeStyle('name_adv',1)" onblur="ChangeStyle('name_adv',2)" />
                          ...
                          <tr>
                            ...
                            <td align="left"><input type="text" name="address_adv" id="address_adv" value="<?php echo $address_adv; ?>" maxlength="80" class="input_formpost" onkeyup="BlockChar(this,'SpecialChar'); CapitalizeNames('frmAddAdvertise','address_adv');" onfocus="ChangeStyle('address_adv',1)" onblur="ChangeStyle('address_adv',2)" />
