...
<script>
    function Sort(type) {
        ...
        var type1 = type;
        window.location.href = '<?php echo base_url(); ?>administ/branch/statistics/'+uid+'/'+type1;
    }
</script>
    <tr>
        <td valign="top">
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="160" align="left">
                                                <input type="text" name="keyword" id="keyword" value="<?php echo $keyword; ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url().'administ/branch/statistics/'.$url.'/search/name/keyword/'; ?>','keyword')" />
                                            </td>
                                            <td width="120" align="left">
                                                <select name="search" id="search" onchange="ActionSearch('<?php echo base_url(); ?>administ/branch/statistics/<?php echo $uidd ?>/',1)" class="select_search">
                                                    <option value="all"><?php echo $this->lang->line('search_by_search'); ?></option>
                                            ...
                                            <td align="left">
                                                <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url().'administ/branch/statistics/'.$url; ?>/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                            </td>
                                                
                                            <td align="right">
                                                <?php $pro_type = $status = $this->uri->segment(6); ?>
                                                <select name="status" id="status" style="margin-right: 10px" onchange="return location.href = '<?php echo base_url(); ?>administ/branch/statistics/<?php echo $this->uri->segment(4); ?>/status/' + this.value;" class="select_search">
                                                    <option value="0">Lọc trạng thái</option>
                                                    <option <?php echo ($status == 1) ? 'selected ="selected"' : ''; ?> value="1">Mới</option>
                                                    <option <?php echo ($status == 2) ? 'selected ="selected"' : ''; ?> value="2">Đang vận chuyển</option>
                                                    <option <?php echo ($status == 3) ? 'selected ="selected"' : ''; ?> value="3">Đã giao hàng</option>
                                                    <option <?php echo ($status == 4) ? 'selected ="selected"' : ''; ?> value="4">Giao không thành công</option>
                                                    <option <?php echo ($status == 5) ? 'selected ="selected"' : ''; ?> value="5">Đang khiếu nại</option>
                                                    <option <?php echo ($status == 6) ? 'selected ="selected"' : ''; ?> value="6">Đã nhận lại hàng - trả hàng</option>
                                                    <option <?php echo ($status == 99) ? 'selected ="selected"' : ''; ?> value="99">Hủy</option>
                                                    <option <?php echo ($status == 98) ? 'selected ="selected"' : ''; ?> value="98">Đã hoàn thành</option>
                                                </select>
                                                
                                                <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url(); ?>administ/branch/statistics/<?php echo $uidd;?>/',2)" class="select_search">
                                            ...
                                            <td width="25" align="right">
                                                ...
                                                <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/branch/statistics/<?php echo $uid;?>/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                            </td>
                                        </tr>
                                    </table>
                                    </form>
                                            ...
                                            <?php foreach($showcart as $key => $showcartArray){
                                                ...
                                                <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" >
                                                    ...
                                                    <td class="detail_list" style="text-align:center;">
                                                        <a href="<?php echo base_url(); ?>administ/showcart/detail/<?php echo $showcartArray->id;  ?>"><?php echo $showcartArray->num_products; ?> sp</a>
                                                    </td>
                                                    <td class="detail_list" style="text-align:right;">
                                                        <b><?php echo date('d/m/Y', $showcartArray->shc_change_status_date); ?></b>
                                                    </td>
                                                    <td class="detail_list" style="text-align:right;">
                                                        <span style="color:#F00; font-weight:bold;"><?php echo number_format($showcartArray->order_total_no_shipping_fee, 0,",","."); ?> đ </span>
                                                    </td>
                                                </tr>
                                                <?php $idDiv++; ?>
                                            <?php } ?>
                                            <tr>
                                                <td colspan="7" class="text-right detail_list" style="font-weight: 600; font-size: 15px">Tổng thu nhập từ đơn hàng:</td>
