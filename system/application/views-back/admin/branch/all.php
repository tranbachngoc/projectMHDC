...
function updategianhangnoibat(value)
{
    ...
    jQuery('.poupngayhethan_'+value).css('display','none');
     window.location.href="<?php echo base_url(); ?>administ/branch/dambao/"+value+"/"+document.getElementById('ngay_ket_thuc_'+value).value;
}
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="5%" height="67" class="item_menu_left">
                                            <a href="<?php echo base_url(); ?>administ/branch<?php  if($getallaf == 'af'){ echo '/af'; }else{ echo "/all"; } ?>">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="160" align="left">
                                            <input type="text" name="keyword" id="keyword" value="<?php echo $keyword; ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url(); ?>administ/branch/<?php echo $getallaf; ?>/search/name/keyword/','keyword')" />
                                        </td>
                                        <td width="120" align="left">
                                            <select name="search" id="search" onchange="ActionSearch('<?php echo base_url(); ?>administ/branch/<?php echo $getallaf; ?>/',1)" class="select_search">
                                                <option <?php echo ($search == 'name') ? 'selected = "selected"' : ''; ?> value="name">Tên gian hàng</option>
                                                <option <?php echo ($search == 'link') ? 'selected = "selected"' : ''; ?> value="link">Link gian hàng</option>
                                                <option <?php echo ($search == 'saler') ? 'selected = "selected"' : ''; ?> value="saler">Chủ gian hàng</option>
                                            </select>
                                        </td>
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/branch/<?php echo $getallaf; ?>/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        <td width="115" align="left">
                                            <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url(); ?>administ/branch/<?php echo $getallaf; ?>/',2)" class="select_search">
                                                ...
                                                <option <?php echo ($filter == 'begindate') ? 'selected = "selected"' : ''; ?> value="begindate"><?php echo $this->lang->line('regisdate_search'); ?></option>
                                                <option <?php echo ($filter == 'active') ? 'selected = "selected"' : ''; ?> value="active">Đã kích hoạt</option>
                                                <option <?php echo ($filter == 'deactive') ? 'selected = "selected"' : ''; ?> value="deactive">Chưa kích hoạt</option>
                                            </select>
                                        </td>
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/branch/<?php echo $getallaf; ?>/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <!---->
                                    <?php $idDiv = 1; $kk=0; ?>
                                    <?php foreach($branch as $shopArray){ ?>
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                       ...
                                       <!-- <td class="detail_list" style="text-align:center;"><b><?php echo date('d-m-Y', $shopArray->sho_enddate); ?></b></td>-->
                                        ...
                                        <td width="5%" class="detail_list" style="text-align:center;"><a href="<?php echo base_url() ?>administ/branch/configdiscount_rate/<?php echo $shopArray->sho_user; ?>" class="menu" data-toggle="tooltip" data-placement="top" title="Click vào để sửa"><?php echo $shopArray->sho_discount_rate; ?>%</a>
                                        </td>
                                    </tr>
                                    <?php $idDiv++; $kk++; ?>
                                    <?php } ?>
