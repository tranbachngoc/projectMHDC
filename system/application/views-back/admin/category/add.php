...
$url1 = '/'.$url;
        $cattype = 0;
        switch ($url){
            case 'service': $cattype = 1;
                break;
            case 'coupon': $cattype = 2;
                break;
            default: $cattype = 0;
        }
?>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="55%" height="67" class="item_menu_right">
                                            ...
                                            <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url().'administ/category'.$url1; ?>')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                                            ...
                                            <div class="icon_item" id="icon_item_2" onclick="CheckInput_AddCategory()" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                                                <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                                ...
                                                <?php if($successAdd == false){ ?>
                                                   <tr>
                                                    ...
                                                    <div id="parent_0" style="float: left; display: inline; margin-left: 0" class="parent_cat_select" >
                                                        <select id="cat_select_0" onclick="check_cat_pr(this.value,0,'<?php echo base_url().'administ/'; ?>',<?php echo $cattype; ?>);" size="10">
                                                        <option value="0-<?php echo $next_index;?>" title="">Thư mục gốc</option>
                                                        <?php if(isset($catlevel0)){
                                                            foreach($catlevel0 as $item){
                                                        ?>
                                                        <option value="<?php echo $item->cat_id.'-'.$item->cat_index;?>" title="<?php echo $item->cat_name;?>"><?php echo $item->cat_name;?><?php if($item->child_count >0){echo ' >';}?></option>
                                                        <?php }}?>
                                                        </select>
                                                    </div>
<!--                                                    <div id="parent_1" class="cat_select" style="float: left; display: none; margin-left: 15px;">-->
<!--                                                    -->
<!--                                                    </div>-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <input type="text" name="name_category" id="name_category" value="<?php echo $name_category; ?>" maxlength="50" class="input_formpost" onkeyup="BlockChar(this,'AllSpecialChar')" onfocus="ChangeStyle('name_category',1)" onblur="ChangeStyle('name_category',2)" />
                                                ...
                                                <tr class="success_post">
                                                    <td colspan="2">
                                                        <!--<p class="text-center"><a href="<?php /*echo base_url().'administ/category' */?>">Click vào đây để tiếp tục</a></p>-->
