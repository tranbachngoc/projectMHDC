...
<script type="text/javascript">
  ...
  function drawChart() {
        ...
        var options = {
          title: "Thống kê tổng doanh thu đơn hàng Sản phẩm năm 2016 - 2017",
          width: 1200,
          height: 400,
          bar: {groupWidth: "95%"},
    ...
    function drawChartMonth() {
          ...
          var options = {
            title: "Thống kê tổng doanh thu đơn hàng Coupon năm 2016 - 2017",
            width: 1200,
            height: 400,
            bar: {groupWidth: "95%"},
            legend: { position: "none" },
...
<div style="width: 1200px; text-align:left; padding-left:150px; height:200px;">&bull; Đơn vị tính: VND</div>
