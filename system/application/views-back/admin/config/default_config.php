        ...
        <script type="text/javascript">
            function checkToEdit(id, baseUrl) {
                ...
                if (isOk) {
                    ...
                    jQuery.ajax({
                        type: "POST",
                        url: baseUrl + "administ/system/config/data/ajax",
                        data: {id: id, field_value: commission},
                        dataType: "json",
                                    ...
                                    <tr>
                                        <td width="5%" height="67" class="item_menu_left"><a
                                                href="<?php echo base_url(); ?>administ/system/info"> <img
                                                    ...
                                                    border="0"/> </a></td>
                                        <td width="40%" height="67" class="item_menu_middle">Cấu hình</td>
                                            ...
                                            <div class="wapper_config">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td class="title_list">Giá trị</td>
                                                        <td class="title_list">Mô tả</td>
                                                    ...
                                                    <?php foreach ($listConfig as $config): ?>
                                                        <tr>
                                                            <td class="detail_list">
                                                                <b><?php echo $config->field_name; ?></b></td>
                                                            ...
                                                            <td class="detail_list"><input disabled="disabled"
                                                                                           ...
                                                                                           name="" type="text"
                                                                                           value="<?php echo $config->field_value; ?>"/>
                                                            </td>
                                                            <td class="detail_list">
                                                                <b><?php echo $config->field_des; ?></b></td>
