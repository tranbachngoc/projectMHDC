...
?>
                                ...
                                <td>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="40%" height="67" class="item_menu_middle">Xác nhận đơn
                                                hàng <?php echo $title; ?> đã thanh toán
                                            </td>
                                        ...
                                        <tr>
                                            <td width="160" align="left">
                                                <input type="text" name="keyword" id="keyword"
                                                       ...
                                                       onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url() . 'administ/showcart/news_order_saler' . $url . '/search/name/keyword'; ?>','keyword')"/>
                                            </td>
                                            <td width="120" align="left">
                                                <select name="search" id="search"
                                                        onchange="ActionSearch('<?php echo base_url(); ?>administ/showcart/news_order_saler/',1)"
                                                        class="select_search">
                                                    <option
                                            ...
                                            <td align="left">
                                                <img
                                                    ...
                                                    onclick="ActionSearch('<?php echo base_url() . 'administ/showcart/news_order_saler/' . $url; ?>',1)"
                                                    title="<?php echo $this->lang->line('search_tip'); ?>"/>
                                            </td>
                                            <!---->
                                            <td width="115" align="left">
                                                <select name="filter" id="filter"
                                                        onchange="ActionSearch('<?php echo base_url(); ?>administ/showcart/news_order_saler/',2)"
                                                        class="select_search">
                                                    <option
                                            ...
                                            <td width="25" align="right">
                                                <img
                                                    src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif"
                                                    border="0" style="cursor:pointer;"
                                                    onclick="ActionSearch('<?php echo base_url() . 'administ/showcart/news_order_saler/' . $url; ?>',2)"
                                    ...
                                    <form name="listOrderProgress" id="listOrderProgress" method="post">
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                foreach ($showcart as $key => $showcartArray) {
                                                    ...
                                                    <tr style="background:#<?php if ($idDiv % 2 == 0) {
                                                        ...
                                                        <td class="detail_list" style="text-align:right;">
                                                            <a href="<?php echo base_url(); ?>administ/user/edit/<?php echo $showcartArray->order_user; ?>"><?php echo $showcartArray->use_username; ?></a>
                                                        </td>
                                                        <td class="detail_list">
                                                            <?php if ($showcartArray->order_status == '02') { ?>
                                                                <button type="button"
                                                                        onclick="apply_order('<?php echo base_url() . 'administ/showcart/confirm_order_checkout/' . $url . '/apply/' . $showcartArray->id; ?>')"
                                                                        class="btn btn-primary">Xác nhận
                                                                </button>
                                                                <button type="button"
                                                                        onclick="cancel_order('<?php echo base_url() . 'administ/showcart/confirm_order_checkout/' . $url . '/cancel/' . $showcartArray->id; ?>')"
                                                                        class="btn btn-danger">Hủy
                                                                </button>
                                                                <!--   <a href="--><?php //echo base_url().'administ/showcart/confirm_order_checkout/'.$url.'/apply/'.$showcartArray->id; ?><!--" class="btn btn-primary">Xác nhận</a>-->
                                                            <?php } elseif ($showcartArray->order_status == '98') { ?>
                                                                <?php if ($showcartArray->order_coupon_code != '') { ?>
                                                                    <span
                                                                        class="text-success"><b><?php echo $showcartArray->order_coupon_code; ?></b></span>
                                                                <?php } else { ?>
                                                                    <span
                                                                        class="text-success"><b><?php echo $showcartArray->id; ?></b></span>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                            ...
                                            <?php } else {
                                                ?>
                                                <tr>
                                                    <td class="text-center" colspan="8"><p>Không có dữ liệu</p></td>
                                                </tr>
                                            <?php } ?>
                                        </table>
                                        <!--END Content-->
    ...
    <script type="text/javascript">
        function apply_order(link) {
            var r = confirm("Bạn có chắc chắn xác nhận?");
            if (r == true) {
                window.location.href = link;
            }
        }
        function cancel_order(link) {
            var r = confirm("Bạn có chắc chắn hủy?");
            if (r == true) {
                window.location.href = link;
            }
        }
