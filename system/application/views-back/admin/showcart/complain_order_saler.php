                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="5%" height="67" class="item_menu_left">
                                            <a href="<?php echo base_url().'administ/showcart/complain_order_saler'.$url; ?>">
                                ...
                                <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                      ...
                                      <td align="center" valign="top"><!--BEGIN: Content-->
                                        ...
                                        <table width="780" class="config_main" cellpadding="0" cellspacing="0" border="0" style="font-size:16px;">
                                            <tbody>
                                                <tr><td height="30" class="config_top"></td></tr>
                                                <tr>
                                                    <td height="30" style="padding-left:20px">
                                                        <?php
                                                            switch($delivery->status_id){
                                                                case "01":
                                                                    $status_name   = "Người mua gởi yêu cầu";
                                                                    break;
                                                                case "02":
                                                                    $status_name   = "Người bán xác nhận yêu cầu";
                                                                    break;
                                                                case "03":
                                                                    $status_name   = "Người mua gởi hàng về SHOP và upload mẫu vận đơn";
                                                                    $image         = base_url().'media/images/mauvandon/'.$delivery->bill;
                                                                    break;
                                                                case "04":
                                                                    if($delivery->type_id == 1){
                                                                        $type = "tạo đơn hàng mới";
                                                                    } else {
                                                                        $type = "hoàn tiền";
                                                                    }
                                                                    $status_name   = "<span style='color:red'>Người bán xác nhận yêu cầu và ".$type.'</span>';
                                                                    break;
                                                            }
                                                        ?>
                                                        Trạng thái đơn hàng bước <span class="step"><?php echo $status_name;?></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="30" style="padding-left:20px">Nội dung tin nhắn người mua và người bán</td>
                                                </tr>
                                                <tr>
                                                    <td height="30" style="padding-left:20px">
                                                        <div class="timeline-2">                                                           
                                                                <?php if($delivery_comments): ?>
                                                                    <?php foreach($delivery_comments as $key => $vals): ?>
                                                                        <div class="time-item">
                                                                            <div class="item-info">
                                                                                <div class="text-muted"><?php echo date("d-m-Y H:i:s",strtotime($vals->lastupdated)); ?></div>
                                                                                <p class="history_group">
                                                                                    <a class="history_logo" href="<?php echo $_thumb[$key]['link'];?>">
                                                                                        <img width="100%" src="<?php echo $_thumb[$key]['logo'];?>" title="<?php echo $_thumb[$key]['name']; ?>" alt="<?php echo $_thumb[$key]['name']; ?>"/>
                                                                                    </a>

                                                                                    <strong><?php echo $vals->content; ?></strong>
                                                                                    <div class="bill">
                                                                                        <?php if($_thumb[$key]['bill']): ?>
                                                                                            <img id="bill" width="80%" src="<?php echo $_thumb[$key]['bill'];?>" title="Hóa đơn - click phóng to" alt="Hóa đơn"/>
                                                                                        <?php endif; ?>
                                                                                    </div>
                                                                                </p>
                                                                            </div>
                                                ...
                                                <tr><td height="30" class="config_bottom"></td></tr>
                                            </tbody>
                                        </table>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="160" align="left">
                                            <input type="text" name="keyword" id="keyword" value="<?php echo $keyword; ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url(); ?>administ/showcart/complain_order_saler/search/name/keyword','keyword')" />
                                        </td>
                                        <td width="120" align="left">
                                            <select name="search" id="search" onchange="ActionSearch('<?php echo base_url().'administ/showcart/complain_order_saler/'.$url; ?>',1)" class="select_search">
                                        ...
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url().'administ/showcart/complain_order_saler/'.$url; ?>',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        <td width="115" align="left">
                                            <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url().'administ/showcart/re_order_saler/'.$url; ?>',2)" class="select_search">
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url().'administ/showcart/re_order_saler/'.$url; ?>',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    foreach ($showcart as $key => $showcartArray) {
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                         <a href="<?php echo base_url(); ?>administ/showcart/detail/<?php echo $showcartArray->id;  ?>"><?php echo $showcartArray->num_products; ?> sản phẩm</a></td>
                                         
                                         <td class="detail_list" style="text-align:right;">
                                         <span style="color:#F00; font-weight:bold;"><?php echo number_format($showcartArray->total_price,0,",","."); ?> đ </span></td>
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                        <?php echo '<button type="button" value="message" class="btn btn-danger" onclick="viewMessage('.$showcartArray->id.')">Xem tin nhắn</button>'; ?>
                                        </td>
                                    </tr>
                                    <?php $idDiv++; ?>
                                    <?php } ?>
...
function viewMessage(id){
    window.location.href='<?php echo base_url(); ?>administ/showcart/complain_order_saler/'+id;
}
</script>