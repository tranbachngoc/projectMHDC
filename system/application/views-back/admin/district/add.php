                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="55%" height="67" class="item_menu_right">
                                            ...
                                            <div class="icon_item" id="icon_item_2" onclick="CheckInput_AddDistrict()" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                                                <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table width="585" class="form_main" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <tr>
                                                    <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('districtCode_list'); ?>:</td>
                                                    <td align="left">
                                                        <input type="text" name="districtCode" id="districtCode" value="<?php echo $districtCode; ?>" maxlength="35" class="input_formpost" />
                                                        <?php echo form_error('districtCode_list'); ?>
                                                    </td>
                                                </tr>
                                                
                                                <tr>
                                                    <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('province_list'); ?>:</td>
                                                    <td align="left">
                                                        <select name="province" id="province">
                                                        <?php foreach($province_list as $vals):?>
                                                            <option value="<?php echo $vals->pre_id; ?>"><?php echo $vals->pre_name; ?></option>
                                                        <?php endforeach; ?>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding-top:7px;">
                                                        <input type="checkbox" name="active_district" checked="" id="active_district" value="1" <?php if($active_district == '1'){echo 'checked="checked"';} ?> />
                                                    </td>
                                                </tr>
                                                </form>
                                                <?php }else{ ?>
