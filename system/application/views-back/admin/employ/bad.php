                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="160" align="left">
                                            <input type="text" name="keyword" id="keyword" value="<?php if($haveEmployBad == true){echo $keyword;} ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url(); ?>administ/employ/bad/search/title/keyword/','keyword')"  />
                                        </td>
                                        ...
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/employ/bad/',1)" alt="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/employ/bad/',2)" alt="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                      ...
                                      <?php /*?>  <td width="80" class="title_list">
                                    ...
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                        ...
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>employ/field/<?php echo $employArray->emp_field; ?>/detail/<?php echo $employArray->emp_id; ?>" target="_blank" alt="<?php echo $this->lang->line('view_tip'); ?>">
                                                <?php echo $employArray->emp_title; ?>
                                            </a>
                                            <span style="color:#0C0; font-style:italic;">(<?php echo $employArray->emp_view; ?>)</span>
                                           <?php /*?> <img src="<?php echo base_url(); ?>templates/admin/images/icon_expand.gif" onclick="Popup('<?php echo base_url(); ?>administ/employ/bad/detail/<?php echo $employArray->emp_id; ?>', 654, 320)" onmouseover="ddrivetip('<?php echo $this->lang->line('view_detail_tip_help_bad'); ?>',290,'#F0F8FF');" onmouseout="hideddrivetip();" style="cursor:pointer;" border="0" /><?php */?>
                                        </td>
                                      <?php /*?>  <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>administ/field/edit/<?php echo $employArray->fie_id; ?>" alt="<?php echo $this->lang->line('edit_tip'); ?>">
                                                <?php echo $employArray->fie_name; ?>
                                            </a>
                                        </td><?php */?>
                                        <td class="detail_list">
                                          <b> <?php echo Counter_model::GetProvinceToID($employArray->emp_province); ?> </b>
                                        </td>
                                        <td class="detail_list">
                                        ...
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>administ/user/edit/<?php echo $employArray->use_id; ?>" alt="<?php echo $this->lang->line('edit_tip'); ?>">
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                            ...
                                            <img src="<?php echo base_url(); ?>templates/admin/images/active.png" onclick="ActionStatus('<?php echo $reliableUrl; ?>/reliable/deactive/ed/<?php echo $employArray->emp_id; ?>')" style="cursor:pointer;" border="0" alt="<?php echo $this->lang->line('stop_reliable_tip_help_bad'); ?>" />
                                            <?php }else{ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/deactive.png" onclick="ActionStatus('<?php echo $reliableUrl; ?>/reliable/active/ed/<?php echo $employArray->emp_id; ?>')" style="cursor:pointer;" border="0" alt="<?php echo $this->lang->line('reliable_tip_help_bad'); ?>" />
                                            <?php } ?>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php if($employArray->emp_status == 1){ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/active.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/deactive/id/<?php echo $employArray->emp_id; ?>')" style="cursor:pointer;" border="0" alt="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                            <?php }else{ ?>
                                      ...
                                      <td class="detail_list" style="text-align:center;" ><a href="<?php echo base_url()?>user/profile/<?php echo $employArray->emb_id_user; ?>" target="_blank"> <?php echo Counter_model::getUSerIdNameToID($employArray->emb_id_user); ?> </a></td>
                                      <td class="detail_list" style="text-align:center"><b> <?php echo date('d-m-Y', $employArray->emb_date); ?> </b></td>
                                    ...
                                    <tr>
                                      ...
                                      <?php /*?>  <td width="120" class="title_list">
                                            <?php echo $this->lang->line('field_list'); ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/sort_asc.gif" style="cursor:pointer;" border="0" />
                                            <img src="<?php echo base_url(); ?>templates/admin/images/sort_desc.gif" style="cursor:pointer;" border="0" />
                                        </td><?php */?>
