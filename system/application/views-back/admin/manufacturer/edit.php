              ...
              <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td align="center" valign="top">
                      <table width="800" class="form_main" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                        ...
                        <form name="frmAddCategory" method="post">                          
                          <tr>
                            <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> Danh mục:</td>
                      ...
                      if(isset($catlevel0)){
                                ...
                                <div id="hoidap_1" style="float: left; margin-left: 15px;">
                                  ...
                                  <select name="category_pro" id="category_proaa" class="selectcategory_formpost_edit" size="14" onclick="check_edit_nha_san_xuat_cate(this.value,1,'<?php echo base_url(); ?>');" >
                                    <?php 
                                ...
                                >
                                    <?php } else { if(isset($parent_id) && $parent_id == $item->cat_id)  { ?>
                                    <option value="<?php echo $item->cat_id; ?>"  selected="selected" ><?php echo $item->cat_name; ?></option>
                                    <?php } else {  ?>
                                    <option value="<?php echo $item->cat_id; ?>" ><?php echo $item->cat_name; ?></option>
                                    <?php } } } ?>
                                ...
                                <div id="hoidap_2" style="float: left;  margin-left: 15px;">
                                  ...
                                  <select name="category_pro" id="category_pro_edit" class="selectcategory_formpost_edit" size="14" onblur="getManAndCategory4Search_edit('<?php echo base_url(); ?>');" onclick="check_edit_nha_san_xuat_cate(this.value,2,'<?php echo base_url(); ?>');" >
                                    <?php 
										foreach($cat_level_2 as $item){
									?>
                                    <?php if(isset($parent_id) && $parent_id == $item->cat_id){ ?>
                                    <option value="<?php echo $item->cat_id; ?>" selected="selected"><?php echo $item->cat_name; ?></option
                                ...
                                <input type="hidden" id="hd_category_id" name="hd_category_id" value="<?php echo $parent_id ; ?>"/>
                              </div></td>
                          </tr>
                          <tr>
                          <tr>
