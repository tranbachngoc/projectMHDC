                        ...
                        <tr>
                            <td>
                                ...
                                <a href="<?php echo base_url(); ?>administ/category">
                                            	<img src="<?php echo base_url(); ?>templates/admin/images/nhasanxuat.png" border="0" />
                                            </a>
                                        </td>
                                        <td width="40%" height="67" class="item_menu_middle">Nhà sản xuất </td>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="160" align="left">
                                            <input type="text" name="keyword" id="keyword" value="<?php echo $keyword; ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" onKeyPress="return SummitEnTerAdmin(this,event,'<?php echo base_url(); ?>administ/manufacturer/search/name/keyword/','keyword')" />
                                        </td>
                                        <td width="120" align="left">
                                            <select name="search" id="search" onchange="ActionSearch('<?php echo base_url(); ?>administ/menu/',1)" class="select_search" style="width:130px">
                                              
                                                <option value="name">Tìm kiếm theo tên</option>
                                            </select>
                                        </td>
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/manufacturer/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        <td width="115" align="left">
                                            <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url(); ?>administ/manufacturer/',2)" class="select_search">
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="title_list">
                                            <?php echo $this->lang->line('name_Category'); ?>
                                        </td>
                                    ...
                                    <!---->
                                    <?php $idDiv = 1; ?>
                                    <?php foreach($category_man as $categoryArray){ ?>
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                            <input type="checkbox" name="checkone[]" id="checkone" value="<?php echo $categoryArray->man_id; ?>" onclick="DoCheckOne('frmCategory')" />
                                        </td>
                                      
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>administ/manufacturer/edit/<?php echo $categoryArray->man_id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                                <?php echo $categoryArray->man_name; ?>
                                            </a>
                                        </td>
                                        <td class="detail_list">
                                            <?php echo $categoryArray->man_descr; ?>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <b><?php echo $categoryArray->cat_name; ?></b>
                                        </td>
                                          <td class="detail_list" style="text-align:center;">
                                            <b><?php echo $categoryArray->man_order; ?></b>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php if($categoryArray->man_status == 1){ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/active.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/deactive/id/<?php echo $categoryArray->man_id; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                            <?php }else{ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/deactive.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/active/id/<?php echo $categoryArray->man_id; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                            <?php } ?>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php echo $categoryArray->man_id; ?>
                                        </td>
                                    </tr>
                                    <?php $idDiv++; ?>
                                    <?php } ?>
