                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                        ...
                                        <td class="detail_list">
                                          ...
                                          <?php /*?>  <img src="<?php echo base_url(); ?>templates/admin/images/icon_expand.gif" onclick="Popup('<?php echo base_url(); ?>administ/product/bad/detail/<?php echo $productArray->pro_id; ?>', 654, 320)" onmouseover="ddrivetip('<?php echo $this->lang->line('view_detail_tip_help_bad'); ?>',280,'#F0F8FF');" onmouseout="hideddrivetip();" style="cursor:pointer;" border="0" /><?php */?>
                                        </td>
                                        <td class="detail_list">
