                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="5%" height="67" class="item_menu_left">
                                            <a href="<?php echo base_url(); ?>administ/product/affiliate">
                                            	<img src="<?php echo base_url(); ?>templates/home/images/icon/shopping-icon.png" border="0" />
                                            </a>
                                        </td>
                                        <td width="40%" height="67" class="item_menu_middle">Sản phẩm Affiliate</td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="120" align="left">
                                            <select name="search" id="search" onchange="ActionSearch('<?php echo base_url(); ?>administ/product/affiliate/',1)" class="select_search">
                                        ...
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url() ?>administ/product/affiliate/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        <td width="115" align="left">
                                            <select name="filter" id="filter" onchange="ActionSearch('<?php echo base_url(); ?>administ/product/affiliate/',2)" class="select_search">
                                                <option value="0"><?php echo $this->lang->line('filter_by_search'); ?></option>

                                                <option value="product_f"><?php echo "Sản phảm"; ?></option>
                                                <option value="service_f"><?php echo "Dịch vụ"; ?></option>
                                                <option value="coupon_f"><?php echo "Coupon"; ?></option>
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/product/affiliate/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="125" class="title_list">
                                            <?php echo $this->lang->line('affiliate_cost_list'); ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/sort_asc.gif" onclick="ActionSort('<?php echo $sortUrl; ?>af_rate/by/asc<?php echo $pageSort; ?>')" style="cursor:pointer;" border="0" />
                                            <img src="<?php echo base_url(); ?>templates/admin/images/sort_desc.gif" onclick="ActionSort('<?php echo $sortUrl; ?>af_rate/by/desc<?php echo $pageSort; ?>')" style="cursor:pointer;" border="0" />
                                        </td>
                                        <td width="135" class="title_list">
                                            <?php echo $this->lang->line('affiliate_vnd_cost_list'); ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/sort_asc.gif" onclick="ActionSort('<?php echo $sortUrl; ?>af_amt/by/asc<?php echo $pageSort; ?>')" style="cursor:pointer;" border="0" />
                                            <img src="<?php echo base_url(); ?>templates/admin/images/sort_desc.gif" onclick="ActionSort('<?php echo $sortUrl; ?>af_amt/by/desc<?php echo $pageSort; ?>')" style="cursor:pointer;" border="0" />
                                        </td>
                                        <td width="135" class="title_list">
                                            Giảm thêm AF
                                        </td>
                                    ...
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                       ...
                                       <!-- <td class="detail_list">
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                            <font color="#FF0000"><b><span id="AfCost_<?php echo $idDiv; ?>"></span>&nbsp;%</b></font>
                                            <script type="text/javascript">FormatCost('<?php echo $productArray->af_rate; ?>', 'AfCost_<?php echo $idDiv; ?>');</script>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <font color="#FF0000"><b><span id="AfvndCost_<?php echo $idDiv; ?>"></span>&nbsp;<?php echo $productArray->pro_currency; ?></b></font>
                                            <script type="text/javascript">FormatCost('<?php echo $productArray->af_amt; ?>', 'AfvndCost_<?php echo $idDiv; ?>');</script>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php
