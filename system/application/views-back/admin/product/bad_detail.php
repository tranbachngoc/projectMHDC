...
<table width="650" border="0" cellpadding="0" cellspacing="0">
    ...
    <form name="frmDetailBadProduct_<?php echo $idDiv; ?>" method="post">
	<tr bgcolor="#E1F0FF">
    	<td width="145" valign="top" class="list_post"><?php echo $this->lang->line('title_detail_bad'); ?>:</td>
        <td class="title_detail_bad">
        	<?php echo $productArray->prb_title; ?>&nbsp;&nbsp;
        	<img src="<?php echo base_url(); ?>templates/admin/images/icon_delete_bad.gif" onclick="ActionDelete('frmDetailBadProduct_<?php echo $idDiv; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('delete_tip_detail_bad'); ?>" />
        </td>
    </tr>
    <tr bgcolor="#F7F7F7">
    	<td width="145" valign="top" class="list_post"><?php echo $this->lang->line('email_detail_bad'); ?>:</td>
        <td class="title_detail_bad">
        	<a class="menu" href="mailto:<?php echo $productArray->prb_email; ?>"><?php echo $productArray->prb_email; ?></a>
        </td>
    </tr>
    <tr bgcolor="#E1F0FF">
        ...
        <td class="content_detail_bad" align="left">
        	<?php echo nl2br($productArray->prb_detail); ?>
        </td>
    </tr>
    <tr bgcolor="#F7F7F7">
    	<td width="145" valign="top" class="list_post"><?php echo $this->lang->line('date_detail_bad'); ?>:</td>
        <td class="time_detail_bad"><?php echo date('h\h:i, d-m-Y', $productArray->prb_date); ?></td>
    </tr>
    <input type="hidden" name="idBad" value="<?php echo $productArray->prb_id; ?>" />
    </form>
    <?php $idDiv++; ?>
    <?php } ?>
    <tr>
    	<td class="show_page" colspan="2"><?php echo $linkPage; ?></td>
 	</tr>
</table>
</body>
</html>