                                                ...
                                                <form id="frmAdminForm" name="frmAdminForm" method="post"
                                                    ...
                                                    <table width="800" class="form_main" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <select  readonly class="select_search" name="group" autocomplete="off">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <input class="input_formpost" type="text" name="name" value="<?php echo $name;?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="150" valign="top" class="list_post"><font
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <input type="text" readonly name="unit" class="input_formpost"
                                                                       id="unit"
                                                                       value="<?php echo $unit;?>"
                                                                    />
                                                            </td>
                                                    ...
                                                    <input type="hidden" name="unit_servi" value="<?php echo $unit; ?>" >
