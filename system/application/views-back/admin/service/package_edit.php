                                                    ...
                                                    <table width="585" class="form_main" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td width="150" valign="top" class="list_post"><font
                                                                    color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('ser_name'); ?>
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <input type="text" name="package_name" class="input_formpost"
                                                                       id="package_name"
                                                                       value="<?php echo $name; ?>"
                                                                       maxlength="255"/>
                                                        ...
                                                        <tr>
                                                            <td width="150" valign="top" class="list_post"><font
                                                                    color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('ser_desc'); ?>
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <textarea id="package_desc" name="package_desc" class="input_select editor"
                                                                          required><?php if ($desc != '') {
                                                                        echo $desc;
                                                                    } ?></textarea>

                                                                <?php echo form_error('package_desc'); ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding-top:7px;">
                                                                <input type="checkbox" name="package_published"
