                                    ...
                                    <script type="text/javascript">
                                        ...
                                        $(document).ready(function () {
                                            $("#frmAdminForm").validate({
                                                ...
                                                messages: {
                                                    month_price: "<?php echo $this->lang->line('required_message');?>",
                                                    discount_rate: "<?php echo $this->lang->line('required_message');?>"
                                                }
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="40%" height="67"
                                                class="item_menu_middle"><?php echo $this->lang->line('price_title_edit'); ?></td>
                                                ...
                                                <form id="frmAdminForm" name="frmAdminForm" method="post"
                                                    ...
                                                    <table width="585" class="form_main" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <?php echo $infoText->name;?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="150" valign="top" class="list_post"><font
                                                                    color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('price_period'); ?>
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <select  class="select_search" name="period" autocomplete="off">
                                                                <?php foreach($periodList as $item):?>
                                                                    <option <?php echo ($item['id'] == $period) ? 'selected="selected"':'';?> value="<?php echo $item['id'];?>"><?php echo $item['text'];?></option>
                                                                <?php endforeach;?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="150" valign="top"
                                                                class="list_post"><?php echo $this->lang->line('price_monthly'); ?>
                                                                :
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width="150" valign="top"
                                                                class="list_post"><?php echo $this->lang->line('price_discount'); ?>
                                                                :
                                                            </td>
                                                            <td align="left" style="padding-top:7px;">
                                                                <input type="text" name="discount_rate" class="input_formpost"
                                                                       id="discount_rate"
                                                                       value="<?php echo $discount_rate;?>"
                                                                 />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td width="150" valign="top"
                                                                class="list_post"><?php echo $this->lang->line('ser_point'); ?>
                                                                :
                                                            </td>
                                                            <td align="left" style="padding-top:7px;">
                                                                <input type="text" name="point" class="input_formpost"
                                                                       id="point"
