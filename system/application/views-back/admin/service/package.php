            ...
            <div class="sContentBox">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="55%" height="67" class="item_menu_right" style="display: none">
                ...
                <table width="100%" border="0" align="center" class="main" cellpadding="0" cellspacing="0">
                    ...
                    <td class="title_list" width="10%">Dịch vụ</td>
                    <td class="title_list" width="10%">Bảng giá</td>
                    ...
                    <?php foreach ($list as $key=>$item): ?>
                        <tr id="row_<?php echo $item['id']; ?>" style="background:<?php if ($key % 2 == 0) {
                            ...
                            <td class="detail_list"><a href="<?php echo $link.'/servicelist/'.$item['id'];?>">Dịch vụ</a></td>
                            <td class="detail_list"><a href="<?php echo $link.'/pricelist/'.$item['id'];?>">Bảng giá</a></td>
