        ...
        <td>
            <div class="sContentBox">
                ...
                <table width="100%" border="0" align="center" class="main" cellpadding="0" cellspacing="0">
                    ...
                    <td class="title_list" width="10%">Giới hạn

                    </td>
                    <td class="title_list" width="10%">Đơn vị

                    </td>
                    <td class="title_list" width="10%">Cài đặt

                    </td>
                    <td class="title_list" width="10%" style="display: none">Kích hoạt
                    ...
                    <?php foreach ($list as $key=>$item): ?>
                        <tr id="row_<?php echo $item['id']; ?>" style="background:<?php if ($key % 2 == 0) {
                            ...
                            <td class="detail_list"><?php echo $item['id']; ?></td>
                            <td class="detail_list">
                                <a class="menu" href="<?php echo $link; ?>/edit/<?php echo $item['id']; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                    <?php echo $item['name']; ?>
                                </a>
                            </td>
                            <td class="detail_list"><?php echo $item['desc']; ?></td>
                            <td class="detail_list"><?php echo $item['limit'] == -1 ? 'Không giới hạn' : $item['limit']; ?></td>
                            <td class="detail_list"><?php echo $item['unit']; ?></td>
                            <td class="detail_list"><?php echo $item['install'] == 1 ? 'Có' : 'Không'; ?></td>
                            <td class="detail_list" style="text-align: center;display: none">
