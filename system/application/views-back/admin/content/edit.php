...
<?php
if ($_SERVER['HTTP_REFERER'] != base_url() . "administ/content/edit/" . $this->uri->segment(4) . "") {
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<td width="55%" height="67" class="item_menu_right"><?php if ($successEdit == false) { ?>
    					    <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url(); ?>administ/content')" onmouseover="ChangeStyleIconItem('icon_item_1', 1)" onmouseout="ChangeStyleIconItem('icon_item_1', 2)">
    							...
    							<td align="left"><div  style=" padding-top:14px;">
									...
									<?php if (isset($cat_level_1)) { ?>
										...
										foreach ($cat_level_1 as $item) {
											...
											if (isset($category_shop) && $category_shop == $item->cat_id) {
											    ?>
		    									<option value="<?php echo $item->cat_id; ?>"  selected="selected" ><?php echo $item->cat_name; ?></option>
											<?php } else { ?>
		    									<option value="<?php echo $item->cat_id; ?>" ><?php echo $item->cat_name; ?></option>
...
<!--    						    <tr>
							    ...
							    <div id="img_list" class="img_list">								
								    ...
								    <img style="cursor:pointer" onclick="closeimagespop();" src="<?php echo base_url(); ?>templates/home/images/close_x.png"/>
								</div>
    							...
    							<td align="left" style="padding-top:7px;"><input type="checkbox" name="active_content" id="active_content" value="1" <?php
								if ($active_content == '1') {
