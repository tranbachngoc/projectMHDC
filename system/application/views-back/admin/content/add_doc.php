...
<?php
if($_SERVER['HTTP_REFERER']!=base_url()."administ/doc/add")
{
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table width="100%" class="form_main1" cellpadding="0" cellspacing="0" border="0">
                                                        ...
                                                        <td align="left">
                                                            <div  style=" padding-top:14px;">
                                                                <div id="hoidap_0" style="float: left; ">                 
                                                                    <select id="hd_select_0" class="form_control_hoidap_select" onclick="check_edit_content_cate(this.value,0,'<?php echo base_url(); ?>');">
                                                ...
                                                <tr>
                                                  ...
                                                  <select name="group_docs" id="group_docs" style="width:250px; margin-top:7px">
                                                      ...
                                                      <option value="3" >Gian hàng</option>
                                                      <option value="14" >Chi nhánh</option>
                                                      <option value="11" >Nhân viên</option>
                                                      ...
                                                      <option value="12" > Core Admin</option>
                                                  </select>
                                                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style=" padding-top:6px;">
                                                      ...
                                                      <img style="vertical-align:middle; height:100px" src="<?php echo base_url().'media/images/doc/noimage.png'?>"/>
                                                  </td>
                                              </tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <textarea id="txtContent" name="txtContent" id="elm3"></textarea>
                                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <tr class="success_post">
                                                    <td colspan="2">
                                                        <p class="text-center"><a href="<?php echo $_SESSION['trangtruoc']; ?>">Click vào đây để tiếp tục</a></p>
