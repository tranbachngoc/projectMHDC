...
if($_SERVER['HTTP_REFERER']!=base_url()."administ/content/edit_doc/".$this->uri->segment(4)."")
{
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="55%" height="67" class="item_menu_right"><?php if($successEdit == false){ ?>
                    <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url(); ?>administ/doc')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                    ...
                    <?php }else{ ?>
                    <div class="icon_item" id="icon_item_2" onclick="ActionLink('<?php echo base_url(); ?>administ/content/adddoc')" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                      <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                ...
                <td align="center" valign="top"><!--BEGIN: Content-->
                  <table width="100%" class="form_main1" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        ...
                        <td align="left"><div  style=" padding-top:14px;">
                          <div id="hoidap_0" style="float: left; ">
                            <select id="hd_select_0" style="width:250px;" class="form_control_hoidap_select" onclick="check_edit_content_cate(this.value,0,'<?php echo base_url(); ?>');" >
                    ...
                    <tr>
                      ...
                      <td align="left">                                            
                      <select name="group_docs" id="group_docs" style="width:250px; margin-top:7px">
                          <option value="0"> Chọn nhóm thành viên </option>
                          <option value="2"  <?php if($group_docs==2)  echo 'selected="selected" ';?>> Affiliate</option>
                          <option value="3"  <?php if($group_docs==3)  echo 'selected="selected" ';?>> Affiliate & Gian hàng</option>
                          <option value="7"  <?php if($group_docs==7)  echo 'selected="selected" ';?>> Developer 1</option>
                          <option value="6"  <?php if($group_docs==6)  echo 'selected="selected" ';?>> Developer 2</option>
                          <option value="9"  <?php if($group_docs==9)  echo 'selected="selected" ';?>> Partner 1</option>
                          <option value="8"  <?php if($group_docs==8)  echo 'selected="selected" ';?>> Partner 2</option>
                          <option value="10" <?php if($group_docs==10) echo 'selected="selected" ';?>> Core Member</option>
                          <option value="12" <?php if($group_docs==12) echo 'selected="selected" ';?>> Core Admin</option>
                        </select>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td align="left" style=" padding-top:6px;">
                        ...
                        <img style="vertical-align:middle; height:100px" src="<?php echo base_url().'media/images/doc/'.$not_dir_image.'/'.$not_image; ?>"/>                                           
                      </td>
                    </tr>
                    <tr>
