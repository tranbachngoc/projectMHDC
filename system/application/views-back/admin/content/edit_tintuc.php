          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="40%" height="67" class="item_menu_middle">Sửa tin tức</td>
                <td width="55%" height="67" class="item_menu_right"><?php if($successEdit == false){ ?>
                  <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url(); ?>administ/tintuc')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                          ...
                          <td align="left"><div  style=" padding-top:14px;">
                            <div id="hoidap_0" style="float: left; ">
                              <select id="hd_select_0" class="form_control_hoidap_select" onclick="check_edit_content_cate(this.value,0,'<?php echo base_url(); ?>');" size="14">
                                <option value="" <?php if($category_shop!="") ?> selected="selected"  >Chọn danh mục</option>
                                <?php 
                                if(isset($catlevel0)){
                            ...
                            <div id="hoidap_1" style="float: left; margin-left: 15px;">
                              ...
                              <div id="hoidap_2" style="float: left;  margin-left: 15px;">
                                ...
                                <select name="category_pro" id="category_pro_edit" class="selectcategory_formpost_edit" size="14" onblur="getManAndCategory4Search_edit('<?php echo base_url(); ?>');" onclick="check_edit_content_cate(this.value,2,'<?php echo base_url(); ?>');" >
                                  <?php 
                            ...
                            <td align="left" style=" padding-top:6px;">
                              ...
                              <img style="vertical-align:middle; height:100px" src="<?php echo base_url().'media/images/tintuc/'.$not_dir_image.'/'.$not_image; ?>"/>                                           
                            </td>
                          </tr>
                            <tr>
                                ...
                                <td align="left"><table border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td><?php $this->load->view('admin/common/tinymce'); ?>
                                      <textarea name="txtContent" style="width:100%" rows="20" >
                                        <?php 
                              ...
                              <tr>
                                <td></td>
                                <td><input type="button" value="Chèn Hình" onclick="popsimages('img_list');"/>
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" style="padding-top:7px;"><input type="checkbox" name="publish_content" id="publish_content" value="1" <?php if($publish_content == '1'){echo 'checked="checked"';} ?> /></td>
                                  </tr>
                                </form>
                                <?php }else{ ?>
                                <tr class="success_post">
                                  <td colspan="2"><p class="text-center"><a href="<?php echo base_url(); ?>/administ/tintuc/">Click vào đây để tiếp tục</a></p>
