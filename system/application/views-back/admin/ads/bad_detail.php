...
<table width="650" border="0" cellpadding="0" cellspacing="0">
    ...
    <form name="frmDetailBadAds_<?php echo $idDiv; ?>" method="post">
	<tr bgcolor="#E1F0FF">
    	<td width="145" valign="top" class="list_post"><?php echo $this->lang->line('title_detail_bad'); ?>:</td>
        <td class="title_detail_bad">
        	<?php echo $adsArray->adb_title; ?>&nbsp;&nbsp;
        	<img src="<?php echo base_url(); ?>templates/admin/images/icon_delete_bad.gif" onclick="ActionDelete('frmDetailBadAds_<?php echo $idDiv; ?>')" style="cursor:pointer;" border="0" alt="<?php echo $this->lang->line('delete_tip_detail_bad'); ?>" />
        </td>
    </tr>
    <tr bgcolor="#F7F7F7">
    	<td width="145" valign="top" class="list_post"><?php echo $this->lang->line('email_detail_bad'); ?>:</td>
        <td class="title_detail_bad">
        	<a class="menu" href="mailto:<?php echo $adsArray->adb_email; ?>"><?php echo $adsArray->adb_email; ?></a>
        </td>
    </tr>
    <tr bgcolor="#E1F0FF">
        ...
        <td class="content_detail_bad" align="left">
        	<?php echo nl2br($adsArray->adb_detail); ?>
        </td>
    </tr>
    <tr bgcolor="#F7F7F7">
    	<td width="145" valign="top" class="list_post"><?php echo $this->lang->line('date_detail_bad'); ?>:</td>
        <td class="time_detail_bad"><?php echo date('h\h:i, d-m-Y', $adsArray->adb_date); ?></td>
    </tr>
    <input type="hidden" name="idBad" value="<?php echo $adsArray->adb_id; ?>" />
    </form>
    <?php $idDiv++; ?>
    <?php } ?>
    <tr>
