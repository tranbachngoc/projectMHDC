                                            ...
                                            <table width="900px" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <tr>
                                                   ...
                                                   <div id="parent_0" style="float: left; display: inline;">
                                                        <select id="cat_select_0" onchange="check_cat_edit_rv(this.value,0,'<?php echo base_url().'administ/'; ?>');">													<option value="0-<?php echo $next_index;?>">Chọn danh mục</option>
                                                    ...
                                                    <div id="parent_1" style="float: left; display: inline; margin-left: 15px;">
														...
														<select id="cat_select_1" onchange="check_cat_edit_rv(this.value,1,'<?php echo base_url().'administ/'; ?>');">													<option value="0">Chọn danh mục</option>
