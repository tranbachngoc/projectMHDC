                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="55%" height="67" class="item_menu_right">
                                            ...
                                            <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url(); ?>administ/doccategory')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table width="900" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <tr class="success_post">
                                                    <td colspan="2">
                                                        <p class="text-center"><a href="<?php echo base_url().'administ/doccategory' ?>">Click vào đây để tiếp tục</a></p>
