                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="55%" height="67" class="item_menu_right">
                                            ...
                                            <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url(); ?>administ/ttcategory')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                                            ...
                                            <?php }else{ ?>
                                            <div class="icon_item" id="icon_item_2" onclick="ActionLink('<?php echo base_url(); ?>administ/cttintuc/add')" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                                                <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table width="900" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <form name="frmAddCategory" method="post">
                                                    <tr>
                                                        <td  valign="top" class="list_post">Chọn Danh Mục Cha:</td>
                                                        <td align="left">
                                                            ...
                                                            <div id="parent_0" style="float: left; display: inline;">
                                                                <select id="cat_select_0" onclick="check_cat_pr(this.value,0,'<?php echo base_url().'administ/'; ?>');" size="10">
                                                ...
                                                <tr class="k_displaynone">
                                                    <td valign="top" class="list_post"><?php echo $this->lang->line('image_add'); ?>:</td>
                                                    <td align="left">
                                                ...
                                                <tr class="success_post">
                                                    <td colspan="2">
                                                        <p class="text-center"><a href="<?php echo base_url().'administ/ttcategory' ?>">Click vào đây để tiếp tục</a></p>
