                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="5%" height="67" class="item_menu_left">
                                                <a href="<?php echo base_url(); ?>administ/shop/statistical">
...
<!--                                                           placeholder="...">-->
                                                ...
                                                <td align="left">
                                                    <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/shop/<?php echo $getallaf; ?>/',1)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
...
<!--                                                    <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i></button>-->
                                                    <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/shop/statistical/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <?php foreach($shop as $k=>$item){ ?>
                                                <tr style="background:#<?php if($k % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $k; ?>">
                                                    ...
                                                    <td align="center">
                                                        <a style="text-decoration: underline;" href="<?php echo base_url().'administ/shop/statistical?uid='.$item->use_id; ?>">Sản phẩm</a> </td>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <td align="center"><a style="text-decoration: underline;" href="<?php echo base_url().'administ/shop/statistics/'.$item->use_id .'/statisticaldate/key/isFilter/'.$getisFilter.'/tokey/'.$gettokey.$statisticaldate ?>"><?php echo number_format($item ->showcarttotal,0,",",".") ?> đ</a> </td>
