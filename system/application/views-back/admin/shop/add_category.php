                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="40%" height="67" class="item_menu_middle">Thêm danh mục gian hàng</td>
                                            ...
                                            <table width="900" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <form name="frmAddCategory" method="post">
                                                   <tr>
                                                    ...
                                                    <div id="parent_0" style="float: left; display: inline;">
                                                        <select id="cat_select_0" onclick="check_cat_pr_shop(this.value,0,'<?php echo base_url().'administ/'; ?>');" size="10">
                                                ...
                                                <tr class="success_post">
                                                    <td colspan="2">
                                                		...
                                                		Thêm danh mục gian hàng thành công
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </table>
