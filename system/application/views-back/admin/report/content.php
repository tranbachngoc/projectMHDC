                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="40%" height="67" class="item_menu_middle">Báo cáo nội dung tin tức</td>
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <?php foreach($reports as $listreport){ 
                                        $a = 'http://'.domain_site.'/tintuc/detail/'.$listreport->not_id.'/'.RemoveSign($listreport->not_title);
                                    ?>
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                        ...
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo $a; ?>" target="_blank" alt="<?php echo $listreport->not_title; ?>">
                                                <?php echo $listreport->not_title; ?>
                                            </a>
                                        </td>
                                        <td class="detail_list">
...
<!--                                        <td class="detail_list" style="text-align:center;">
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                            <b><?php echo $listreport->not_id; ?></b>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php echo date('d-m-Y', $listreport->not_begindate); ?>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php echo $listreport->cntReport; ?>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <a href="/administ/reports/content/detail/<?php echo $listreport->not_id; ?>"><b>Xem và xử lý</b>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php $idDiv++; ?>
