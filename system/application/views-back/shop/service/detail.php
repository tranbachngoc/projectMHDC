  ...
  <div class="affiliate-content-coupondetail">
    <div class="coupondetail-tit">
      <a href="<?=azibai_url('/shop/service')?>">
        ...
        <!-- <img src="/templates/home/styles/images/hinhanh/15.jpg" alt="" class="avata">  -->
        <?=$service['name']?>
      </a>
    </div>
    <div class="coupondetail-content post-detail">
      <div class="row">
        <div class="col-xl-4 col-lg-6 col-md-12">
          <div class="img">
            <img src="/templates/home/styles/images/svg/bg_dichvu.png" class="main-img" alt="">
          </div>
          <?php
...
<?php //$this->load->view('shop/service/popup-payment-service', ['service'=>$service, 'iUserId'=>$iUserId], FALSE); ?>
