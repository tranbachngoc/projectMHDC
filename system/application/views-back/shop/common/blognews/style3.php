<?php if(isset($lastnews) && !empty($lastnews)) {
    ...
    ?>
    <h3 class="text-center"><i class="fa fa-newspaper-o fa-fw"></i> Tin tức mới nhất</h3>
    <div class="row tintuc">
        <?php foreach($lastnews as $k=>$item){ if($k<8) { ?>
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 <?php echo $k >= 3?'hidden-xs': '';?>">
                <div style="<?php if($k % 4 == 0) echo 'clear:both';  ?>">
                    ...
                    <div style="padding:0 15px;">
                        ...
                        <h4><a href="<?php echo $URLRoot;?>detail/<?php echo $item->not_id; ?>/<?php echo RemoveSign($item->not_title);?>"><?php echo $item->not_title; ?></a></h4>

<!--                        <p>--><?php //$vovel=array("&curren;"); echo strip_tags(cut_string_unicodeutf8(html_entity_decode(str_replace($vovel,"#",$item->not_detail)),150)) ; ?><!--</p>-->
