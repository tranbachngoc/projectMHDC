...
if($shop_af->use_group == 2){
	...
	$affiliate_products = $this->product_model->fetchAF('tbtt_product.*'.DISCOUNT_QUERY, array('pro_status'=>1, 'tbtt_product_affiliate_user.use_id'=>(int)$siteGlobal->sho_user), "homepage", "DESC", $start, 16);
}
