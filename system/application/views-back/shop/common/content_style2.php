...
<div class="module featured_products">
    ...
    <?php if (count($featured_products) > 0): ?>
        <h3 class="text-center"><span>Sản phẩm nổi bật</span></h3>
        <div class="row">
            ...
            ?>               
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                    ...
                    ?>
                    <div class="thumbox" style="background:#fff">
                    ...
                    <p class="pro_descr"> <?php echo $product->pro_descr; ?> </p>
                    ...
                    <div style="margin-bottom: 30px;">
                        <a class="btn btn-primary" href="<?php echo $link; ?>"> Xem chi tiết </a>
                    </div>
    ...
    <?php if (count($featured_products) > 0 && serviceConfig == 1): ?>
        <h3 class="text-center"><span> Dịch vụ nổi bật</span></h3>
        <div class="row">
    ...
    <?php if (count($new_coupon) > 0): ?>
        <h3 class="text-center"><span>Coupon nổi bật</span></h3>
        <div class="row">
            <?php foreach ($new_coupon as $k => $product) {              
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                    <?php $filename = DOMAIN_CLOUDSERVER . 'media/images/product/' . $product->pro_dir . '/thumbnail_3_'. explode(',', $product->pro_image)[0]; ?>
                    <div class="thumbox">
                        <a href="<?php echo $link ?>">             
                            <?php if ($product->pro_image != '') { //file_exists($filename)?>
                                <img
