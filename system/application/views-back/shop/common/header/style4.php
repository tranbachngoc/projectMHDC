...
<div class="hidden-xs hidden-sm">
    <div class="headertop">
        <div class="container" style="padding:10px 10px">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6 text-left"><a href="tel:<?php echo  $siteGlobal->sho_mobile ?>"><i class="fa fa-phone-square fa-fw"></i> Hotline: <?php echo  $siteGlobal->sho_mobile ?></a></div>
                <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                    ...
                    if ($this->session->userdata('sessionUser') > 0){ 
                        ...
                        <?php } ?>
                    <?php } else { ?>
			    <a href="#" data-toggle="modal" data-target="#myLogin"><i class="fa fa-sign-in fa-fw"></i> Đăng nhập</a>
                    <?php } ?>
                      <a class="cart_db" href="/checkout"><i class="fa fa-shopping-cart fa-fw"></i> <span class="cartNum badge"><?php echo  $azitab['cart_num']?$azitab['cart_num']:'0' ?></span></a>
                </div>
            </div>
        </div>
    </div>
    <div class="headerbottom">
		...
		<a href="/">
		    <?php if ($siteGlobal->sho_logo) { ?>
    		    <img alt="<?php echo $siteGlobal->sho_name; ?>" src="<?php echo $sho_logo; ?>" border="0" height="75"  />
		    <?php } else { ?>
		...
		<div class="collapse navbar-collapse">
			...
			<li class="<?php
			if (isset($menuSelected) && $menuSelected == 'store') {
			    echo 'active';
			} else {
			    echo 'normal';
			}
		    ...
		    <?php if (serviceConfig == 1) { ?>
				...
				?>
    			    <li><a class="hover" href="/shop/services">Xem tất cả dịch vụ</a></li>
    			</ul>
    		    </li>
		    <?php } ?>
	...
	<div class="shop_banner">
	    <div class="fix3by1" style="background: url('<?php echo $srcbanner ?>') no-repeat center / cover"></div>
	</div>
    </div>
</div>
<div class="visible-xs visible-sm">       
	...
	<div class="shop_logo text-center">
		...
		<a href="/" style=" border: 1px solid #f9f9f9; display: block; height:100%; background: url('<?php echo  $sho_logo ?>') no-repeat center / 100% auto"></a>
	    </div>
	</div>
