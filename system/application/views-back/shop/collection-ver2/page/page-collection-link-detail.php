<div class="collection-detail-header">
  <div class="bosuutap-header">
    <div class="button-back">
      <a href="<?=$shop_url . 'home/shop/collection_link_v2'?>">
...
<div class="grid haftwidth append-box">
  <?php foreach ($items as $key => $item) {
    $this->load->view('shop/collection-ver2/element/item-collection-link-detail', ['item'=>$item, 'shop_url' => $shop_url], FALSE);
  } ?>
</div>
...
<?php $this->load->view('shop/collection-ver2/popup/popup-collection-link-add-new-link',
  [
...
<?php $this->load->view('shop/collection-ver2/popup/popup-collection-detail-link-menu-item');?>
<?php $this->load->view('shop/collection-ver2/popup/popup-collection-link-edit-new-link',
  [
  'popup_list_collection'=>$popup_list_collection,
  'cate_id'=>$collection['cate_id'],
  'c_id'=>$collection['id'],
...
<?php if($user_id != (int)$this->session->userData('sessionUser')) {
  $this->load->view('shop/collection-ver2/popup/popup-collection-link-clone',
  [
  'popup_list_collection'=>$popup_list_collection,
  'cate_id'=>$collection['cate_id'],
  'c_id'=>$collection['id'],
