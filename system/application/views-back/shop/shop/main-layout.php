...
<head>
  <meta charset="UTF-8">
  <title><?php echo (isset($ogtitle)) ? strip_tags($ogtitle) : settingTitle; ?></title>
  ...
  <meta property="og:title" content="<?php echo (isset($ogtitle)) ? strip_tags($ogtitle) : settingTitle; ?>" />
  ...
  <meta property="og:image" content="<?php echo isset($ogimage) && $ogimage ? $ogimage : ((getAliasDomain() != '') ? getAliasDomain() . 'templates/home/images/logoshare.png' : site_url('templates/home/images/logoshare.png')); ?>" />
  ...
  <meta property="og:image:alt" name="og_image_alt" content="<?php echo (isset($ogtitle)) ? $this->filter->injection_html(strip_tags($ogtitle)) : settingTitle ?>"/>
