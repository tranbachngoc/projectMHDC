...
.container .showcart {min-height:300px;}
   ...
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">        
         <div class="showcart">
                                  ...
                                  if (cart_delete[i] && cart_delete[i].products.length > 0 && cart_delete[i].shop == tmp[0]) {
                                      ...
                                      if (cart_delete[i].products.length > 0) {
                                          ...
                                          if ($('table.shopBox').length == 0) {
                                              ...
                                              var mes = '<?php echo $this->lang->line('none_record_showcart_defaults'); ?>! Vui lòng trở lại <a  href="<?php echo site_url($linkreturn); ?>"><strong>Trang mua sắm</strong></a> tìm sản phẩm và chọn thêm vào Giỏ hàng!';
                              ...
                              for (var i = 0, len = cart_delete.length; i < len; ++i) {
                                  ...
                                  if (cart_delete[i].products.length > 0 && cart_delete[i].shop == tmp[0]) {
                                      ...
                                      if (cart_delete[i].products.length > 0) {
                                          ...
                                          // $(element).parent().find('div#title_' + tmp[0]).remove();
                                          if ($('table.shopBox').length == 0) {
                                              var mes = '<?php echo $this->lang->line('none_record_showcart_defaults'); ?>! Vui lòng trở lại <a  href="<?php echo base_url(); ?>">Trang chủ Azibai</a> tìm sản phẩm và chọn thêm vào Giỏ hàng!';
            ...
            <form id="frmShowCart" name="frmShowCart" method="post" action="<?php echo getAliasDomain(); ?>showcart/order_cart">
               <h3 style="text-transform: uppercase" class="hidden-md hidden-lg">Giỏ hàng của bạn</h3>
                <?php foreach ($cart as $key => $shop): ?>
                    <div class="panel panel-primary">
					
						<div id="title_<?php echo $key; ?>" class="panel-heading">
                        ...
                        <?php if ($isMobile == 0){ ?>
                        <table id="row_<?php echo $key; ?>" class="table shopBox" width="100%" cellpadding="0" cellspacing="0">                           
                            <tr class="table_head">
                           ...
                           <?php $link_img = DOMAIN_CLOUDSERVER .'media/images/product/'. $product->pro_dir . '/thumbnail_1_'; ?>
                                <tr id="row_<?php echo $product->key; ?>">
                                    ...
                                    <td class="text-danger">
                                        <div id="sub_<?php echo $product->key; ?>"><b><?php echo lkvUtil::formatPrice($product->pro_cost * $product->qty, 'đ'); ?></b></div>
                                        <div id="dc_<?php echo $product->key; ?>"><?php echo $product->em_discount > 0 ? '-'. lkvUtil::formatPrice($product->em_discount, 'đ') : ''; ?></div>
                                    </td>
                                    <td align="center">
                                        <button type="button" onclick="deleteProduct('<?php echo $product->key; ?>', this, 'product');" class="btn button-delete btn-danger btn-sm">Xóa
                                        </button>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td colspan="6" class="text-right">
                                    <a href="<?php echo '/affiliate/orderv0/'. $key .'/'. $shops[$key]['sho_link']; ?>" class="btn btn-default1 btn-order" <?php if($noAccesss == 1){ ?> onclick="alert('Bạn là thành viên Azibai, bạn không có quyền mua hàng khi đăng nhập, hay thoát ra và đặt hàng bằng tài khoản khác hoặc đặt hàng qua email. <a href=\'logout\'>Thoát ngay</a>'); return false;" <?php } ?> >Đặt hàng</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        foreach ($shop as $key_num => $product) {
                           ...
                           <div class="row">
                               ...
                               <div class="col-xs-8">
                                   ...
                                   <button type="button" onclick="deleteProductMB('<?php echo $product->key; ?>', this, 'product');"
                                           class="btn button-delete btn-sm btn-danger pull-right">Xóa
                                   </button>
                               </div><!--/Col8-->
                           </div><!-- /form-group-->
                           </li>
                           ...
                           <div class="row">
                              <div class="col-xs-4">Tổng tiền:</div>
                                ...
                                <div class="col-xs-12">                                    
                                    <a href="<?php echo '/affiliate/orderv0/'. $key .'/'. $shops[$key]['sho_link']; ?>" class="btn btn-block btn-order" <?php if($noAccesss == 1){ ?> onclick="alert('Bạn là thành viên Azibai, bạn không có quyền mua hàng khi đăng nhập, hay thoát ra và đặt hàng bằng tài khoản khác hoặc đặt hàng qua email. <a href=\'<?php echo getAliasDomain() ?>logout\'>Thoát ngay</a>'); return false;" <?php } ?> >
                                        Đặt hàng</a>
                                </div>
                           </div>
                        </ul>
                ...
                <?php 
                    ...
                    <div class="panel panel-primary">
                        ...
                        <table id="row_<?php echo $key; ?>" class="table shopBox" width="100%" cellpadding="0" cellspacing="0">                            
                                ...
                                <td align="center">
                                    ...
                                    <td align="center">
                                        <button type="button" onclick="deleteProduct('<?php echo $product->key; ?>', this, 'coupon');"
                                                class="btn button-delete btn-sm btn-danger">Xóa
                                        </button>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                            <td  colspan="6" class="text-right">                                
                                <a href="<?php echo '/affiliate/orderv2/'. $key .'/2/'. $shops[$key]['sho_link']; ?>" class="btn btn-order btn-default1" <?php if($noAccesss == 1){ ?> onclick="alert('Bạn là thành viên Azibai, bạn không có quyền mua hàng khi đăng nhập, hay thoát ra và đặt hàng bằng tài khoản khác hoặc đặt hàng qua email. <a href=\'<?php echo getAliasDomain() ?>logout\'>Thoát ngay</a>'); return false;" <?php } ?> >Đặt hàng</a>
                            </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                           ...
                           <div class="row">
                              <div class="col-xs-4">Tổng tiền:</div>
                                ...
                                <div class="col-xs-12">                                    
                                    <a href="<?php echo '/affiliate/orderv2/'. $key .'/2/'. $shops[$key]['sho_link']; ?>" class="btn btn-block btn-order" <?php if($noAccesss == 1){ ?>
                  ...
                  <span class="add-qty" title="Thêm"
                       onclick="cart_update_qty('<?php echo $product->key; ?>', 1, <?php echo $product->dp_id; ?>, this, 'coupon');">+</span>
                            ...
                            <tr>
                            <td  colspan="6" class="text-right">                                
                                <a href="<?php echo '/affiliate/orderv2/'. $key .'/2/'. $shops[$key]['sho_link']; ?>" class="btn btn-order" <?php if($noAccesss == 1){ ?> onclick="alert('Bạn là thành viên Azibai, bạn không có quyền mua hàng khi đăng nhập, hay thoát ra và đặt hàng bằng tài khoản khác hoặc đặt hàng qua email. <a href=\'<?php echo getAliasDomain() ?>logout\'>Thoát ngay</a>'); return false;" <?php } ?> >Đặt hàng</a>
                            </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        ?>
                               ...
                               <div class="col-xs-4">
                                  <p>
                                      ...
                                      if ($img1[0] != "" && file_exists($file_ex)) {
                                          ?>
                                          <img width="75" src="<?php echo getAliasDomain() .'media/images/product/'. $product->pro_dir .'/'. show_thumbnail($product->pro_dir, $img1[0], 1); ?>"/>
                                      <?php } else { ?>
                                          <img width="75" src="<?php echo getAliasDomain() .'images/img_not_available.png' ?>"/>
                                      <?php } ?>
                                  </p>
                           ...
                           <div class="row">
                              <div class="col-xs-4">Số lượng:</div><!--/col4-->
                              <div class="col-xs-8">
                                 <div class="qty_row" id="bt_<?php echo $product->key; ?>">
                                    <div class="qty_group">
                                       <span class="sub-qty" title="Bớt" onclick="cart_update_qty('<?php echo $product->key; ?>', -1, <?php echo $product->dp_id; ?>, this, 'coupon');">-</span>
                                       <input readonly="readonly" id="qty_<?php echo $product->key; ?>" name="<?php echo $product->key; ?>" autofocus="autofocus" autocomplete="off" type="text" min="1" max="9999" class="inpt-qty productQty" required value="<?php echo $product->qty; ?>">
                                       <span class="add-qty" title="Thêm" onclick="cart_update_qty('<?php echo $product->key; ?>', 1, <?php echo $product->dp_id; ?>, this, 'coupon');">+</span>
                                    </div>
                                    <input type="hidden" value="<?php echo $product->qty_min; ?>" name="qty_min">
                                    <input type="hidden" value="<?php echo $product->qty_max; ?>" name="qty_max">
                                   </div>
                           ...
                           <div class="row">
                              <div class="col-xs-4">Tổng tiền:</div>
                                ...
                                <div class="col-xs-12">                                    
                                    <a href="<?php echo '/affiliate/orderv2/'. $key .'/'. $shops[$key]['sho_link']; ?>" class="btn btn-block btn-order" <?php if($noAccesss == 1){ ?> onclick="alert('Bạn là thành viên Azibai, bạn không có quyền mua hàng khi đăng nhập, hay thoát ra và đặt hàng bằng tài khoản khác hoặc đặt hàng qua email. <a href=\'<?php echo getAliasDomain() ?>logout\'>Thoát ngay</a>'); return false;" <?php } ?> >Đặt hàng</a>
                                </div>
                           </div>
                        </ul>
                        <?php }?>
            ...
            <?php } else { ?>                    
				<div class="alert alert-info text-center" role="alert">
				   Không có sản phẩm nào trong giỏ hàng của bạn! Vui lòng trở lại <a href="/affiliate/product/"><strong>Trang mua sắm</strong></a> tìm sản phẩm và chọn thêm vào giỏ hàng!
				</div>
            <?php } ?>         
		 </div>
      </div>
