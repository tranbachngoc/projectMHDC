...
<div class="modal modal-show-detail main-content" id="modal-show-detail-video"  tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-show-detail-dialog content-posts" role="document">
        <!-- Modal Header -->
        <!-- <div class="modal-header"></div> -->
        <!-- Modal body -->
        <div class="modal-content container post-detail">
            <div class="modal-body">
                <div class="row">
                    <div class="js-background-black col-lg-7 popup-image-sm">
                                ...
                                <div class="jR3DCarouselCustomSlide" data-index="0">
                                    <div class="big-img">
                                        <div class="tag position-tag">
                                            <img class="image_main_tag slider_check_main" src="<?php echo DOMAIN_CLOUDSERVER ?>media/images/content/26122018/5c2305de0c16e15457991345c2305de0c1ca.jpeg" alt="" data-id="0">
                        ...
                        <div class="action md">
                            <?php 
                            $this->load->view('home/share/bar-btn-share-js', array('show_bar_video_md7' => 1, 'show_bar_video_md5' => 0, 'show_bar_video_sm' => 0));
                            ?>
                        </div>
                    ...
                    <div class="js-background-white col-lg-5 md">
                        <div class="post">
                            ...
                            <div class="action">
                                <?php $this->load->view('home/share/bar-btn-share-js', array('show_bar_video_md7' => 0, 'show_bar_video_md5' => 1, 'show_bar_video_sm' => 0)); ?>
    ...
    <div class="sm content-posts">
        <div class="sm tieude-sm">
            <div class="tieude-sm-head">
                ...
                <a href="" class="btn-chitiettin btn-chitiettin-js mt10 mr10">Chi tiết tin <img src="/templates/home/styles/images/svg/next.svg"></a>
            </div>
            <h3 class="pop-descrip-title"></h3>
        </div>
        <div class="action post-detail">
            <?php $this->load->view('home/share/bar-btn-share-js', array('show_bar_video_md7' => 0, 'show_bar_video_md5' => 0, 'show_bar_video_sm' => 1, 'show_sm' => 0)); ?>
        </div>
...
<script id="js-list-3d-tag-news" type="text/template">
...
<script id="js-link-photo-tag-news" type="text/template">
    <li>
...
<script id="js-list-3d-video-news" type="text/template">
