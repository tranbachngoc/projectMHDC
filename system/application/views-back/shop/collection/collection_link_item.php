...
<style>
      ...
      <section class="main-content">
        ...
        <div class="container bosuutap bg-black-container">
          ...
          <div class="bosuutap-header tieude-chinhsua">
            ...
            <div class="bosuutap-chitiet-tieude">
              ...
              <div class="icons">
                ...
                <?php } ?>
                <div class="icon share-click shr-bosuutap" data-toggle="modal" data-value="<?=$share_url;?>" data-name="<?= htmlspecialchars($share_name);?>"><img src="/templates/home/styles/images/svg/share.svg" alt=""></div>
            ...
            <div class="tim-bosuutap sm">
              <p class="search"><input type="text" placeholder="Tìm kiếm mục đã lưu..."><img src="asset/images/svg/search.svg" alt=""></p>
            </div>
          ...
          <div class="liet-ke-hinh-anh">
            <div class="grid">
              <?php foreach ($collection_link as $key => $value) {?>
                <?php $this->load->view('shop/collection/common/item_link', ['item'=>$value]); ?>
              <?php } ?>
            </div> 
          </div>
        </div>
  ...
  <?php if ($is_owner) {?>
  <?php $this->load->view('shop/collection/popup-collection/popup-add-custom-link', ['c_id'=>$coll_selected->id]); ?>
  <?php $this->load->view('shop/collection/popup-collection/popup-edit-custom-link', ['c_id'=>$coll_selected->id]); ?>
  <?php $this->load->view('shop/collection/html/button-add-link-in-collection'); ?>
  ...
  <script>
    function copyLink(id) {
      ...
      link = window.location.href + '/view/' + id;
      textArea.value = link;
