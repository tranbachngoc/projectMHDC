                  ...
                  <div class="danhsach-tatcabosuutap">
                    <?php if ($is_owner) {?>
                        <div class="taobosuutap-sp createCollection">
                          ...
                          <label for="file"><img src="/templates/home/styles/images/svg/add_circle.svg" class="mr10" alt="">Thêm BST tin</label>
                        </div>
                    <?php }?>
                    <div class="danhsach-tatcabosuutap-items md">
                      ...
                      <?php foreach ($collection as $key => $value) { ?>
                        <a href="<?php echo $shop_url. 'shop/collection/select/'. $value->id; ?>"><li><img src="<?php echo $value->avatar_path_full; ?>" alt=""><?php echo $value->name; ?> <span
                  ...
                  <div class="bosuutap-tabbosuutap-01">
                    ...
                    <?php foreach ($collection as $key => $value) { ?>
                      <div class="item moreBox" style="display:none" data-index="<?=$key?>" data-char="<?=substr($value->name, 0, 1)?>">
                        <div class="image">
                          <a href="<?php echo $shop_url. 'shop/collection/select/'. $value->id?>">
                            ...
                            <?php if($value->total > 0){ ?>
                              <?php foreach ($value->content as $k => $v) { ?>
                                <li><img src="<?php echo $v->image?>" alt="" onerror="image_error(this)"></li>
                              <?php } ?>
                              <?php if($value->total < 4 && !($value->total < 2) ) { 
                                for ($i=0; $i < (4 - $value->total); $i++) { ?>
                                <li><img src="/templates/home/styles/images/default/error_image_400x400.jpg" alt="" onerror="image_error(this)"></li>
                              <?php } } ?>
                        ...
                        <div class="descript">
                          <a href="<?php echo $shop_url. 'shop/collection/select/'. $value->id?>"><?php echo $value->name; ?><br><span><?php echo $value->total . ' mục' ?></span></a>
                          <?php if ($is_owner) {?>
