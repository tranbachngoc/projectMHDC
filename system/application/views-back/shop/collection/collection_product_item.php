...
<style>
      ...
      <section class="main-content">
        ...
        <div class="container bosuutap bg-black-container">
          ...
          <div class="liet-ke-hinh-anh">
            <div class="grid">
              <?php foreach ($collection_product as $key => $value) {?>
                <?php $this->load->view('shop/collection/common/item_product', ['item'=>$value]); ?>
              <?php } ?>         
            </div> 
          </div>
        </div>
  ...
  <script>
    ...
    function copyLink(id, cate_id, name) {
      var af = "<?=$af_id ? '?af_id='.$af_id : ''?>";
      var textArea = document.createElement("textarea");
      var link = domain + "/"+cate_id+"/"+id+"/"+name+af;
      textArea.value = link;
