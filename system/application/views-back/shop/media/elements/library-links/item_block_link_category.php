...
<div class="list-link-content <?php echo @$category['class_bg_color'] ?>">
    <div class="newest-post">
        <a title="<?php echo htmlspecialchars($item['link_title']); ?>" target="_blank" href="<?php echo $url_item . $type_tbl .'/'. $item['id'] ?>">
            <?php
            if($item['video']) {
        ...
        <div class="head">
            ...
            <a href="<?php echo ($link_view_all = $domain_url .'library/links/'. $category['slug']) ?>">Xem tất cả</a>
        </div>
        <div class="text">
        ...
        <div class="newest-post-edit">
            <div class="main">
                <div class="p-2 cursor-pointer icon js_library-link-show-more"
                      ...
                      data-value="<?php echo $url_item . $type_tbl .'/'. $item['id'] ?>"
    ...
    ?>
    <div class="grid <?php echo $view_type_class ?>">
