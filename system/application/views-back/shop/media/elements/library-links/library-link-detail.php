                      ...
                      <div class="col-lg-5">
                        <div class="post">
                          ...
                          <div class="action">
                            ...
                            $this->load->view('home/share/bar-btn-share', array('data_backwhite' => 1, 'data_shr' => 1, 'data_jsclass' => 'js-like-link', 'data_url' => base_url().'library-links/'.$node_custom_link->id, 'data_title' => $node_custom_link->title, 'data_id' => $node_custom_link->id, 'data_imglike' => $imgLike, 'data_numlike' => 0, 'data_lishare' => 1));
                            ?>
