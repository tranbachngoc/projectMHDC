                            ...
                            <div class="text-center">
                                <div class="big-img">
                                    <div class="tag position-tag">
                                        ...
                                        if($link['media_type'] ==  'video' && $link['video_path'] != '') { ?>
                                        ...
                                        <?php } elseif ($link['media_type'] == 'image' && $link['image_path'] != '') { ?>
                                            <img onerror="image_error(this)" src="<?php echo $link['image_path']; ?>" alt="<?php echo htmlspecialchars($link['title']) ?>">
                                        <?php } else { ?>
                                            <img onerror="image_error(this)" src="<?php echo $link['image']; ?>" alt="<?php echo htmlspecialchars($link['title']) ?>">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5">
                            <div class="post">
                                <div>
                                    <div class="info-product">
                                        ...
                                        <div class="sm btn-seelink">
                                            <a ref="nofollow" href="<?php echo $link['save_link'] ?>" target="_blank">Xem liên kết</a>
                                        </div>
                                    </div>
                                    <div class="info-user">
                                        <div class="name">
                                ...
                                <div class="action">
                                    ...
                                    $this->load->view('home/share/bar-btn-share', array('data_backwhite' => 1, 'data_shr' => 1, 'data_jsclass' => 'js-like-link', 'data_url' => base_url().'custom-links/'.$link['id'], 'data_title' => $link['title'], 'data_id' => $link['id'], 'data_imglike' => $imgLike, 'data_numlike' => 0, 'data_lishare' => 1));
                                    ?>
                                </div>
                            </div>
                        </div>
...
if(!empty($is_owns) && !isset($page_custom_link_detail)){
    $this->load->view('shop/media/elements/library-links/popup-custom-link-create'  , ['sho_id' => $shop_current->sho_id]);
}
