...
<div class="coupondisplay-category">
  ...
  <a class="item <?=$this->uri->segment(4) == 0 ? "active" : ""?>" href="<?=base_url()."library/vouchers/type/0".$af_key?>">Mới nhất</a>
  <a class="item <?=$this->uri->segment(4) == 1 ? "active" : ""?>" href="<?=base_url()."library/vouchers/type/1".$af_key?>">Bán chạy</a>
