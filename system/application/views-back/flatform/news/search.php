...
<script>
    function submitSearchTintuc() {
        ...
        var url = '<?php echo getAliasDomain(); ?>flatform/news/search/keyword' + keyword;
        window.location = url;
        return true;
    }
    ...
    <div class="row tintuc">
        ...
        <div class="col-lg-10">
            <div class="breadcrumbs hidden-xs">
                ...
                <a  href="<?php echo getAliasDomain(); ?>flatform/news">Tin tức</a><i class="fa fa-angle-right"></i>
                <span>Tìm kiếm</span>
            </div>

            <div class="row visible-xs">  
                <div class="col-md-6">
                    <form id="tintuc_search" class="form-horizontal" action="<?php echo getAliasDomain() ?>flatform/news/search" method="post">                            
                        <div class="input-group">
                            <input name="keyword" id="keyword" class="form-control" type="text" 
                                   value="<?php if ($keyword) { echo $keyword; } ?>" 
                                   placeholder="Nhập từ khóa tìm kiếm" 
                                    onkeypress="return submitenterQ(this,event,'<?php echo getAliasDomain(); ?>')">
			...
			<?php if (isset($results) && count($results) > 0) { ?>
                <div class="panel panel-default" id="results">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-newspaper-o fa-fw"></i>&nbsp; <b>Kết quả tìm kiếm</b> <span class="">(<?php echo $totalRecord ?>)</span></h3>
                    </div>
			...
			<div class="row" style="margin-bottom: 15px;">
				<div class="col-xs-12">
					...
					<div class="item-title"><a href="<?php echo getAliasDomain() ?>flatform/news/<?php echo $item->not_id; ?>/<?php echo RemoveSign($item->not_title); ?>"><?php echo $item->not_title ?></a></div>
