    ...
    <div class="row">
        <?php foreach($products as $key => $product){
                if ($shop_pro->domain != '') {
                    ...
                    $my_link_news = 'https://' . $shop_pro->sho_link . '.' . domain_site;
                    $my_link_shop = $my_link_news . '/shop'; 
                }
                ?>
            ...
            <div class="row">        
                <div class="col-sm-5 col-xs-12">
                    <div class="text-center">
                            ...
                            <div class="row" style="text-align: left;"><b>Hoa hồng cộng tác viên được hưởng khi bán sp này: <span style="color: #f00"><?php echo $pro_affiliate_value; ?></span></b></div>
                ...
                <div class="col-sm-7 col-xs-12">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                                ...
                                <td id="cost_detail" valign="top">
                                    ...
                                    <?php } else {
                                        ...
                                        <?php if ($product->pro_cost > $discount['salePrice']) { ?>
                                            <span class="cost-price" style="color: gray; text-decoration: line-through;" id="show-cost"><?php echo lkvUtil::formatPrice($product->pro_cost, 'vnđ'); ?></span>
                                        <?php } else { ?>
                            ...
                            <?php if ($product->off_amount > 0) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="sale-price detail <?php if ($discount['af_off'] > 0) { echo 'cost-price-line';} ?>" style="color: red;" id="cost-save"><?php echo number_format($price_sale, 0, ",", "."); ?></span>
                                        vnđ
                            ...
                            <?php if ($group_id == 2 && $discount['af_off'] > 0): ?>
                                <tr>
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php if($product->pro_detail != '') echo htmlspecialchars_decode(html_entity_decode(str_replace("&curren;", "#", $product->pro_detail))); else echo 'Chưa có mô tả'; ?>
                        </div>
                    </div>
                </div>        
            </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        foreach ($same_store_products as $products) {
                            $afSelect = false;
                            if ($af_id != '' && $products->is_product_affiliate == 1) {
                                $this->load->model('user_model');
                                $userObject = $this->user_model->get("use_id", "af_key = '" . $af_id . "'");
                                if ($userObject->use_id > 0) {
                                    $afSelect = true;
                            ...
                            ?>
                            <div class="col-xs-6">
                                <?php $this->load->view('flatform/products/product-item', array('product' => $products, 'discount' => $discount)); ?>
                            </div>                      
                        <?php } ?>
                    </div>
                </div>
