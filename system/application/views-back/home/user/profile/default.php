	...
	<meta charset=UTF-8">
        ...
        <style>
            ...
            .quotes {
                ...
                <?php } else { ?>
                background: url(<?php echo DOMAIN_CLOUDSERVER.'media/images/profiles/default/bg1.jpg';?>) no-repeat center center;
                <?php } ?>
                background-attachment: scroll;
                -webkit-background-size: cover;
                -moz-background-size: cover;
        ...
        <div id="company" class="company section">           
            <div class="container">
                <header class="heading hd_about_2">
                    <h2><?php echo $resume->company_name ? $resume->company_name : 'CÔNG TY';?></h2>
                </header>
                <div class="row">
                ...
                <div class="container">
                    <div class="sr_quote">
                        <p>
							...
							<?php echo $resume->slogan ?>	
                            <i class="fa fa-quote-right"></i>
                        </p>
                        <div class="sr_quote-author">- <?php echo $resume->slogan_by;?> -</div>
                    </div>
                </div>
                <span class="cp-load-after-post"></span>
            </div>
        ...
        <div id="services" class="services section">
            <div class="container">
                <header class="heading hd_services_4">
                    <h2><?php echo $resume->title_service ? $resume->title_service : 'DỊCH VỤ' ?></h2>                    
                </header>
                ...
                <?php 
                    $services = json_decode($resume->list_service);                    
                ?>            
	...
	<?php if($resume->show_statistic == 1 ){ ?>
        ...
        <div id="portfolio" class="portfolio sections">
            <div class="container" style="margin-bottom:20px;">
                <header class="heading">
                    <h2 class="h_tit"><?php echo $resume->title_product ? $resume->title_product: 'SẢN PHẨM' ?></h2>                    
                </header>
        ...
        <div id="certification" class="certification section">
            <div class="container">
                ...
                <?php $certification = json_decode($resume->certification);?>
        ...
        <div id="blog" class="blog section">
            <div class="timeline container">
				...
				<h2><?php echo $resume->title_history ? $resume->title_history : 'HOẠT ĐỘNG' ?></h2>                   
                </header>                
                        ...
                        <div class="timeline-container wow <?php echo $key%2==0?'timeline-left fadeIn':'timeline-right fadeIn';?>">
                            <div class="content">
                                ...
                                <div style="padding: 10px 20px;">
                                    ...
                                    <?php if($value->url) { ?>
                                    <p class="text-center">
                                        <a href="<?php echo $value->url ?>" class="btn btn-default">Xem thêm</a>
                                    </p>
                                    <?php } ?>
                                </div>                        
                            </div>                        
