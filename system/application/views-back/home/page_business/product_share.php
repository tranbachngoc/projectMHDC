  ...
  <section class="main-content">
    <div class="breadcrumb control-board">
      <div class="container">
        <ul>
          <li>
            <img src="/templates/home/styles/images/svg/breadcrumb_arrow.svg" class="mr10" alt="">
            <?php echo $type_pro == 2 ? 'Phiếu mua hàng': 'Sản phẩm' ?> được chia sẻ</li>
        </ul>
    ...
    <div class="container">
      <div class="product-posted">
        <div class="product-posted-tit">
          <?php echo $type_pro == 2 ? 'PHIẾU MUA HÀNG': 'SẢN PHẨM' ?> ĐƯỢC CHIA SẺ</div>
        <div class="product-posted-search">
          <div class="left">
            <div class="input-search">
              <img src="/templates/home/styles/images/svg/search.svg" alt="">
              <input type="text" name="pro_name" value="" class="form-control" placeholder="Tìm theo tên <?php echo $type_pro == 2 ? 'phiếu mua hàng': 'sản phẩm' ?>">
            </div>
          </div>
          <div class="right">
            <div class="select-search">
              <select name="search_branch" id="search_branch">
                ...
                <option value="<?php echo $v_bran['user_id'] ?>">
            ...
            <div class="select-search">
              <select name="search_category" id="search_category">
                ...
                <option value="<?php echo $v_cate['cat_id'] ?>">
        ...
        <div class="product-posted-content">
          <table class="parent-table">
            <tr>
              <th>Tên
                <?php echo $type_pro == 2 ? 'Phiếu mua hàng': 'Sản phẩm' ?>
              </th>
            ...
            <tr class="js-filter-item" data-search="<?=$v['pro_name']?>" data-cname="<?=$v['cat_name']?>" data-sname="<?=$v['shop_name']?>">
                    ...
                    <div class="accordion-toggle">
                      <div class="product-detail">
                        <label class="checkbox-style-circle">
                          <input type="checkbox" name="category" value="aaa">
                          <span></span>
                        </label>
                        <div class="info">
                          <div class="img">
                          ...
                          <div class="name">
                            ...
                            <p class="date">Người đăng:
                              <?php echo $v['pro_poster'] ?>
                              <br>Ngày đăng
                      ...
                      <div class="tablet">
                        <table class="child-table">
                          <tr>
                            <td>Danh mục</td>
                            <td>
                              <?php echo trim($v['cat_name']) ?>
                            </td>
                          </tr>
                          <tr>
                            <td>Giá</td>
                            <td>
                              <?php echo number_format($v['pro_cost'],0,",","."); ?> VNĐ</td>
                          </tr>
                          <tr>
                            <td>Số lượng</td>
                            <td>
                              <?php echo $v['pro_instock'] ?>
                            </td>
                          </tr>
                          <tr>
                            <td>Trạng thái</td>
                            <td class="js-trigger-change-status">
                              <a href="javascript:void(0)">
                                <?php echo $v['status'] == 1 ? 'Đã kích hoạt': 'Chưa kích hoạt' ?>
                              </a>
                            </td>
                          </tr>
                          <tr>
                            <td>Bán qua CTV</td>
                            <td>
                              <?php echo $v['is_product_affiliate'] == 1 ? 'Có': 'Không' ?>
                            </td>
                          </tr>
                        </table>
                      </div>
              ...
              <td class="tablet-none">
                <div class="text-bold text-red">
                  <?php echo number_format($v['pro_cost'],0,",","."); ?> VNĐ</div>
              </td>
              <td class="tablet-none">
                <div class="text-bold">
                  <?php echo $v['pro_instock'] ?>
              ...
              <td class="tablet-none">
                <label class="checkbox-style-circle">
                  <input type="checkbox" data-user-shop="<?php echo $user['use_id']; ?>" data-type="<?php echo $type_pro ?>" data-id="<?php echo $v['pro_id'] ?>"
                    class="is_product_affiliate" name="is_product_affiliate" <?php echo $v[ 'is_product_affiliate']==1 ?
                    'checked': '' ?> disabled="disabled" value="1">
                  <span></span>
                </label>
              </td>
              <td class="tablet-none">
                <label class="checkbox-style-circle">
                  <input type="checkbox" data-user-shop="<?php echo $user['use_id']; ?>" data-type="<?php echo $user['use_group'] == 3 ? 'shop' : 'branch' ?>"
                    data-id="<?php echo $v['pro_id'] ?>" class="pro_status" name="pro_status" <?php echo $v['status']==1
                    ? 'checked': '' ?> value="1" >
                  <span></span>
                </label>
              </td>
...
<script type="text/javascript">
  ...
  $('.js-filter-item .pro_status').change(function () {
    ...
    $.ajax({
      type: 'POST',
      url: '<?=azibai_url("/home/api_affiliate/change_status_product_has_shared")?>',
      data: { list_pro_id: pro_id, status: pro_status, user_id: id_user_shop },
      dataType: 'json',
