...
<main class="ordersmanager">
  <section class="main-content">
    <div class="breadcrumb">
      <div class="container">
        <ul>
          <li><a href="<?=azibai_url()?>">Trang chủ <img src="/templates/home/styles/images/svg/breadcrumb_arrow.svg" class="ml10 mt05" alt=""></a></li>
      ...
      <div class="affiliate-menupage">
        <ul>
          ...
          <li class="<?=isset($_REQUEST['pro_type']) && $_REQUEST['pro_type'] === '3' ? 'active' : ''?>">
            <a href="<?=azibai_url("/manager/order?pro_type=3")?>">
              <span class="icon">
          ...
          <li class="<?=isset($_REQUEST['pro_type']) && $_REQUEST['pro_type'] === '0' ? 'active' : ''?>">
            <a href="<?=azibai_url("/manager/order?pro_type=0")?>">
              <span class="icon">
          ...
          <li class="<?=isset($_REQUEST['pro_type']) && $_REQUEST['pro_type'] === '2' ? 'active' : ''?>">
            <a href="<?=azibai_url("/manager/order?pro_type=2")?>">
              <span class="icon">
          ...
          <div class="ordersmanager-table">
            <table>
              ...
              <tr>
                ...
                <td class="sm-none"><a class="text-red" href="<?=azibai_url("/manager/order/view/{$item['id']}?pro_type={$item['product_type']}")?>">#<?=$item['id']?></a></td>
                <td class="title">
                  <div class="sm">
                    <div class="info">
                      <div class="left">
                        <div class="code"><a class="text-red" href="<?=azibai_url("/manager/order/view/{$item['id']}?pro_type={$item['product_type']}")?>">#<?=$item['id']?></a></div>
                  ...
                  <div class="sm">
                    <div class="text">
                      <p><span>Bán bởi: </span><?=$item['shop']['sho_name']?></p>
                ...
                <td class="sm-none"><?=$item['shop']['sho_name']?></td>
      ...
      <div class="modal-body">
        <div class="ordersmanager-content">
          <div class="search">
            ...
            <div class="search-category">
              <input type="text" class="form-control" name="customer_name" value="<?=$_REQUEST['customer_name']?>" placeholder="Tên người bán" autocomplete="off">
            </div>
            <div class="search-category">
              <input type="text" class="form-control" name="pro_name" value="<?=$_REQUEST['pro_name']?>" placeholder="Tên sản phẩm" autocomplete="off">
            </div>
