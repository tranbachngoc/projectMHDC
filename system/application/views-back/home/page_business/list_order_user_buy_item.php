    ...
    <div class="breadcrumb">
      <div class="container">
        <ul>
          ...
          <li><a href="<?=azibai_url('/manager/order')?>">Quản lý đơn hàng <img src="/templates/home/styles/images/svg/breadcrumb_arrow.svg" class="ml10 mt05" alt=""></a></li>
      ...
      <div class="ordersmanager-content">
        <div class="ordersmanager-content-detail">
          <div class="tt">
            ...
            <div class="right">
              <a href="<?=azibai_url("/manager/order") . (isset($_REQUEST['pro_type']) ? "?pro_type={$_REQUEST['pro_type']}" : "")?>">Quay về danh sách</a>
            </div>
          </div>
          <div class="info">
            <div class="item">
...
<script>
  ...
  $('.js-cancel-order').click(function () {
    ...
    $.ajax({
      type: "post",
      url: "<?=azibai_url("/home/api_affiliate/update_status_user_get_order_detail")?>",
      data: data,
      dataType: "json",
      beforeSend: function () {
        $('.load-wrapp').show();
