...
<script src="/templates/home/js/addnews-update.js?ver=<?=time();?>"></script>
...
<script type="text/javascript">
    ...
    // Set not_description
    <?php if($item->not_description != '') { ?>
        formData.set('not_description','<?=$item->not_description?>');
    <?php } ?>
                    ...
                    <div class="sidebar-right">
                        <div id="preview_content">
                            ...
                            <div id="preslider">
                                <?php if (isset($aListImage) && !empty($aListImage)) { ?>
                                    <div class="wowslider-container">
                                        <div class="ws_images">
                                            <ul class="listimageslider">
                                                <?php foreach ($aListImage as $iKImage => $oImage) { ?>
                                                    <li>
                                                        <img crossorigin="Anonymous" src="<?= $oImage->image_url ?>"
                                                             alt="<?= $oImage->image_title ?>"
                                                             title="<?= $oImage->image_title ?>"
                                                             id="wows<?= $iKImage ?>_0" style="">
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                        <div class="ws_bullets">
                                            <div class="listimagesbullets">
                                                <?php foreach ($aListImage as $iKImage => $oImage) { ?>
                                                    <a href="#" title="img<?= $iKImage ?>"><span><?= $iKImage ?></span></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <script type="text/javascript">
                                        formData.set('not_slideshow', '<?=$item->not_slideshow?>');
                                        formData.set('not_effect', '<?=$item->not_effect?>');
                                        formData.set('not_music', '<?=$item->not_music?>');
                            ...
                            <div id="pretitlecontent">
                                <div class="r-title"><h2><?= $item->not_title ?></h2></div>
                            ...
                            <div id="addNewsFrontEnd">
                                ...
                                <div class="blockdangtin-dangtinby">
                                    <button class="addvideonews">
                                        <img src="/templates/home/images/svg/camera.svg" alt="Video">Ảnh/Video
                                    ...
                                    <button class="more" id="buttonaddfunction">
                                        <img src="/templates/home/images/svg/3dot.svg" alt="">
                                    </button>
                                </div>
                                <div class="boxaddfunctionfooter">
                                    <div class="list-function">
                                        <button class="addfeaturednews">
                                            <img src="/templates/home/images/svg/relatedicon.svg" alt="Tin nổi bật">Tin nổi bật
                                        </button>
                                        <button class="adddesnews">
                                            <img src="/templates/home/images/svg/shortdes.svg" alt="Mô tả ngắn">Mô tả ngắn
                                        </button>
                                        <button class="addstaticnews">
                                            <img src="/templates/home/images/svg/static.svg" alt="Thống kê">Thống kê
                                        </button>
                                        <button class="addkeywordnews">
                                            <img src="/templates/home/images/svg/keyword.svg" alt="Từ khóa">Từ khóa
                                        </button>
                                        <button class="addeffectnews">
                                            <img src="/templates/home/images/svg/slider.svg" alt="Tạo trình chiếu">Tạo trình chiếu
                                        </button>
                                        <button class="addadsnews">
                                            <img src="/templates/home/images/svg/ads.svg" alt="Quảng cáo">Quảng cáo
                                        </button>
                                        <button class="addrelatednews">
                                            <img src="/templates/home/images/svg/relatedcutomer.svg" alt="Liên quan">Liên quan
                                        </button>
                                        <button class="addcategoriesnews">
                                            <img src="/templates/home/images/svg/newscategory.svg" alt="Chuyên mục tin">Chuyên mục tin
                                        </button>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                                <div class="boxaddnew" data-satus="closed">
                                    <input type="text" name="not_title" value="<?= $item->not_title ?>" required
                                           placeholder="Tiêu đề tin (bắt buộc)">
                                ...
                                <div id="tabdescontentlinkmain" class="tabdescontentlink">
                                    <div class="addlinkthem addlinkthem-detail no-slider-for version01"
                                         id="addlinkthem">
                                    ...
                                    <?php if (isset($not_additional) && !empty($not_additional)) { ?>
                                        <?php foreach ($not_additional as $iKIcon => $oIconContent) { ?>
                                            <div class="icon-item-featured <?= $oIconContent->position ?>">
                                                <div class="image">
                                                    <img src="<?= $oIconContent->icon_url ?>">
                                                    <button type="button" class="close remove-icon-item" data-icon="<?= $iKIcon ?>">×</button>
                                                </div>
                                                <div class="infomation">
                                                    <div class="title"><?= $oIconContent->title ?></div>
                                                    <div class="des"><?= $oIconContent->desc ?></div>
                    ...
                    if (isset($icons)) {
                        foreach ($icons as $image) {
                            ...
                            <div class="icon-item chooseimage" style="cursor:pointer;"
                                 data-image-url="<?= $imglink ?>" data-image="<?= $image ?>" title="<?= $image ?>">
...
<div id="myIconOption" class="model-content">
    <div class="wrapp-model">
        <div class="content-model">
            <div class="contents">
                <div class="btn-back js-back"><a href="#">
                        <img src="<?= base_url() ?>templates/home/images/svg/close.svg">
                    </a>
                </div>
