    ...
    <div class="row tintuc">
        ...
        <div class="col-lg-10 col-lg-offset-2 ">
            ...
            <div class="breadcrumbs hidden-xs">
                ...
                <a href="<?php echo base_url(); ?>tintuc/<?php echo $tin_sale_danhmuc[0]->not_pro_cat_id; ?>/<?php echo RemoveSign($tin_sale_danhmuc[0]->cat_name); ?>"><?php echo $tin_sale_danhmuc[0]->cat_name; ?></a><i
            ...
            <div class="row">
                    ...
                    <ul class="sub-menu-tintuc">
                        <li>
                            <a class="btn btn-default" href="<?php echo base_url() . 'tintuc/'; ?>"
                               data-toggle="tooltip" data-placement="top" title="Azinet">
                                <img src="<?php echo base_url()?>images/a.png"/> <span class="hidden-xs">Azinet</span>
                            </a>
                        </li>
                        <li>
                            <a class="btn btn-default" href="<?php echo base_url() . '' . $tin_sale_danhmuc[0]->not_pro_cat_id . '/' . RemoveSign($tin_sale_danhmuc[0]->cat_name) ?>"
                               data-toggle="tooltip" data-placement="top" title="Mua sắm">
                                <i class="fa fa-shopping-basket"></i><span class="hidden-xs">Mua sắm</span>
                            </a>
                        </li>
                        <li class="active">
                            <a class="btn btn-default1" href="<?php echo base_url() . 'tintuc/' . $tin_sale_danhmuc[0]->not_pro_cat_id . '/khuyen-mai/' . RemoveSign($tin_sale_danhmuc[0]->cat_name) ?>"
                        ...
                        <li>
                            <a class="btn btn-default" href="<?php echo base_url() . 'tintuc/' . $tin_sale_danhmuc[0]->not_pro_cat_id . '/tin-hot/' . RemoveSign($tin_sale_danhmuc[0]->cat_name) ?>"
                               data-toggle="tooltip" data-placement="top" title="Tin tức HOT">
                                <i class="fa fa-star fa-fw"></i><span class="hidden-xs">Tin tức HOT</span>
                            </a>
                        </li>
                        <li>
                            <a class="btn btn-default" href="<?php echo base_url() . 'tintuc/' . $tin_sale_danhmuc[0]->not_pro_cat_id . '/xem-nhieu/' . RemoveSign($tin_sale_danhmuc[0]->cat_name) ?>"
                ...
                <div class="clear col-sm-12 visible-xscol-sm-12 visible-xs">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-newspaper-o fa-fw"></i>&nbsp; Tin tức khuyến mãi</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <?php foreach ($tin_sale_danhmuc as $k => $item) { ?>
