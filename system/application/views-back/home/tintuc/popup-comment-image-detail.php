...
<div class="modal commentModal" id="modal-show-comment-sm">
  <div class="modal-dialog modal-dialog-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><img  data-dismiss="modal" src="asset/images/svg/back.svg" width="20" class="mr10 mt05" alt="">Danh sách bình luận</h4>
