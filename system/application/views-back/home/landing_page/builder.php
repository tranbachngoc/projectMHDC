...
<head>
    <meta charset="utf-8">
    <title>Azibai Landing Page</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Loading Bootstrap -->
    <link href="<?php echo base_url()?>/templates/landing_page/bootstrap/css/bootstrap.css" rel="stylesheet">
    <!-- Loading Flat UI -->
    <link href="<?php echo base_url()?>/templates/landing_page/css/flat-ui.css" rel="stylesheet">
    <link href="<?php echo base_url()?>/templates/landing_page/css/style.css" rel="stylesheet">
    <link href="<?php echo base_url()?>/templates/landing_page/css/spectrum.css" rel="stylesheet">
    <link href="<?php echo base_url()?>/templates/landing_page/css/chosen.css" rel="stylesheet">
    <link rel="shortcut icon" href="<?php echo base_url()?>/templates/landing_page/images/favicon.ico">
    <!-- Font Awesome -->
    <link href="<?php echo base_url()?>/templates/landing_page/css/font-awesome.css" rel="stylesheet">
    <link href="<?php echo base_url()?>/templates/landing_page/js/redactor/redactor.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url()?>/templates/landing_page/css/pixicon.css"></head>
<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
<!--[if lt IE 9]>
<script src="<?php echo base_url()?>/templates/landing_page/js/html5shiv.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/respond.min.js"></script>
<![endif]-->
</head>
<body>
<style>
    #clearScreen, #preview,#savePage, #open_page_sections{display:none !important;}
</style>
<div class="menu" id="menu">

    <div class="main" id="main">

        <h3 id="pixlogo" style="color:#fff;">AZIBAI <br/><span>Landing Page</span></h3>
...
<!--            <a href="#exportModal" data-toggle="modal" class="btn btn-sm btn-embossed disabled actionButtons"><i class="pi pixicon-download"></i> Export</a>-->
<!--        </div>-->

<!--        <div class="left_headline left_shadows"><i class="pi pixicon-file"></i> .PixBuilder Project</div>-->
        <div class="pixbuilderdiv">
            <a href="#projModal" id="projPage" data-toggle="modal" class="btn btn-info btn-embossed pull-a actiosnButtons projexp" style="width:80%;margin:0 10%;"><i class="pi pixicon-open" ></i> Export & Import</a>
        </div>
...
<header class="clearfix" data-spy="affix" data-offset-top="40" data-offset-bottom="180">
    ...
    <a href="#" id="clearScreen" class="btn btn-danger btn-embossed pull-right disabled actionButtons pixbtn"><i class="pi pixicon-trash" ></i> Empty Page</a>

    <a href="#previewModal" id="preview" data-toggle="modal" class="btn btn-inverse btn-embossed pull-right disabled actionButtons pixbtn" style="display: none"><i class="pi pixicon-eye"></i> Preview</a>
    ...
    <form action="preview.php" target="_blank" id="pix_preview_form" method="post" style="display:none;">
        ...
        <button type="submit" type="button" class="btn btn-inverse btn-embossed btn-blue actionButtons pixbtn" id="pixshowPreview"><i class="pi pixicon-eye"></i> Preview</button>
    </form>




<!--    <a href="#seoModal" id="seoButton" data-toggle="modal" class="btn btn-info btn-embossed  pull-right actionButtons seo_btn pixbtn" style=""><i class="pi pixicon-cog"></i> SEO</a>-->

    <a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-info btn-embossed pull-right disabled actionButtons pixbtn"><i class="pi pixicon-download"></i> Hoàn Thành</a>

    <a href="#" id="mysavepage" class="btn btn-primary" style=" padding: 10px 50px;">Lưu tạm</a>
    <a href="#" id="savePage" class="btn btn-primary btn-embossed pull-right disabled actionButtons pixbtn"><i class="pi pixicon-square-check"></i> <span class="bLabel" style="display:none;">Nothing new to save</span></a>
...
<div class="container">
    ...
    <div class="screen" id="screen">
        ...
        <div class="toolbar">
            ...
            <div class="top_right_options">
                ...
                <!-- &nbsp;|&nbsp; -->
                <a href="#sectionsModal" data-toggle="modal" id="open_page_sections"><span><i class="pi pixicon-menu"></i> Page Sections</span></a>
            </div>
    ...
    <div class="pix_copy_right"><span>All rights reserved Copyright © 2016 <a style="display:none;" href="http://themeforest.net/item/flatpack-landing-pages-pack-with-page-builder/10591107" class="pix_copy_right" target="_blanck">FLATPACK</a> by <a href="http://pixfort.com" class="pix_copy_right" style="display:none;" target="_blanck">PixFort</a></span><a href="http://azibai.com">Azibai</a></div>
</div><!-- /.container -->
...
<ul class="nav nav-tabs " id="detailTabs">
    ...
    <li style="display: none;"><a href="#link_Tab" id="link_Link"><i class="pi pixicon-paper-clip"></i> Link</a></li>
    <li style="display: none;"><a href="#image_Tab" id="img_Link"><i class="pi pixicon-image"></i> Image</a></li>
    <li style="display: none;"><a href="#icon_Tab" id="icon_Link"><i class="pi pixicon-umbrella"></i> Icons</a></li>
    ...
    <li style="display: none;"><a href="#checkbox_Tab" id="checkbox_Link"><i class="pi pixicon-stack"></i> Checkbox</a></li>
    <li style="display: none;"><a href="#form_Tab" id="form_Link"><i class="pi pixicon-stack"></i> Form Builder</a></li>
    <li style="display: none;"><a href="#paypal_Tab" id="paypal_Link"><i class="pi pixicon-paypal"></i> PayPal Builder</a></li>
    <li style="display: none;"><a href="#animation_Tab" id="animation_Link"><i class="pi pixicon-loader"></i> Animation</a></li>
</ul><!-- /tabs -->
        ...
        <div class="form-group">
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput" style="display:inline-block;width:100% !important;postition:relative;">
                ...
                <div class="buttons">
                    ...
                    <a href="#" class="btn btn-sm btn-embossed fileinput-exists" data-dismiss="fileinput"><i class="pi pixicon-trash"></i>&nbsp;&nbsp;Remove</a>
                </div>
            </div>
        </div>
...
<div class="tab-pane imageFileTab pixformbuilder" id="checkbox_Tab">
    ...
    <input type="text" class="form-control" id="input_checkbox_name" placeholder="Enter Field Name" value="">
    <div class="pix_note" style="" id="pix_edit_note">*Use the same name for each group of checkboxes in the form.</div>
...
<div class="tab-pane imageFileTab pixformbuilder2" id="form_Tab">
    ...
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_field"><i class="pi pixicon-square-plus"></i> Add new Field</button>
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_select"><i class="pi pixicon-add-to-list"></i> Add new Select</button>
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_textarea"><i class="pi pixicon-align-left"></i> Add new Text Area</button>
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_radio"><i class="pi pixicon-target"></i> Add new radio</button>
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_checkboxs"><i class="pi pixicon-list"></i> Add new checkboxs</button>
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_date"><i class="pi pixicon-clock"></i> Add new date field</button>
    <button type="button" class="btn btn-embossed btn-sm btn-block" id="add_terms"><i class="pi pixicon-paper"></i> Add new accept terms</button>
...
<div class="tab-pane imageFileTab pixpaypalbuilder" id="paypal_Tab">
    ...
    <div id="paypal_complex" class="">
        ...
        <input type="text" class="form-control" id="paypal_item_price" placeholder="Enter item price" value="">
        <div class="pix_note" style="display:none;padding:5px 0;padding-top:8px;" id="paypal_price_note">This form has complex price field, for more information about editing it please check <a href="http://support.pixfort.com/doc/flatpack/#paypal_complex" target="_blanck">the documentation file</a>.</div>
    </div>

    <label>Enter successful return URL:</label>
    <input type="text" class="form-control" id="paypal_successful_url" placeholder="Enter return URL" value="">
    ...
    <div class="pix_note" id="pix_paypal_note">* For more information about the PayPal integration please check the <a href="http://support.pixfort.com/doc/flatpack/#paypal" target="_blanck">documentation file</a>.</div>
...
<div class="tab-pane imageFileTab pixanimations" id="animation_Tab">
    ...
    <input type="text" class="form-control" id="data-anim-delay" placeholder="Enter delay time in milliseconds" value="">
...
<div class="margin-bottom-5 savebtn_div">
    <button type="button" class="btn btn-primary btn-embossed btn-sm btn-block" id="saveStyling"><i class="pi pixicon-circle-check"></i> Apply Changes</button>
</div>

<div class="sideButtons clearfix">
    <button type="button" class="btn btn-inverse btn-embossed btn-xs" id="cloneElementButton"><i class="pi pixicon-stack"></i> Clone</button>
    <button type="button" class="btn btn-warning btn-embossed btn-xs" id="resetStyleButton"><i class="pi pixicon-repeat"></i> Reset</button>
    <button type="button" class="btn btn-danger btn-embossed btn-xs" id="removeElementButton"><i class="pi pixicon-trash"></i> Remove</button>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><i class="pi pixicon-cross"></i><span class="sr-only">Close</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-embossed" data-dismiss="modal"><span class="fui-cross"></span> Close</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <textarea style="width:100%;max-width:100%;min-height:300px;" class="form-control" id="cssToEdit">body *{background: #000 !important;}</textarea>

                <!-- <button type="button" class="btn btn-embossed" id="firas2"><span class="fui-check"></span> shit</button> -->
            </div><!-- /.modal-body -->
            <div class="modal-footer">
                <button type="button" class="btn btn-embossed" data-dismiss="modal"><span class="fui-cross"></span> Close</button>
                <button type="button" class="btn btn-embossed" data-dismiss="modal" id="css_save"><span class="fui-check"></span> Save</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class="pi pixicon-cog"></i> SEO Settings for <span id="pix_seo_title" class="text-primary pName">index.html</span></h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-embossed" data-dismiss="modal"><i class="pi pixicon-cross"></i> Cancel</button>
                <button type="button" class="btn btn-primary btn-embossed" data-dismiss="modal" id="seoSubmittButton"><i class="pi pixicon-check"></i> Save SEO Settings</button>
...
<div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg bigModal">
        <form action="<?php echo base_url();?>landing_page/saveLandingPage"  id="markupForm" method="post" class="form-horizontal">
            <input style="display:none;" type="text" name="landing_id" value="<?php echo $landingId; ?>" >
            <input style="display:none;" type="text" name="content" id="mycontent" value="" >
            <input style="display:none;" type="text" name="name" id="" value="<?php echo $name; ?>" >
            <input style="display:none;" type="text" name="templateId" value="<?php echo $templateId; ?>" >
            <input type="hidden" name="markup" value="" id="markupField">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="pi pixicon-download"></i> Hoàn thành chỉnh sửa</h4>
                </div>
                <div class="modal-body">
Bạn sẽ được chuyển sang trang chi tiết
                </div><!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-embossed" data-dismiss="modal" id="exportCancel"><i class="pi pixicon-cross"></i> Hủy bỏ</button>
<!--                    <button type="button" class="btn btn-embossed" data-dismiss="modal" id="exportSave"><i class="pi pixicon-check"></i> Save</button>-->
                    <button type="submit" type="button" class="btn btn-primary btn-embossed" id="exportSubmit"><i class="pi pixicon-download"></i> Hoàn thành</button>
                </div>
            </div><!-- /.modal-content -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="pi pixicon-open"></i> Export/Import PIXBUILDER Project</h4>
                </div>
                <div class="modal-body">
                    <div class="row text-center">
                        <div class="col-sm-6 export_import">
                            <form action="expImp.php" target="_blank" id="markFormExp" class="form-horizontal" method="post">
                        ...
                        <div class="col-sm-6 export_import left_border">
                            <form action="expImp.php" id="markFormImp" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <p>Import .pixbuilder Project</p>
                                <div>
                                <span class="file-input btn btn-primary btn-file ">
                                   <span class="fa fa-upload"></span> &nbsp;Browse… <input type="file" id="fileinput" name="projectImp" multiple="">
                                </span>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-embossed" data-dismiss="modal" id="exportCancel"><i class="pi pixicon-cross"></i> Cancel</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        <b class="white_text">Please note:</b> you can only preview a single page; links to other pages won't work. When you make changes to your page, reloading the preview won't work, instead you'll have to use the "Preview" button again.
                    </p>
                    <input type="checkbox" name="fast_preview" value="" id="pixcheck"><span class="preview_remember"> Don't show this again. </span><br>

                </div><!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn  btn-embossed" data-dismiss="modal" id="previewCancel"><i class="pi pixicon-cross"></i> Cancel</button>
                    <button type="submit" type="button" class="btn btn-embossed btn-blue" id="showPreview"><i class="pi pixicon-eye"></i> Show Preview</button>
...
<div class="modal fade small-modal" id="deleteBlock" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn  btn-embossed" data-dismiss="modal"><i class="pi pixicon-cross"></i> Cancel</button>
                <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteBlockConfirm"><i class="pi pixicon-trash"></i> Delete</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade small-modal" id="deleteAll" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-embossed" data-dismiss="modal"><i class="pi pixicon-cross"></i> Cancel</button>
                <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteAllConfirm"><i class="pi pixicon-trash"></i> Delete</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade small-modal" id="deletePage" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-embossed" data-dismiss="modal" id="deletePageCancel"><i class="pi pixicon-cross"></i> Cancel</button>
                <button type="button" type="button" class="btn btn-primary btn-embossed" id="deletePageConfirm"><i class="pi pixicon-trash"></i> Delete</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<script src="<?php echo base_url()?>/templates/landing_page/js/jquery-1.8.3.min.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/jquery-ui.min.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/jquery.ui.touch-punch.min.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/bootstrap.min.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/bootstrap-select.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/bootstrap-switch.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/flatui-checkbox.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/flatui-radio.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/jquery.tagsinput.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/flatui-fileinput.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/jquery.placeholder.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/jquery.zoomer.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/application.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/spectrum.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/chosen.jquery.min.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/redactor/redactor.min.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/redactor/table.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/redactor/bufferButtons.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/src-min-noconflict/ace.js"></script>
<script src="<?php echo base_url()?>/templates/landing_page/elements.json"></script>
<script src="<?php echo base_url()?>/templates/landing_page/js/builder.js"></script>
...
<script>
    $(function(){
        ...
        AddDefaultJSon(<?php echo $landingId ?>);
        exportPage();
        $('#mysavepage,#exportPage').click(function(){
            $('#savePage').click();
            saveLandingPage();
        });
...
//    function loadIframe() {
//
//        $("#frameWrapper iframe").each(function(){
//            console.log($(this).attr("src"));
//            if ( $(this).length ) {
//                $(this).attr('src',"http://"+ location.host + "/templates/landing_page/" + $(this).attr("src"));
//            }
//        });
//        return true;
//    }
    ...
    function saveLandingPage(){
        var landing_id = '<?php echo $landingId; ?>';
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>landing_page/saveJson/",
            data: { landing_id: landing_id, content : content, templateId : templateId }
        })
            .done(function( msg ) {
                if(msg.isOk){
    ...
    function AddDefaultJSon(id){
        $.ajax({url: "<?php echo base_url(); ?>landing_page/html/"+id, success: function(datae){
            var data = JSON.parse(datae);
            var isReload = 0;
            if(data.isOk){
                var contents = JSON.parse(data.content);
                var size = Object.keys(contents).length;
                if(localStorage.length != size){
                    localStorage.clear();
                    isReload = 1;
                }
                for (var key in contents) {
                    if(localStorage[key] != contents[key]){
                        localStorage[key] = contents[key];
                        isReload = 1;
                    }
                }
                if(isReload){
