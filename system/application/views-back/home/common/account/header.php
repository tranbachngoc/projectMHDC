...
<html lang="vi">
	...
	<meta property="og:title" content="<?php echo (isset($ogtitle)) ? $ogtitle : settingTitle; ?>"/>
	<meta property="og:description" content="<?php echo (isset($ogdescription)) ? $ogdescription : settingDescr; ?>"/>
	...
	<meta property="og:image:alt" content="<?php echo (isset($ogtitle)) ? $ogtitle : '' ?>"/>
...
<!--					    <li>
		...
		<?php if ($isMobile == 0) { ?>
    		<div class="header-news" class="hidden-xs">
