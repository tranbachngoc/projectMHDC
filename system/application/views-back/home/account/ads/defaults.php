...
<!--BEGIN: RIGHT-->
 <SCRIPT TYPE="text/javascript">
  function SearchRaoVat(type,baseUrl){
		  ...
		  window.location = baseUrl+'account/ads/search/title/keyword/'+product_name+'/';
...
if($type == "ads" || $type_in_search=="ads"){
	$type=2;
}else{
	$type = 1;
}
        ...
        <tr>
            <td >
                <table border="0" width="100%" height="29" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="46" class="title_account_0">#</td>
                ...
                <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'f1f9ff';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                        ...
                        <td height="32" class="line_account_2">
                            <a class="menu_1" href="<?php echo base_url(); ?>ads/category/detail/<?php echo $adsArray->ads_category; ?>/<?php echo $adsArray->ads_id; ?>/<?php echo RemoveSign($adsArray->ads_title); ?>" onmouseover="ddrivetip('<?php echo $adsArray->ads_descr; ?>',300,'#F0F8FF');" onmouseout="hideddrivetip();">
                        ...
                        <td width="45" height="32" class="line_account_5">
                            <img src="<?php echo base_url(); ?>templates/home/images/edit.jpg" onclick="ActionLink('<?php echo base_url(); ?>account/ads/edit/<?php echo $adsArray->ads_id; ?>')" alt="<?php echo $this->lang->line('edit_tip'); ?>" style="cursor:pointer;" border="0" />
                        </td>
                    </tr>
                    <?php $idDiv++; ?>
                    <?php $sTT++; ?>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center" id="boxfilter_account">
                            ...
                            <img src="<?php echo base_url(); ?>templates/home/images/icon_filter.gif" onclick="ActionSearch('<?php echo base_url(); ?>account/ads/', 0)" border="0" style="cursor:pointer;" alt="<?php echo $this->lang->line('search_tip'); ?>" />
                        </td>
