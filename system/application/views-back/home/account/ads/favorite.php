                ...
                <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'f1f9ff';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                        ...
                        <td height="32" class="line_account_2">
                            <a class="menu_1" href="<?php echo base_url(); ?>ads/category/detail/<?php echo $favoriteAdsArray->ads_category; ?>/<?php echo $favoriteAdsArray->ads_id; ?>/<?php echo RemoveSign($favoriteAdsArray->ads_title); ?>" onmouseover="ddrivetip('<?php echo $favoriteAdsArray->ads_descr; ?>',300,'#F0F8FF');" onmouseout="hideddrivetip();">
                        ...
                        <td width="125" height="32" class="line_account_4">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center" id="boxfilter_account">
                            ...
                            <img src="<?php echo base_url(); ?>templates/home/images/icon_filter.gif" onclick="ActionSearch('<?php echo base_url(); ?>account/ads/favorite/', 0)" border="0" style="cursor:pointer;" alt="<?php echo $this->lang->line('search_tip'); ?>" />
                        </td>
