    ...
    <table class="table table-bordered" width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>            
            <td>
				...
				<?php echo $this->lang->line('title_job_edit'); ?>
                </div>
                <div class="fr"></div>
                </div>
            </td>
                ...
                <table class="post_main" align="center" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            hoặc điền
                                ...
                                <input type="text"  name="nganhnghe_dien" id="nganhnghe_dien" maxlength="120" class="input_formpost" style="width:120px;"  value="<?php echo $job_nganhnghe_dien; ?>"/>                                
                    ...
                    <tr>
                        ...
                        <select name="yeu_cau_trinh_Do" id="yeu_cau_trinh_Do" class="selectcategory_formpost">
                            <option value="0" >Bạn hãy chọn</option>
                             <option value="Tốt nghiệp đại học tại chức trở lên" <?php if($level_job=="Tốt nghiệp đại học tại chức trở lên" ) {echo "selected=\"selected\"";} ?> >Tốt nghiệp đại học tại chức trở lên</option>
                                 <option value="Tốt nghiệp cấp 2  trở lên" <?php if($level_job=="Tốt nghiệp cấp 2  trở lên" ) {echo "selected=\"selected\"";} ?>  >Tốt nghiệp cấp 2  trở lên</option>
                                      <option value="Tốt nghiệp cấp 3  trở lên"   <?php if($level_job=="Tốt nghiệp cấp 3  trở lên" ) {echo "selected=\"selected\"";} ?>  >Tốt nghiệp cấp 3 trở lên</option>
                                            <option value="Tốt nghiệp trung cấp  trở lên"   <?php if($level_job=="Tốt nghiệp trung cấp  trở lên" ) {echo "selected=\"selected\"";} ?> >Tốt nghiệp trung cấp trở lên</option>
                                                 <option value="Tốt nghiệp cao đẳng  trở lên" <?php if($level_job=="Tốt nghiệp cao đẳng  trở lên" ) {echo "selected=\"selected\"";} ?> >Tốt nghiệp cao đẳng trở lên</option>
                                                  <option value="Tốt nghiệp đại học  trở lên" <?php if($level_job=="Tốt nghiệp đại học  trở lên" ) {echo "selected=\"selected\"";} ?>  >Tốt nghiệp đại học trở lên</option>
                                                     <option value="Tốt nghiệp master  trở lên"  <?php if($level_job=="Tốt nghiệp master  trở lên" ) {echo "selected=\"selected\"";} ?> >Tốt nghiệp master trở lên</option>
                                                        <option value="Tiến sỹ" <?php if($level_job=="Tiến sỹ" ) {echo "selected=\"selected\"";} ?> >Tiến sỹ</option>
                                                         <option value="Kỹ sư" <?php if($level_job=="Kỹ sư" ) {echo "selected=\"selected\"";} ?>  >Kỹ sư</option>
                          </select>
                          <span>
                          hoặc điền
                          </span>
                          
                            <input type="text" value="<?php if($level_job!="Tốt nghiệp đại học tại chức trở lên" && $level_job!="Tốt nghiệp cấp 2  trở lên" && $level_job!="Tốt nghiệp cấp 3  trở lên" && $level_job!="Tốt nghiệp trung cấp  trở lên" && $level_job!="Tốt nghiệp cao đẳng  trở lên" && $level_job!="Tốt nghiệp đại học  trở lên" && $level_job!="Tốt nghiệp master  trở lên" && $level_job!="Tiến sỹ"  && $level_job!="Kỹ sư"  ) { echo $level_job; } ?> " name="level_job" id="level_job" maxlength="120" class="input_formpost" style="width:130px;"/>
                    ...
                    <tr>
                        ...
                        <td style="padding-top:5px;">
                              ...
                              <textarea name="require_job" id="require_job" rows="2" cols="45"  ><?php if(isset($require_job)){echo $require_job;} ?></textarea>
                    ...
                    <tr>
                        ...
                        <td style="padding-top:5px;">
                           <textarea name="experience_job" id="experience_job" style="width:300px;" cols="45"><?php echo $job_exper ; ?></textarea>
                    ...
                    <tr>
                        ...
                        <select name="time_job" id="time_job" class="selecttime_formpost">
                                <option value="1"  <?php if(isset($time_job) && $time_job == '1'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> > Bán thời gian </option>
                                <option value="2"  <?php if(isset($time_job) && $time_job == '2'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> >Toàn thời gian</option>
                                <option value="3"  <?php if(isset($time_job) && $time_job == '3'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> >Hành chính</option>
                             	<option value="4"  <?php if(isset($time_job) && $time_job == '4'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> >Buổi sáng</option>
                              	<option value="5"  <?php if(isset($time_job) && $time_job == '5'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> >Buổi trưa</option>
                                <option value="6"   <?php if(isset($time_job) && $time_job == '6'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> >Buổi tối</option>
                                <option value="7"  <?php if(isset($time_job) && $time_job == '7'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?> >Thời gian khác</option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <textarea name="interest_job" id="interest_job" rows="3" class="textarea_post" onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('interest_job',1)" onblur="ChangeStyle('interest_job',2)" cols="45" /><?php if(isset($interest_job)){echo $interest_job;} ?></textarea>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <textarea name="record_job" id="record_job" rows="3" class="textarea_post" onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('record_job',1)" onblur="ChangeStyle('record_job',2)" cols="45" /><?php if(isset($record_job)){echo $record_job;} ?></textarea>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                       ...
                                       <textarea id="txtContent" name="txtContent" cols="45" style="width:300px;" rows="5"><?php echo $job_detail ;?></textarea>
                                    </td>
                                    <td style="padding-top:7px;">
                    ...
                    <tr>
                        ...
                        <div style=" clear:both; padding-top:10px;">
                           ...
                           <textarea id="gioi_thieu_nha_tuyen_dung" name="gioi_thieu_nha_tuyen_dung" rows="2" style="width:300px;" cols="45"><?php echo $job_gioithieu_nhatuyendung ; ?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>                          
                            <input type="text" name="fax_job_nha_tuyen_dung" id="fax_job_nha_tuyen_dung" maxlength="50"  class="input_formpost" value="<?php echo $job_fax_nhatuyendung ; ?>" />
                    ...
                    <tr>
                        ...
                        <div style="clear:both; padding-top:10px;">
                               ...
                               <input name="checkbox_lienhetructiep" type="checkbox" id="checkbox_lienhetructiep"  /><?php echo $this->lang->line('best_contact_1_contact_job_edit');; ?>
                          <input name="checkbox_lienhedienthoai" type="checkbox" id="checkbox_lienhedienthoai"  /><?php echo $this->lang->line('best_contact_2_contact_job_edit'); ?>
                          <input name="checkbox_Email" type="checkbox" id="checkbox_Email"  />
                          <?php echo $this->lang->line('best_contact_3_contact_job_edit'); ?>
                            <input name="checkbox_Chatyahoo_sype" type="checkbox" id="checkbox_Chatyahoo_sype"  />
                            <?php echo $this->lang->line('best_contact_4_contact_job_edit'); ?>
                             <input name="checkbox_website" type="checkbox" id="checkbox_website"  />
                             <?php echo $this->lang->line('best_contact_5_contact_job_edit'); ?>
                    ...
                    <tr>
                        ...
                        <td align="left" style="padding-top:7px;">
                            <img src="<?php echo $imageCaptchaEditJobAccount; ?>" width="151" height="30" /><br />
...
//-->
                                    ...
                                    <input type="button" onclick="CheckInput_EditJob();" name="submit_editjob" value="<?php echo $this->lang->line('button_agree_job_edit'); ?>" class="button_form" /></td>
                                    <td width="15"></td>
                    ...
                    <tr>
                        <td class="success_post" style="padding-top:10px;">
                            <p class="text-center"><a href="<?php echo base_url(); ?>account/job">Click vào đây để tiếp tục</a></p>
