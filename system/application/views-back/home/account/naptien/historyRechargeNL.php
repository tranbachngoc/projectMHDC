            ...
            <div style="background-color: white">
                <div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="_nganluong">
                                ...
                                <?php if (count($listHistoryRecharge) > 0) { ?>
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="20%" align="center">Ngày gởi yêu cầu</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <?php foreach ($listHistoryRecharge as $key => $vals): ?>
                                            <tr>
                                                <td class="bk_email"><?php echo ++$key; ?></td>
                                                <td class="bk_email red_money"><?php echo number_format($vals->order_total, 0, ",", "."); ?></td>
                                                <td class="bk_email"><?php echo ($vals->payment_status == 1) ? "Nạp thành công" : ""; ?></td>
                                                <td class="bk_email"><?php echo date("d-m-Y H:i:s", $vals->date); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                <?php } else { ?>
                        ...
                        <div class="tab-pane" id="_banking">
                            &nbsp;  
                        </div>
                    </div>
                </div>
