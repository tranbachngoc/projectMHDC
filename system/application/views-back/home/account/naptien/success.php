...
<div class="text_header">
		...
		<span>vào tài khoản thông qua cổng thanh toán sohapay</span>
</div>
...
<div>
<h2> Quá trình thanh toán thành công</h2>
Quá trình thanh toán của bạn đã hoàn tất, chọn các hành động sau:
<ul>
<li><A href="<?php echo base_url()."account/lichsugiaodich" ?>">Xem lịch sử giao dịch</a></li>
<li><a href="<?php echo base_url()."account/naptien" ?>">Nạp thêm tiền</a></li>
