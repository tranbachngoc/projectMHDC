		...
		<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <form name="frmTasktoday" id="frmTasktoday" method="post">
                    <h4 class="page-header text-uppercase" style="margin-top: 10px;">
                        ...
                        $y = date("Y");
                        ?>
                        <span>Công việc trong ngày</span>( <?php if(empty($getday)){echo date('d').'/';} else{echo $getday.'/' ;} if(isset($month)){ echo $month. '/';} else{ echo $m. '/';} echo $y;?> )
			...
			<div class="none_record">
			    <p class="text-center">
				<span>Không có công việc nào được giao!</span>
			    </p>
			</div>
		    <?php }  else { ?>
			<div class="table-responsive">
				...
				<tbody>
				<?php foreach( $tasklist as $key => $items)
