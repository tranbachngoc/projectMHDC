                    ...
                    <?php if($shop->sho_id > 0) { ?>
                        ...
                        <?php } ?>
                            ...
                            <div class="form-group">
                                <input type="text" name="txtdomain" id="txtdomain" placeholder="Nhập tên miền của bạn" class="form-control" value="<?php echo $shop->domain; ?>" required />
                                <br>
				<p>Lưu ý:</p>
