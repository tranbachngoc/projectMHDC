        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            <h4 class="page-header text-uppercase" style="margin-top:10px">                
                ...
                <?php if ($group_id == AffiliateUser) { ?>
                    Thu nhập từ giới thiệu bán hàng của tôi
                <?php } ?>
				
                <?php if ($group_id == BranchUser) { ?>
                    Thu nhập Từ Chi Nhánh
                <?php } ?>
            ...
            <div class="panel panel-default panel-custom">
                <div class="panel-body">
                    <form name="frmAccountPro" action="<?php echo base_url() . 'account/income/user'; ?>" method="post" >
                        <div class="row">
                            <?php if ($filter['status'] == 0): ?>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Loại thu nhập:</label>
                                        <select name="ctype" class="form-control" autocomplete="off">
