...
<!--BEGIN: RIGHT-->
 <SCRIPT TYPE="text/javascript">
  function SearchRaoVat(baseUrl){	
		  ...
		  window.location = baseUrl+'account/pexpiration/search/name/keyword/'+product_name+'/';		 	
}
<!--
        ...
        <tr>
            <td class="main_list" valign="top" >
                <table border="0" width="788" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="none_record_search" align="center">Không có sản phẩm hết hạn nào được tìm thấy theo yêu cầu của bạn</td>
					</tr>
                </table>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
