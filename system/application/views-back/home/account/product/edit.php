...
<div class="container-fluid">
    <div class="row">
        ...
        <script language="javascript"
                src="<?php echo base_url(); ?>templates/home/js/jupload-crop-images/jquery.Jcrop.min.js"></script>
        <script language="javascript"
                src="<?php echo base_url(); ?>templates/home/js/jupload-crop-images/script.js"></script>
        <script>
            ...
            <form name="frmEditPro" id="frmEditPro" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?php if ($shopid > 0) { ?>
                    <?php if ($successEditProductAccount == false) { ?>
                        <div class="form-group">
                            <label class="col-sm-3 col-xs-12 control-label "><span style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('category_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <div id="category_pro_0" style="margin-bottom:15px">
                                    <select onchange="check_postCategoryProduct('<?php echo $pro ?>',this.value,0,'<?php echo base_url(); ?>');"
                                        id="cat_pro_0" name="category_pro_0" class="form-control form_control_cat_select">
                                        <option value=""> -- Chọn danh mục sản phẩm --</option>
                                        <?php if (isset($catlevel0) && count($catlevel0) > 0) {
                                            foreach ($catlevel0 as $item) { ?>
                                                <option value="<?php echo $item->cat_id; ?>" data-value="<?php echo $item->b2c_fee; ?>" <?php echo ($cat_level_1[0]->parent_id == $item->cat_id) ? 'selected="selected"' : ''; ?>><?php echo $item->cat_name; ?><?php echo ($item->child_count > 0) ? ' >' : ''; ?></option>
                                                <?php
                                            }
                                        } ?>
                                    </select>
                                ...
                                <div id="category_pro_1" style="margin-bottom:15px">
                                    <?php if (isset($cat_level_1)) { ?>
                                        <select name="cat_pro_1" id="cat_pro_1" class="form-control form_control_cat_select" onchange="check_postCategoryProduct('<?php echo $pro ?>',this.value,1,'<?php echo base_url(); ?>');">
                                            <option value="0">--Chọn danh mục cho <?php echo $pro ?>--</option>
                                            <?php foreach ($cat_level_1 as $item) { ?>
                                                <?php if ($cat_level_2[0]->parent_id == $item->cat_id) { ?>
                                                    <option value="<?php echo $item->cat_id; ?>" data-value="<?php echo $item->b2c_fee; ?>" selected="selected"><?php echo $item->cat_name .' >'; ?></option>
                                                <?php } else {
                                                    if (isset($category_pro) && $category_pro == $item->cat_id) { ?>
                                                        <option value="<?php echo $item->cat_id; ?>" data-value="<?php echo $item->b2c_fee; ?>" selected="selected"><?php echo $item->cat_name; ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo $item->cat_id; ?>" data-value="<?php echo $item->b2c_fee; ?>"><?php echo $item->cat_name; ?></option>
                                                    <?php }
                                                }
                                            } ?>
                                        </select>
                                ...
                                <div id="category_pro_2" style="margin-bottom:15px">
                                    <?php if (isset($cat_level_2)) { ?>
                                        <select name="cat_pro_2" id="cat_pro_2" class="form-control form_control_cat_select" onchange="check_postCategoryProduct('<?php echo $pro ?>',this.value,2,'<?php echo base_url(); ?>');">
                                            <option value="0">--Chọn danh mục cho <?php echo $pro ?>--</option>
                                            <?php foreach ($cat_level_2 as $item) { ?>
                                                ...
                                                <?php } else {
                                                    if (isset($category_pro) && $category_pro == $item->cat_id) { ?>
                                                        <option value="<?php echo $item->cat_id; ?>" selected="selected" data-value="<?php echo $item->b2c_fee; ?>"><?php echo $item->cat_name; ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo $item->cat_id; ?>" data-value="<?php echo $item->b2c_fee; ?>"><?php echo $item->cat_name; ?></option>
                                                    <?php }
                                                }
                                ...
                                <div id="category_pro_3" style="margin-bottom:15px">
                                    <?php if (isset($cat_level_3)) { ?>
                                        <select name="cat_pro_3" id="cat_pro_3" class="form-control form_control_cat_select" onchange="check_postCategoryProduct('<?php echo $pro ?>',this.value,3,'<?php echo base_url(); ?>');">
                                            <option value="0">--Chọn danh mục cho <?php echo $pro ?>--</option>
                                ...
                                <div id="category_pro_4" style="margin-bottom:15px">
                                    <?php if (isset($cat_level_4)) { ?>
                                        <select name="cat_pro_4" id="cat_pro_4" class="form-control form_control_cat_select" onchange="check_postCategoryProduct('<?php echo $pro ?>',this.value,4,'<?php echo base_url(); ?>');">
                                            <option value="0">--Chọn danh mục cho <?php echo $pro ?>--</option>
                                            <?php
                        ...
                        <div class="form-group">
                            <label for="name_pro" class="col-sm-3 col-xs-12 control-label "><span
                                    style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('name_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" value="<?php if (isset($name_pro)) {
                                    echo $name_pro;
                                } ?>" name="name_pro" id="name_pro" maxlength="80" class="form-control"
                                       onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('name_pro',1)"
                                       onblur="ChangeStyle('name_pro',2)" onkeypress="return submitenter(this,event)"/>
                        ...
                        <div class="form-group">
                            <label for="pro_sku" class="col-sm-3 col-xs-12 control-label "><span
                                    style="color: #FF0000"><b>*</b></span> Mã <?php echo $pro ?>:
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" value="<?php if (isset($sku_pro)) {
                                    echo $sku_pro;
                                } ?>" name="pro_sku" id="pro_sku" maxlength="35" class="form-control"
                                       placeholder="Nhập tối đa 35 ký tự"
                                       onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('pro_sku',1)"
                                       onblur="ChangeStyle('pro_sku',2)" onkeypress="return submitenter(this,event)"/>
                        ...
                        <div class="form-group">
                            <label for="descr_pro"
                                   class="col-sm-3 col-xs-12 control-label "><span
                                    style="color: #FF0000"><b>*</b></span><?php echo $this->lang->line('descr_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" value="<?php if (isset($descr_pro)) {
                                    echo $descr_pro;
                                } ?>" name="descr_pro" id="descr_pro" maxlength="120" class="form-control"
                                       onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('descr_pro',1)"
                                       onblur="ChangeStyle('descr_pro',2)" onkeypress="return submitenter(this,event)"/>
                        ...
                        <div class="form-group">
                            <label for="image_1_pro" class="col-sm-3 col-xs-12 control-label "><span
                                    style="color: #ff0000">* </span><?php echo $this->lang->line('image_1_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <div style=" display:<?php if ($imageDetail[0] != '') {
                                    echo "none";
                                } else {
                                    echo "block";
                                } ?>" id="vavatar_input1">
                                    <span class="btn btn-primary btn-file upload_btn inputimage_formpost"
                                          name="image_1_pro" id="image_1_pro"
                                          onclick="show_popup('popup_upload', 1);"><i class="fa fa-upload"
                                                                                      aria-hidden="true"></i> Chọn Ảnh</span>
                                    <input type="text" placeholder="Chưa chọn ảnh" id="nameImage_1" disabled="disabled"
                                    ...
                                    <input class="btn btn-default" type="button"
                                           onclick="resetBrowesIimgQ('image_1_pro',1);" value="Hủy"/>
                                    <p><span class="text-warning"><i class="fa fa-info-circle" aria-hidden="true"></i> (<?php echo $this->lang->line('image_help'); ?>
                                            )</span></p>
                                ...
                                <div style=" display:<?php if ($imageDetail[0] == '') {
                                    ...
                                    echo "block";
                                } ?>" id="img_vavatar_input1">
                                    <div style="float:left;">
                                        <?php if ($imageDetail[0] != "") { ?>
                                            <img src="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/'. $pro_dir .'/thumbnail_1_'. $imageDetail[0]; ?>"
                                                style="max-height:100px; max-width:100x; margin-top:5px; clear:both;"/>
                                        <?php } ?>
                                    </div>
                                    <div style="float:left; " class="xoa_hinh_nay">
                                        <img style="margin-top:7px;"
                                             ...
                                             title="Xóa hình này"
                                             onclick=" return delete_img_pro('<?php echo base_url(); ?>home/account/','<?php echo $pro_id; ?>','<?php echo $imageDetail[0]; ?>', 0);"/>
                                    </div>
                                </div>
                                <input id="image1_edit" type="hidden" value="<?php echo $imageDetail[0] ?>"
                                       name="image1_edit">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="image_2_pro"
                                   class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('image_2_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <div style=" display:<?php if ($imageDetail[1] != '') {
                                    echo "none";
                                } else {
                                    echo "block";
                                } ?>" id="vavatar_input2">
                                    <span class="btn btn-primary btn-file upload_btn inputimage_formpost"
                                          name="image_2_pro" id="image_2_pro" onclick="show_popup('popup_upload', 2);"><i class="fa fa-upload" aria-hidden="true"></i> Chọn Ảnh</span>
                                    <input type="text" placeholder="Chưa chọn ảnh" id="nameImage_2" disabled="disabled"
                                           style="border:none;background:none;padding: 5px;"/>
                                    <!-- <span class="btn btn-primary btn-file">
                                        <i class="fa fa-upload" aria-hidden="true"></i> Chọn File
                                ...
                                <div style=" display:<?php if ($imageDetail[1] == '') {
                                    ...
                                    echo "block";
                                } ?>" id="img_vavatar_input2">
                                    <div style="float:left;">
                                        <?php if ($imageDetail[1] != "") { ?>
                                            <img src="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/'. $pro_dir .'/thumbnail_1_'. $imageDetail[1] ?>" style="max-height:100px; max-width:100px; margin-top:5px; clear:both;"/>
                                        <?php } ?>
                                    </div>
                                    <div style="float:left; " class="xoa_hinh_nay">
                                        <img style="margin-top:7px;" src="<?php echo base_url(); ?>templates/home/images/xoaimg.png" border="0" title="Xóa hình này "
                                             onclick=" return delete_img_pro('<?php echo base_url(); ?>home/account/','<?php echo $pro_id; ?>','<?php echo $imageDetail[1]; ?>,',1);"/>
                                    </div>
                                </div>
                                <input id="image2_edit" type="hidden" value="<?php echo $imageDetail[1]; ?>"
                                       name="image2_edit">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="image_3_pro"
                                   class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('image_3_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <div style=" display:<?php if ($imageDetail[2] != '') {
                                    echo "none";
                                } else {
                                    echo "block";
                                } ?>" id="vavatar_input3">
                                    <span class="btn btn-primary btn-file upload_btn inputimage_formpost"
                                          name="image_3_pro" id="image_3_pro"
                                          onclick="show_popup('popup_upload', 3);"><i class="fa fa-upload"
                                                                                      aria-hidden="true"></i> Chọn Ảnh</span>
                                    <input type="text" placeholder="Chưa chọn ảnh" id="nameImage_3" disabled="disabled"
                                           style="border:none;background:none;padding: 5px;"/>
                                    <!--  <span class="btn btn-primary btn-file">
                                         <i class="fa fa-upload" aria-hidden="true"></i> Chọn File
                                    ...
                                    <input class="btn btn-default" type="button"
                                           onclick="resetBrowesIimgQ('image_3_pro',3);" value="Hủy"/>
                                    <p><span class="text-warning"><i class="fa fa-info-circle" aria-hidden="true"></i> (<?php echo $this->lang->line('image_help'); ?>
                                            )</span></p>
                                ...
                                <div style=" display:<?php if ($imageDetail[2] == '') {
                                    ...
                                    echo "block";
                                } ?>" id="img_vavatar_input3">
                                    <div style="float:left;">
                                        <?php if ($imageDetail[2] != "") { ?>
                                            <img src="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/'. $pro_dir .'/thumbnail_1_'. $imageDetail[2]; ?>"
                                                style="max-height:100px; max-width:100px; margin-top:5px; clear:both;"/>
                                        <?php } ?>
                                    </div>
                                    <div style="float:left; " class="xoa_hinh_nay">
                                        <img style="margin-top:7px;"
                                             src="<?php echo base_url(); ?>templates/home/images/xoaimg.png" border="0"
                                             title="Xóa hình này "
                                             onclick=" return delete_img_pro('<?php echo base_url(); ?>home/account/','<?php echo $pro_id; ?>','<?php echo $imageDetail[2]; ?>,',2);"/>
                                    </div>
                                </div>
                                <input id="image3_edit" type="hidden" value="<?php echo $imageDetail[2] ?>" name="image3_edit">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="image_4_pro"
                                   class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('image_4_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <div style=" display:<?php if ($imageDetail[3] != '') {
                                    echo "none";
                                } else {
                                    echo "block";
                                } ?>; " id="vavatar_input4">
                                    <span class="btn btn-primary btn-file upload_btn inputimage_formpost"
                                          name="image_4_pro" id="image_4_pro" onclick="show_popup('popup_upload', 4);"><i class="fa fa-upload" aria-hidden="true"></i> Chọn Ảnh</span>
                                    ...
                                    <input class="btn btn-default" type="button"
                                           onclick="resetBrowesIimgQ('image_4_pro',4);" value="Hủy"/>
                                    <p><span class="text-warning"><i class="fa fa-info-circle" aria-hidden="true"></i> (<?php echo $this->lang->line('image_help'); ?>
                                            )</span></p>
                                ...
                                <div style=" display:<?php if ($imageDetail[3] == '') {
                                    ...
                                    echo "block";
                                } ?>" id="img_vavatar_input4">
                                    <div style="float:left;">
                                        <?php if ($imageDetail[3] != "") { ?>
                                            <img src="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/'. $pro_dir .'/thumbnail_1_'. $imageDetail[3]; ?>"
                                                style="max-height:100px; max-width:100px; margin-top:5px; clear:both;"/>
                                        <?php } ?>
                                    </div>
                                    <div style="float:left; " class="xoa_hinh_nay">
                                        <img style="margin-top:7px;"
                                             src="<?php echo base_url(); ?>templates/home/images/xoaimg.png" border="0"
                                             title="Xóa hình này "
                                             onclick=" return delete_img_pro('<?php echo base_url(); ?>home/account/','<?php echo $pro_id; ?>','<?php echo $imageDetail[3]; ?>',3);"/>
                                    </div>
                                </div>
                                <input id="image4_edit" type="hidden" value="<?php echo $imageDetail[3]; ?>"
                                       name="image4_edit">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="image5_edit"
                                   class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('image_5_product_edit'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <div style=" display:<?php if ($imageDetail[4] != '') {
                                    echo "none";
                                } else {
                                    echo "block";
                                } ?>; " id="vavatar_input5">
                                    <span class="btn btn-primary btn-file upload_btn inputimage_formpost"
                                          name="image_5_pro" id="image_5_pro"
                                          onclick="show_popup('popup_upload', 5);"><i class="fa fa-upload"
                                                                                      aria-hidden="true"></i> Chọn Ảnh</span>
                                    <input type="text" placeholder="Chưa chọn ảnh" id="nameImage_5" disabled="disabled"
                                           style="border:none;background:none;padding: 5px;"/>
                                    <!-- <span class="btn btn-primary btn-file">
                                        <i class="fa fa-upload" aria-hidden="true"></i> Chọn File
                                    ...
                                    <input class="btn btn-default" type="button"
                                           onclick="resetBrowesIimgQ('image_5_pro',5);"
                                           value="Hủy"/>
                                    <p><span class="text-warning"><i class="fa fa-info-circle"
                                                                     aria-hidden="true"></i> (<?php echo $this->lang->line('image_help'); ?>
                                            )</span></p>
                                ...
                                <div style=" display:<?php if ($imageDetail[4] == '') {
                                    ...
                                    echo "block";
                                } ?>" id="img_vavatar_input5">
                                    <div style="float:left;">
                                        <?php if ($imageDetail[4] != "") { ?>
                                            <img src="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/'. $pro_dir .'/thumbnail_1_'. $imageDetail[4]; ?>"
                                                style="max-height:100px; max-width:100px; margin-top:5px; clear:both;"/>
                                        <?php } ?>
                                    </div>
                                    <div style="float:left; " class="xoa_hinh_nay">
                                        <img style="margin-top:7px;"
                                             src="<?php echo base_url(); ?>templates/home/images/xoaimg.png" border="0"
                                             title="Xóa hình này "
                                             onclick=" return delete_img_pro('<?php echo base_url(); ?>home/account/','<?php echo $pro_id; ?>','<?php echo $imageDetail[4]; ?>',4);"/>
                                    </div>
                                </div>
                                <input id="image5_edit" type="hidden" value="<?php echo $imageDetail[4] ?>"
                                       name="image5_edit">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 col-xs-12 control-label ">
				<span style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('detail_product_edit'); ?>
                                :</label>			    
                            <div class="col-sm-9 col-xs-12">
                        ...
                        <!--pro_saleoff_value-->
                        <div class="form-group">
                            <label class="col-sm-3 col-xs-12 control-label "><span
                                    style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('cost_product_edit'); ?>
                                :</label>
                            <div class="col-sm-3 col-xs-8">				
                                <input type="text" value="<?php if (isset($cost_pro)) {
                                    if ($cost_pro == 0) echo ""; else echo $cost_pro;
                                } ?>" name="cost_pro" id="cost_pro" maxlength="11" class="inputcost_formpost form-control"
                                       onkeypress="return isNumberKey(event);"
                                       onkeyup="FormatCurrency('DivShowCost','currency_pro',this.value);" />
				<span class="div_helppost">(<?php echo $this->lang->line('only_input_number_help'); ?>
                                    )</span>
				    
			    </div>
			    <div class="col-sm-1 col-xs-4">
                                <select name="currency_pro" id="currency_pro" class="selectcurrency_formpost form-control"
                                        onchange="FormatCurrency('DivShowCost','currency_pro',document.getElementById('cost_pro').value)">
                                    <option value="VND" <?php if (isset($currency_pro) && $currency_pro == 'VND') {
                                        echo 'selected="selected"';
                                    } elseif (!isset($currency_pro)) {
                                        echo 'selected="selected"';
                                    } ?>><?php echo $this->lang->line('vnd_product_edit'); ?></option>
                                    <!-- <option value="USD" <?php if (isset($currency_pro) && $currency_pro == 'USD') {
                                        echo 'selected="selected"';
                                    } ?>><?php echo $this->lang->line('usd_product_edit'); ?></option>-->
                                </select>
			    ...
			    <div id="DivShowCost"></div>
                                ...
                                <div class="none_cost" style="display:none">
                                    <input type="checkbox" name="nonecost_pro" id="nonecost_pro"
                                           value="1" <?php if (isset($nonecost_pro) && $nonecost_pro == '1') {
                                        echo 'checked="checked"';
                                    } ?>
                                           onclick="ChangeStyleTextBox('cost_pro','DivShowCost',this.checked); ChangeCheckBox('nego_pro');"/>
                                    <?php echo $this->lang->line('none_cost_product_edit'); ?> <font
                                        color="#FF0000">(<?php echo $this->lang->line('call_product_edit'); ?>)</font>&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox" name="nego_pro" id="nego_pro"
                                           value="1" <?php if (isset($nego_pro) && $nego_pro == '1') {
                                        echo 'checked="checked"';
                                ...
                                <div class="saleoff_edit">
                                    <input type="checkbox" onclick="checkShowSaleOffValue();" name="saleoff_pro"
                                           id="saleoff_pro"
                                           value="1" <?php if (isset($saleoff_pro) && $saleoff_pro == '1') {
                                        echo 'checked="checked"';
                                    } ?> />
					    ...
					    <div class="col-sm-3 col-xs-8"> 
						<input onkeypress="return isNumberKey(event);" class="inputcost_formpost form-control"
                                                   id="pro_saleoff_value"
                                                   value="<?php echo $pro_saleoff_value > 0 ? $pro_saleoff_value : ""; ?>"
                                                   name="pro_saleoff_value" type="text" size="10"/>
						<span class="div_helppost">(Chỉ nhập số)</span>
					    </div>
					    <div class="col-sm-1 col-xs-4"> 
						<select class="selectcurrency_formpost form-control" id="pro_type_saleoff"
						...
						<span class="small">(Nhập tiền giảm giá theo % hoặc tiền VND)</span>
					    </div>
                                        </div>
						...
						<label for="prom_begin_txt">Ngày áp dụng: </label>
						    <input readonly class="form-control" name="prom_begin_txt"
							   value="<?php echo $begin_date_sale ? date('d/m/Y', $begin_date_sale) : ''; ?>"
							   id="prom_begin_txt"/>
						    <input type="hidden" name="prom_begin"
							   value="<?php echo $begin_date_sale ? date('Y/m/d', $begin_date_sale) : ''; ?>"
							   id="prom_begin"/>
						
					    </div>
					    <div class="col-sm-3 col-xs-12">
						<label for="promotion_expiry">Thời hạn áp dụng:</label>	<span class="text-danger"><b>*</b></span>		    
						    <select
							class="form-control" name="promotion_expiry" id="promotion_expiry">
							<option value="">--Số ngày--</option>
							<?php for ($i = 5; $i <= 45; $i++) { ?>
							    <option <?php echo ($days == $i) ? 'selected = "selected"' : ''; ?>
								value="<?php echo $i; ?>"><?php echo $i; ?> ngày
							    </option>
							<?php } ?>
						    </select>						
					    </div>
						...
						<?php if ($end_date_sale > 0) { ?>
						    <p class="text-danger">Ngày hết
							hạn: <?php echo date('d/m/Y', $end_date_sale); ?></p>
						<?php } ?>						    
					     </div>
                                        </div>
					<div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="pro_instock" class="col-sm-3 col-xs-12 control-label "><span
                                    style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('pro_instock'); ?>
                                :</label>
                            <div class="col-sm-2 col-xs-12">
                                <input type="text" maxlength="10" class="form-control"
                                       onkeypress="return isNumberKey(event);" value="<?php echo $pro_instock; ?>"
                                       name="pro_instock" id="pro_instock" title="Số lượng trong kho">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <?php if ($shoptype >= 1): ?>
                            <div class="form-group">
                                <label class="col-sm-3 col-xs-12 control-label " for="pro_minsale"><span style="color: #FF0000"><b>*</b></span>Số
                                    lượng bán tối thiểu:</label>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="number" onkeypress="return isNumberKey(event);"
                                           title="Số lượng bán sỉ tối thiểu" id="pro_minsale" name="pro_minsale"
                                           value="<?php if ($pro_minsale > 0) {
                                               echo $pro_minsale;
                                           } else {
                                               echo '1';
                                               } ?>" class="form-control" maxlength="10" min="1" max="<?php echo settingOtherShowcart ?>">
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($this->uri->segment(3) == 'product'){ ?>
                            <div class="form-group">
                                <label class="col-sm-3 col-xs-12 control-label " for="pro_weight"><span
                                        style="color: #FF0000"><b>*</b></span>Trọng lượng: (gram)</label>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" onkeypress="return isNumberKey(event);"
                                           title="Trọng lượng sản phẩm" id="pro_weight" name="pro_weight"
                                           value="<?php echo $pro_weight; ?>"
				...
				<div class="form-group">
				    <label class="col-sm-3 col-xs-12  control-label" for="pro_length">Kích thước sản phẩm:</label>
				    <div class="col-sm-9 col-xs-12">
					<div class="row">
					    <label class="col-sm-2 col-xs-4 control-label" for="pro_length">Dài (cm):</label>
					    <div class="col-sm-2 col-xs-8">
						<input type="text" onkeypress="return isNumberKey(event);"
						       title="Chiều dài sản phẩm" id="pro_length" name="pro_length"
						       value="<?php echo $pro_length; ?>" class="form-control" maxlength="10">
					    </div>
					    <label class="col-sm-2 col-xs-4 control-label" for="pro_length">Rộng(cm):</label>
					    <div class="col-sm-2 col-xs-8">
						<input type="text" onkeypress="return isNumberKey(event);"
						       title="Chiều rộng sản phẩm" id="pro_width" name="pro_width"
						       value="<?php echo $pro_width; ?>" class="form-control" maxlength="10">
					    </div>
					    <label class="col-sm-2 col-xs-4 control-label" for="pro_length">Cao (cm):</label>
					    <div class="col-sm-2 col-xs-8">
						<input type="text" onkeypress="return isNumberKey(event);"
						       title="Chiều cao sản phẩm" id="pro_height" name="pro_height"
						       value="<?php echo $pro_height; ?>" class="form-control" maxlength="10">
					    </div>
					</div>				   
				    </div> 
				</div>
                            ...
                            <div class="form-group">
                                <label for="pro_made_from"
                                       class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('pro_made_from'); ?>
                                    :</label>
                                <div class="col-sm-3 col-xs-12">
                                    <?php
                                    if ($pro_made_from == 0)
                                    ...
                                    ?>
                                    <select size="1" class="form-control" name="pro_made_from" id="pro_made_from"
                                            class="form_control_select"
                                            title="Xuất xứ">
                                        <option <?php echo $selecte_made_form0; ?> value="0" title="- Chọn -">- Chọn -
                                        </option>
                                        <option <?php echo $selecte_made_form1; ?> value="1" title="Chính hãng">Chính
                                            hãng
                                        </option>
                                        <option <?php echo $selecte_made_form2; ?> value="2" title="Xách tay">Xách tay
                                        </option>
                                        <option <?php echo $selecte_made_form3; ?> value="3" title="Hàng công ty">Hàng
                                            công
                                            ty
                                        </option>
                                    </select>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 col-xs-12 control-label " for="pro_weight"><span style="color: #FF0000"></span>Phân loại sản phẩm cùng mẫu hoặc đặc tính sản phẩm:<br>
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <div id="numBoxqc" class="tab-pane fade in active">
                                    ...
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th style="width: 130px;"><span style="color: #ff0000">* </span>Hình ảnh
                                            </th>
                                            <th>Màu sắc <input type="checkbox" onclick="CheckColor();" id="input_color"
                                                               value="1" checked="checked"></th>
                                            <th>Kích thước <input type="checkbox" onclick="CheckSize();" id="input_size"
                                                                  value="1"></th>
                                            <th>Chất liệu <input type="checkbox" onclick="CheckMaterial();"
                                                                 id="input_material" value="1"></th>
                                        ...
                                        <?php $row_qc = 0;
                                        if (!empty($de_product)) { ?>
                                            <?php foreach ($de_product as $key => $value) {
                                                $row_qc++; ?>
                                                <tr class="inline" id="rowqc_<?php echo $value->id; ?>">
                                                    <td>
                                                        <div style="display: <?php if ($value->dp_images == '') {
                                                            echo 'none';
                                                        } else {
                                                            echo 'block';
                                                        } ?>;">
                                                            <div style="float: left;">
                                                                <img src="<?php echo DOMAIN_CLOUDSERVER . 'media/images/product/'. $pro_dir . '/thumbnail_1_' . $value->dp_images; ?>"
                                                                    style="min-width:60px; min-height:60px; max-height:80px; max-width:80px; clear:both;"/>
                                                                <input type="hidden"
                                                                       name="<?php echo 'rowqc[' . $row_qc . '][qcimage]'; ?>"
                                                                       id="<?php echo 'rqc_image_' . $row_qc; ?>"
                                                                       value="<?php echo $value->dp_images; ?>"/>
                                                                <input type="hidden"
                                                                       name="<?php echo 'rowqc[' . $row_qc . '][qcid]'; ?>"
                                                                       id="dp_id_<?php echo $row_qc; ?>"
                                                            ...
                                                            <div style="float: left;">
                                                                ...
                                                                <span style="display:block"
                                                                      class="btn btn-primary btn-file upload_btn"
                                                                      id="sp_upload_<?php echo $row_qc; ?>"
                                                                      onclick="show_popup_qc('popup_upload_qc',<?php echo $row_qc; ?>);"><i
                                                                        class="fa fa-upload"></i> Đổi ảnh<input
                                                                        type="hidden"
                                                                        name="<?php echo 'rowqc_' . $row_qc . '_qcimage'; ?>"
                                                                        id="<?php echo 'rqc_image_' . $row_qc; ?>"
                                                                        class="form-control"
                                                                        value="<?php echo $value->dp_images; ?>"/></span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                    </td>

                                                    <td><input type="text" onkeyup="checkinput1_(this);" name="rowqc[<?php echo $row_qc; ?>][qccolor]"
                                                               id="<?php echo 'rqc_color_' . $row_qc; ?>"
                                                               class="form-control rqc_color"
                                                               value="<?php echo $value->dp_color; ?>"/></td>
                                                    <td><input type="text" onkeyup="checkinput2_(this);" name="rowqc[<?php echo $row_qc; ?>][qcsize]"
                                                               id="<?php echo 'rqc_size_' . $row_qc; ?>"
                                                               class="form-control rqc_size"
                                                               value="<?php echo $value->dp_size; ?>"/></td>
                                                    <td><input type="text" onkeyup="checkinput1_(this);"
                                                               name="rowqc[<?php echo $row_qc; ?>][qcmaterial]"
                                                               id="<?php echo 'rqc_material_' . $row_qc; ?>"
                                                               class="form-control rqc_material"
                                                               value="<?php echo $value->dp_material; ?>"/></td>
                                                    <td><input type="text" name="rowqc[<?php echo $row_qc; ?>][qccost]"
                                                               id="<?php echo 'rqc_cost_' . $row_qc; ?>" onkeypress="return isNumberKey(event);"
                                                               class="form-control"
                                                               value="<?php echo $value->dp_cost; ?>"/></td>
                                                    <td><input type="text"
                                                               name="rowqc[<?php echo $row_qc; ?>][qcinstock]"
                                                               id="<?php echo 'rqc_instock_' . $row_qc; ?>" onkeypress="return isNumberKey(event);"
                                                               class="form-control"
                                                               value="<?php echo $value->dp_instock; ?>"/></td>
                                                    <td><span id="<?php echo 'del_' . $row_qc; ?>"
                                                              class="btn btn-danger"
                                                              style="<?php if ($row_qc == count($de_product)) {
                                                                  //echo 'display:block';
                                                              } else {
                                                                  //echo 'display:none';
                                                              } ?>"
                                                              onclick="removeRowqc(<?php echo $value->id; ?>, '#numBoxqc');"
                                                              title="Xóa"><i class="fa fa-remove "></i></span></td>
                                                </tr>
                                            <?php } ?>
                                        <?php } ?>
                                        </tbody>
				    ...
				    <button type="button" class="btn btn-default area-new"
                                            onClick="addRowQC('#numBoxqc',<?php echo $row_qc; ?>);">
                                        <i class="fa fa-plus"></i>&nbsp;&nbsp;Thêm
                                    </button>
                                    <input id="numrow_add" type="hidden" value="<?php echo $row_qc; ?>"/>
                                </div>
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                        
                                    });
                                    function checkinput1_(a){
                                        var enoughRegex = new RegExp("([!@#$%^&*=;,.{/}'|?\"\+])", "g");
                                        if(false == enoughRegex.test($(a).val())) {
                                            
                                        }else{
                                            var txt = $(a).val().substring(0,$(a).val().length-1);
                                            $(a).val(txt);
                                        }
                                    }
                                    function checkinput2_(a){
                                        var enoughRegex = new RegExp("([!@#$%^&*=+;{}'|?\"\])", "g");
                                        if(true == enoughRegex.test($(a).val())) {
                                            var txt = $(a).val().substring(0,$(a).val().length-1);
                                            $(a).val(txt);
                                        }
                                    }
                                    ...
                                    function addRowQC(boxqc, no) {
                                        ...
                                        if (checked) {
                                            ...
                                            htmlqc += '<td><input name="rowqc[' + rowqc + '][qccolor]" onkeyup="checkinput1_(this);" type="text" id="rqc_color_' + rowqc + '" class="form-control rqc_color" /></td>';
                                            htmlqc += '<td><input name="rowqc[' + rowqc + '][qcsize]" onkeyup="checkinput2_(this);" type="text" id="rqc_size_' + rowqc + '" class="form-control rqc_size" /></td>';
                                            htmlqc += '<td><input name="rowqc[' + rowqc + '][qcmaterial]" onkeyup="checkinput1_(this);" type="text" id="rqc_material_' + rowqc + '" class="form-control rqc_material" /></td>';
                                            ...
                                            $.jAlert({
                                                'title': 'Thông báo',
                                                'content': 'Nhập các trường có dấu đỏ là bắt buộc, upload hình & các trường quy cách đã checkbox ở dòng trên!',
                                                'theme': 'default',
                                                'btns': {
                                    ...
                                    function removeRowqc(idqc, boxqc) {
                                        jQuery.ajax({
                                            ...
                                            success: function (res) {
                                                ...
                                                // if($('#numrow_add').length > 0) {
                                                //     console.log('aaaaaa');
                                                //     var num = parseInt($('#numrow_add').val());
                                                //     $('#numrow_add').val(parseInt(num - 1));
                                                // }
                        ...
                        <!--<div class="form-group">
                            <label class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('image_show_opt'); ?>
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                        ...
                        <?php if ($this->session->userdata('sessionGroup') == AffiliateStoreUser || $this->session->userdata('sessionGroup') == BranchUser): ?>
                            ...
                            <?php if (isset($shoptype) && (int)$shoptype != 0) { ?>
                                <div class="form-group">
                                    <label class="col-sm-3 col-xs-12 control-label "><?php echo 'Giảm giá sỉ'; ?>
                                        :</label>
                                    <div class="col-sm-9 col-xs-12">
                                        <script type="text/javascript">
                                            var row = 1;
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li <?php echo $limit_type == 1 ? 'class="active"' : ''; ?> ><a
                                                    href="#numBox" class="numBox">Số lượng</a></li>
                                            <li <?php echo $limit_type == 2 ? 'class="active"' : ''; ?>><a
                                                    href="#totalBox" class="totalBox">Số tiền</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <input type="hidden" id="limit_type" name="limit_type"
                                                   value="<?php echo $limit_type; ?>"/>
                                            <div id="numBox"
                                                 class="tab-pane fade <?php echo $limit_type == 1 ? 'in active' : ''; ?>">
                                                <div class="table-responsive">
                                                        ...
                                                        <?php foreach ($promotions as $pro): ?>
                                                            <tr id="row_<?php echo $pro['id']; ?>">
                                                                ...
                                                                <td><span class="btn btn-danger"
                                                                          onclick="removeRow(<?php echo $pro['id']; ?>, '#numBox');"
                                                                          title="Xóa"><i
						...
						<button type="button" class="btn btn-default area-new"
                                                        onClick="addRow('#numBox');"><i
                                                        class="fa fa-plus"></i>&nbsp;&nbsp;Thêm
                                                </button>
                                            </div>
                                            <div id="totalBox"
                                                 class="tab-pane fade <?php echo $limit_type == 2 ? 'in active' : ''; ?>">
                                                <table class="table table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th>Từ</th>
                                                    ...
                                                    <?php if ($limit_type == 2 && !empty($promotions)): ?>
                                                        <?php foreach ($promotions as $pro): ?>
                                                            <tr id="row_<?php echo $pro['id']; ?>">
                                                                ...
                                                                <td><?php echo $pro['dc_type']; ?></td>
                                                                <td><span class="btn btn-danger"
                                                                          onclick="removeRow(<?php echo $pro['id']; ?>, '#totalBox');"
                                                                          title="Xóa"><i
                                                                            class="fa fa-remove "></i></span></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                ...
                                                <button type="button" class="btn btn-default area-new"
                                                        onClick="addRow('#totalBox');"><i class="fa fa-plus"></i>&nbsp;&nbsp;Thêm
                                                </button>
                                            </div>
                                            <br/>
                                            (Nhập số lượng từ 5 đến 10 giảm 200.000 thì nhập là Từ: 5, Tới: 10, Giảm
                                            giá:200000, tương tự cho nhập Số tiền)
                                            <br/>
                                            (Nhập số lượng từ 10 trở về sau thì nhập là Từ: 10, Tới: 0, tương tự cho
                                            nhập Số tiền)
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php if (false): ?>
                            <div class="form-group">
                                <label class="col-sm-3 col-xs-12 control-label "><?php echo 'Chiết khấu cho thành viên'; ?>
                                    :</label>
                                <div class="col-sm-9 col-xs-12">
                                    ...
                                    <select class="selectcurrency_formpost" id="dc_type"
                                        ...
                                        foreach ($dcType as $k => $val):
                                            ?>
                                            <option
                                                value="<?php echo $k; ?>" <?php echo ($k == $dc_type) ? 'selected="selected"' : ''; ?>><?php echo $val; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <!--Chiết khấu cho Thành viên-->
                        <div
                            class="form-group" <?php echo ($shoptype == 0 || $shoptype == 2) ? '' : 'style="display:none"'; ?> >
                            <label for="affiliate_pro" class="col-sm-3 col-xs-12 control-label ">Sản phẩm cộng tác viên :</label>
                            <div class="col-sm-9 col-xs-12">
                                <input type="checkbox" onclick="checkShowAffiliateValue();" name="affiliate_pro"
                                       id="affiliate_pro"
                                       value="1" <?php if (isset($affiliate_pro) && $affiliate_pro == '1') {
                                    echo 'checked="checked"';
                                } ?> /> Cho cộng tác viên bán sản phẩm này
                                <div
                                    id="wapper-affiliate" <?php if (isset($affiliate_pro) && $affiliate_pro == '0') { ?> style="display:none;" <?php } else { ?>  style="display:block;" <?php } ?>>
                                    <input class="inputcost_formpost" id="pro_affiliate_value"
                                           value="<?php echo $pro_affiliate_value > 0 ? $pro_affiliate_value : ""; ?>"
                                           name="pro_affiliate_value" type="text" size="10" autocomplete="off"/>
                                    <select class="selectcurrency_formpost" id="pro_type_affiliate"
                                    ...
                                    <select class="selectcurrency_formpost" id="pro_type_dc_affiliate"
                                            autocomplete="off"
                        ...
                        <div class="form-group" style="display: none">
                            <label for="province_pro" class="col-sm-3 col-xs-12 control-label "><span
                        ...
                        <div class="form-group" style="display: none">
                            <label for="inputPassword3" class="col-sm-3 col-xs-12 control-label "><span
                        ...
                        <?php if ($url == 'edit') { ?>
                            <div class="form-group">
                                <label for="mannufacurer_pro" class="col-sm-3 col-xs-12 control-label ">Nhà sản xuất:</label>
                                <div class="col-sm-3 col-xs-12">
                                ...
                                <div id="man_khac" style="display: none;">
                                    ...
                                    <div class="col-sm-5" id="manafacture_khac">
                                        <input id="manafac_khac" name="manafac_khac" class="form-control" type="text"
                                               title=""/>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 col-xs-12">
                                ...
                                ?>
                                <select size="1" class="form-control" name="pro_vat" id="pro_vat"
                                        title="Thuế VAT">
                        ...
                        <?php if ($url == 'edit') { ?>
                            <div class="form-group">
                                <label for="pro_quality"
                                       class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('pro_quality'); ?>
                                    :</label>
                                <div class="col-sm-3 col-xs-12">
                                    <?php
                                    if ($pro_quality == 0)
                                    ...
                                    ?>
                                    <select size="1" name="pro_quality" id="pro_quality" class="form-control"
                                            title="Tình trạng">
                            ...
                            <div class="form-group">
                                <label for="pro_warranty_period"
                                       class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('pro_warranty_period'); ?>
                                    :</label>
                                <div class="col-sm-2 col-xs-2">
                                    <input onkeypress="return isNumberKey(event);" type="text" maxlength="10"
                                           class="form-control"
                                           value="<?php echo $pro_warranty_period; ?>" name="pro_warranty_period"
                                           id="pro_warranty_period" title="Thời gian bảo hành">
                                    
                                </div>
				<div class="col-sm-7 col-sm-10">
                                tháng
                            </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="form-group">
                            <label for="keyword_pro"
                                   class="col-sm-3 col-xs-12 control-label ">Từ khóa tìm kiếm
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" value="<?php if (isset($keyword_pro)) {
                                    echo $keyword_pro;
                                } ?>" name="keyword_pro" id="keyword_pro" maxlength="120" class="form-control"
                                       placeholder="Từ khóa tìm kiếm cách nhau bởi dấu ,"
                                       onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('descr_pro',1)"
                                       onblur="ChangeStyle('keyword_pro',2)"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 col-xs-12 control-label ">Link Youtube
                                :</label>
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="pro_video" id="pro_video" maxlength="250"
                                       value="<?php if (isset($pro_video)) {
                                           echo $pro_video;
                                       } ?>" class="form-control"
                                       placeholder="https://www.youtube.com/watch?v=zlsQF_ufUNU"/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="" class="col-sm-3 col-xs-12 control-label "> <font color="#FF0000"><b>*</b></font> Đồng ý phí mua bán :</label>
                            <div class="col-sm-9 col-xs-12">
                        ...
                        <div style="display: none">
                            <div class="form-group">
                                <label for="fullname_pro" class="col-sm-3 col-xs-12 control-label "><span
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" value="<?php if (isset($fullname_pro)) {
                                        echo $fullname_pro;
                                           ...
                                           onfocus="ChangeStyle('fullname_pro',1)"
                                           onblur="ChangeStyle('fullname_pro',2)"
                                           onkeypress="return submitenter(this,event)"/>
                            ...
                            <div class="form-group">
                                <label for="address_pro" class="col-sm-3 col-xs-12 control-label "><span
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-xs-12 control-label "><span
                                        style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('phone_product_edit'); ?>
                                </label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" value="<?php if (isset($mobile_pro)) {
                                        echo $mobile_pro;
                                    } ?>" name="mobile_pro" id="mobile_pro" maxlength="20" class="form-control"
                                           onfocus="ChangeStyle('mobile_pro',1)" onblur="ChangeStyle('mobile_pro',2)"
                                           onkeypress="return submitenter(this,event)"/>
                            ...
                            <div class="form-group">
                                <label for="email_pro" class="col-sm-3 col-xs-12 control-label "><span
                                        style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('email_product_edit'); ?>
                                    :</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" value="<?php if (isset($email_pro)) {
                                        echo $email_pro;
                                    } ?>" name="email_pro" id="email_pro" maxlength="50" class="form-control"
                                           onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('email_pro',1)"
                                           onblur="ChangeStyle('email_pro',2)"
                                           onkeypress="return submitenter(this,event)"/>
                            ...
                            <div class="form-group">
                                <label for="yahoo_pro"
                                       class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('yahoo_product_edit'); ?>
                                    :</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" value="<?php if (isset($yahoo_pro)) {
                                        echo $yahoo_pro;
                                    } ?>" name="yahoo_pro" id="yahoo_pro" maxlength="50" class="form-control"
                                           onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('yahoo_pro',1)"
                                           onblur="ChangeStyle('yahoo_pro',2)"
                                           onkeypress="return submitenter(this,event)"/>
                            ...
                            <div class="form-group">
                                <label for="skype_pro"
                                       class="col-sm-3 col-xs-12 control-label "><?php echo $this->lang->line('skype_product_edit'); ?>
                                    :</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" value="<?php if (isset($skype_pro)) {
                                        echo $skype_pro;
                                    } ?>" name="skype_pro" id="skype_pro" maxlength="50" class="form-control"
                                           onkeyup="BlockChar(this,'SpecialChar')" onfocus="ChangeStyle('skype_pro',1)"
                                           onblur="ChangeStyle('skype_pro',2)"
                                           onkeypress="return submitenter(this,event)"/>
                        ...
                        <?php if (isset($imageCaptchaEditProductAccount)) { ?>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 col-xs-12 control-label "><span style="color: #FF0000"><b>*</b></span> <?php echo $this->lang->line('captcha_main'); ?>
                                    :</label>
                                <div class="col-sm-3">
                                    <img src="<?php echo $imageCaptchaEditProductAccount; ?>" width="151"
                                         height="30"/><br/>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" name="captcha_pro" id="captcha_pro" value="" maxlength="10"
                                           class="form-control" onfocus="ChangeStyle('captcha_pro',1);"
                                           onblur="ChangeStyle('captcha_pro',2);"
                                           onkeypress="return submitenter(this,event)"/>
                        ...
                        <?php } ?>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 col-xs-12 control-label "></label>
                            <div class="col-sm-9 col-xs-12">
                                <SCRIPT TYPE="text/javascript">
                                    <!--
                                ...
                                <input type="button" onclick="checkbox()" name="submit_editpro"
                                       value="Cập nhật" id="save"
                    ...
                    <?php } else { ?>
                        <div class="text-center">
                            ...
                            <?php if($this->session->userdata('sessionGroup') == StaffStoreUser && $pro_type == 0) { ?>
                                <a href="<?php echo getAliasDomain() . 'account/emp-product'; ?>">Bấm vào đây để quay lại</a>
                            <?php } elseif($this->session->userdata('sessionGroup') == StaffStoreUser && $pro_type == 2) { ?>
                                <a href="<?php echo getAliasDomain() . 'account/emp-coupon'; ?>">Bấm vào đây để quay lại</a>
                            <?php } else { ?>
                                <a href="<?php echo getAliasDomain() . 'account/product' . $url1; ?>">Bấm vào đây để quay lại</a>
                            <?php } ?>
                        </div>
                    <?php } ?>
                <?php } else { ?>
...
<div id="popup_upload">
    <div class="form_upload">
        ...
        <form action="<?php echo base_url(); ?>account/upload_photo" method="post" enctype="multipart/form-data"
              target="upload_frame" onsubmit="submit_photo();">
            ...
            <input type="hidden" name="product_dir" id="product_dir" value="<?php echo $pro_dir; ?>"/>
        </form>
...
<div id="popup_crop">
    <div class="form_crop">
        ...
        <form>
            ...
            <input type="hidden" id="product_dir" name="product_dir" value="<?php echo $pro_dir; ?>"/>
...
<div id="popup_upload_qc">
    <div class="form_upload">
        ...
        <form action="<?php echo base_url(); ?>account/upload_photo_qc" method="post" enctype="multipart/form-data"
              target="upload_frame" onsubmit="submit_photo();">
...
<div id="popup_crop_qc">
    <div class="form_crop">
        ...
        <form>
            ...
            <input type="hidden" id="w" name="w"/>
            <input type="hidden" id="h" name="h"/>
            <input type="hidden" id="DOMAIN_CLOUDSERVER" value="<?php echo DOMAIN_CLOUDSERVER ?>"/>
            <input type="hidden" id="photo_url_qc" name="photo_url_qc"/>
            <input type="hidden" id="photo_pos_qc" name="photo_pos_qc"/>
            <input type="hidden" name="dp_id_cr" id="dp_id_cr"/>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#mannufacurer_pro').change(function () {
            if ($(this).val() == 'khac') {
                $('#man_khac').css('display', 'block');
            } else {
                $('#man_khac').css('display', 'none');
            }
        });
        ...
        for (var k = 1; k <= dem; k++) {
            if ($('#rqc_color_' + k).val() != "") {
                ...
                $('#rqc_color_' + k).attr('disabled', 'disabled');
            }

            if ($('#rqc_size_' + k).val() != "") {
                $('#input_size').prop('checked', true);
            } else {
                $('#input_size').prop('checked', false);
                $('#rqc_size_' + k).attr('disabled', 'disabled');
            }

            if ($('#rqc_material_' + k).val() != "") {
                $('#input_material').prop('checked', true);
            } else {
                $('#input_material').prop('checked', false);
                $('#rqc_material_' + k).attr('disabled', 'disabled');
            }
        }
    });

    function CheckSize() {
        var rowqc = $('#numrow_add').val() + 1;
