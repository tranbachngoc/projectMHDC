...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            <h4 class="page-header text-uppercase" style="margin-top:10px"><?php echo $this->lang->line('title_my_order_defaults'); ?> của
                <?php if ($this->uri->segment(2) == 'bran_order') {
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-barcode fa-fw"></i></div>
                                        <input class="form-control" type="text" name="order_id" value="<?php echo $params['order_id']; ?>" placeholder="Mã số đơn hàng ...">
                                    </div> 
                                </div>                            
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-male fa-fw"></i></div>
                                        <input class="form-control" type="text" name="username" value="<?php echo $params['username']; ?>" placeholder="Khách hàng ...">
                                    </div>
                                </div>                            
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-phone fa-fw"></i></div>
                                        <input class="form-control" type="text" name="ordmobile" value="<?php echo $params['ordmobile']; ?>" placeholder="SĐT người nhận...">
                                    </div>
                                </div> 
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-tag fa-fw"></i></div>
                                        <select class="form-control " type="text" name="order_status">
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control " type="text" name="daterange" value="<?php echo $params['order_date']; ?>" placeholder="Từ ngày... đến ngày..." readonly/>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-truck fa-fw"></i></div>
                                        <select class="form-control " type="text" name="ship_order">
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-barcode fa-fw"></i></div>
                                        <input class="form-control " type="text" name="coupon_code" value="<?php echo $params['coupon_code']; ?>"
                                               placeholder="Mã Coupon hoặc dịch vụ ...">
                                    </div>
                                </div>
                                <?php } ?>
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    
                                        <button type="submit" class="btn btn-azibai btn-block">
                ...
                <form name="frmAccountShowcart" method="post"> 
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($showcart as $k => $showcartArray) { ?>
                            ...
                            /*$shop = $protocol . $parent . $duoi . 'shop/'. $pro_type . '/detail/' . $showcartArray->pro_id . '/' . RemoveSign($showcartArray->pro_name);
                            if ($domain != '') {
                                $shop = $protocol . $domain . '/shop/' . $pro_type . '/detail/' . $showcartArray->pro_id . '/' . RemoveSign($showcartArray->pro_name);
                            }*/
                            ...
                            if($showcartArray->order_group_id > 0){
                                $myGrt = $this->grouptrade_model->get('grt_link, grt_domain', 'grt_id = ' . (int)$showcartArray->order_group_id);
                                if($myGrt->grt_domain != ''){
                                    $store = $protocol . $myGrt->grt_domain;
                                }else{
                                    $store = $protocol . $myGrt->grt_link . $duoi;
                                }
                                $store .= '/grtshop/';
                            }else{
                                $store = $protocol . $shop . '/shop/'; 
                            }
                            ?>
                            <!-- Modal -->
                            ...
                            <tr>
                                <td>
                                    <a class="menu_1" target="_blank" href="<?php echo $store. $pro_type . '/detail/' . $showcartArray->pro_id . '/' . RemoveSign($showcartArray->pro_name); ?>">
                                        <?php
                                ...
                                <td colspan="<?php echo $colspan ?>">
                                    <p>Mã SP: <span class="text-primary"><?php echo $showcartArray->pro_sku; ?></span></p>
                                    <p>Người xử lý lần cuối: <span class="text-primary"><?php echo $this->user_model->get('use_fullname', 'use_id = ' . $showcartArray->user_process)->use_fullname; ?></span></p>
                                </td>
                                ...
                                <td colspan="6">
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            ...
                                            <?php if ($showcartArray->pro_type != 0 && $showcartArray->order_status == '98' && $showcartArray->order_saler == ((int)$this->session->userdata('sessionUser') || $parent_id) ) { ?>
                                        ...
                                        <div class="col-sm-4 col-xs-12">
                                            <?php if ($showcartArray->pro_type == 2 && $showcartArray->order_saler == ((int)$this->session->userdata('sessionUser') || $parent_id) && $showcartArray->order_status != '99') { 
