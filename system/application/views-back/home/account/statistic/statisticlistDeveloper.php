    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-8">
            <h2 class="page-title text-uppercase">
                Danh sách Developer có doanh thu
            </h2>
            <div class="db_table" style="overflow: auto; width:100%">
                ...
                <div colspan="6" class="text-right detail_list" style="font-weight: 600; font-size: 15px">Tổng doanh thu các Developer:<span style="color:#F00; font-size: 15px"><b> <?php echo number_format($total_sum,0,",","."); ?> Đ</b></span></div>
                        ...
                        <tr>
                            ...
                            <td width="20%" height="32" class="line_account_2">
                                ...
                                <div class="shop_parent <?php if($items->userid_parent == $this->session->userdata('sessionUser')){ ?>active<?php } ?>">
                                    <i><?php echo 'Partner: '.$items->parent_username;?></i>
                                </div>
                            </td>
                            ...
                            <td width="10%" height="32" class="line_account_2">
                                ...
                                <?php 
                                    foreach ($money[$items->use_id] as $keyitem => $item){
                                        $showcarttotal += $item;
                                    }
                                ?>
                                <a  href="<?php echo base_url(); ?>account/statisticlistshop/shc/<?php echo $items->use_id ?>">
                                    <span style="color: #ff0000; font-weight: 600">  <?php echo number_format($showcarttotal,0,",",".");?> đ</span>
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
                    <td colspan="5" class="text-right detail_list" style="font-weight: 600; font-size: 15px">Tổng doanh thu:</td>
                    <td colspan="2" class="detail_list"><span style="color:#F00; font-size: 15px"><b><?php echo number_format($total_sum,0,",","."); ?> Đ</b></span></td>
