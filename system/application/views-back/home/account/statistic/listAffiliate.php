    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-8">
            <h2 class="page-title text-uppercase">
                Danh sách Cộng tác viên <?php echo $text ?>
            </h2>
            <div class="db_table" style="overflow: auto; width:100%">
                <div colspan="6" class="text-right detail_list" style="font-weight: 600; font-size: 15px">Tổng số CTV trong danh sách:<span style="color:#F00; font-size: 15px"><b> <?php echo $number; ?></b></span></div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td width="20%" height="32" class="line_account_2">
                                ...
                                <div class="shop_parent <?php if($items->userid_parent == $this->session->userdata('sessionUser')){ ?>active<?php } ?>"></div>
                            </td>
