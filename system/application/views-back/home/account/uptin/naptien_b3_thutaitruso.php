...
<div class="classic-popup_eb">
    ...
    <div class="classic-popup-main_eb">
      <div class="classic-popup-title_eb">
        <div class="fl_eb">Nhập số Gold muốn nạp tại trụ sở azibai.com</div>
        ...
        <div class="content_eb">
          <div class="reg_cart_form_eb">
            ...
            <div class="k_btn">
                ...
                <div class="k_btnnaptien"><a href="<?php echo base_url();?>account/naptien/buoc4thutaitruso" style="float:right" class="blueButton_eb mLeft10_eb"><span><span>TIẾP TỤC <b>»</b></span></span></a></div>
            </div>
              <div class="c_eb"></div>
            </div>
            <div class="c_eb"></div>
