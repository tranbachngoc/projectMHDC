...
<SCRIPT TYPE="text/javascript">
  function SearchRaovatUathich(baseUrl){	
		  product_name='';		 
		  if(document.getElementById('keyword_account').value!='')
		  product_name=document.getElementById('keyword_account').value;  		 
		  window.location = baseUrl+'account/raovat/favorite/search/title/keyword/'+product_name+'/';		 	
}

function submitenterRaovatUathich(myfield,e,baseUrl){
	var keycode;
    ...
    <table class="table table-bordered" width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
            <td>
                ...
                <div class="fl"></div>
                <div class="fc">
				<?php echo $this->lang->line('title_ads_favorite'); ?>
                </div>
                <div class="fr"></div>
                </div>
            </td>
        </tr>
        <?php if(count($favoriteAds) > 0){ ?>
        <form name="frmAccountFavoriteAds" method="post">
        <tr>
            <td class="k_list k_listhead">
                <table border="0" width="100%" height="29" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="4%" class="title_account_0">STT</td>
                        <td width="3%" class="title_account_1"><input type="checkbox" name="checkall" id="checkall" value="0" onclick="DoCheck(this.checked,'frmAccountFavoriteAds',0)" /></td>
                        <td width="40%" class="title_account_2 k_fixwidthietieudetinravatuathich">
                        ...
                        <td width="11%" class="title_account_1" >
        ...
        <tr>
            <td class="main_list k_list k_fixpaddingie" valign="top"  style="padding-left:0px" >
                <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                    <?php $idDiv = 1; ?>
                    <?php foreach($favoriteAds as $favoriteAdsArray){ ?>
                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'f1f9ff';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                        <td width="4%" height="32" class="line_account_0"><?php echo $sTT; ?></td>
                        <td width="3%" height="32" class="line_account_1">
                            <input type="checkbox" name="checkone[]" id="checkone" value="<?php echo $favoriteAdsArray->adf_id; ?>" onclick="DoCheckOne('frmAccountFavoriteAds')" />
                        </td>
                        <td width="40%" height="32" class="line_account_2 k_fixwidthietieudetinravatuathich">
                            <a class="menu_1" href="<?php echo base_url(); ?>raovat/<?php echo $favoriteAdsArray->ads_category; ?>/<?php echo $favoriteAdsArray->ads_id; ?>/<?php echo RemoveSign($favoriteAdsArray->ads_title); ?>" onmouseover="ddrivetip('<?php echo $favoriteAdsArray->ads_descr; ?>',300,'#F0F8FF');" onmouseout="hideddrivetip();">
                                <?php echo sub($favoriteAdsArray->ads_title, 80); ?>
                            </a>
                            <span class="number_view">(<?php echo $favoriteAdsArray->ads_view; ?>)</span>
                        </td>
                        <td width="13%" height="32" class="line_account_1">
                            <?php echo date('d-m-Y', $favoriteAdsArray->ads_begindate); ?>
                        </td>
                        <td width="11%" height="32" class="line_account_4">
                            <?php echo date('d-m-Y', $favoriteAdsArray->adf_date); ?>
                        </td>
                    </tr>
                    <?php $idDiv++; ?>
                    <?php $sTT++; ?>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="30%" id="delete_account"><img src="<?php echo base_url(); ?>templates/home/images/icon_deleteads_account.gif" onclick="ActionSubmit('frmAccountFavoriteAds')" style="cursor:pointer;" border="0" /></td>
                        <td align="center" id="boxfilter_account">
                            <input type="text" name="keyword_account" id="keyword_account" value="<?php if(isset($keyword)){echo $keyword;} ?>" maxlength="100" class="inputfilter_account" onKeyUp="BlockChar(this,'AllSpecialChar')" onfocus="ChangeStyle('keyword_account',1)" onblur="ChangeStyle('keyword_account',2)" onKeyPress="return submitenterRaovatUathich(this,event,'<?php echo base_url(); ?>')"/>
                            <input type="hidden" name="search_account" id="search_account" value="title" />
                            <img src="<?php echo base_url(); ?>templates/home/images/icon_filter.gif" onclick="ActionSearch('<?php echo base_url(); ?>account/raovat/favorite/', 0)" border="0" style="cursor:pointer;" alt="<?php echo $this->lang->line('search_tip'); ?>" />
                        </td>
        ...
        <?php }elseif(count($favoriteAds) == 0 && trim($keyword) != ''){ ?>
        <tr>
            <td class="v_background" height="29">
                <table border="0" width="100%" height="29" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="50" class="title_account_0">STT</td>
                        <td width="30" class="title_account_1"><input type="checkbox" name="checkall" id="checkall" value="0" onclick="DoCheck(this.checked,'frmAccountFavoriteAds',0)" /></td>
                        ...
                        <td width="110" class="title_account_3">
                            <?php echo $this->lang->line('date_post_list'); ?>
                            <img src="<?php echo base_url(); ?>templates/home/images/sort_asc.gif" border="0" />
                            <img src="<?php echo base_url(); ?>templates/home/images/sort_desc.gif" border="0" />
                        </td>
        ...
        <tr>
            <td class="main_list" valign="top" style="background:#f4f4f4; border-left: 1px solid #62C7FD; border-right:1px solid #62C7FD" >
                <table border="0" width="788" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="none_record_search" align="center"><?php echo $this->lang->line('none_record_search_ads_favorite'); ?></td>
					</tr>
                </table>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
        ...
        <?php }else{ ?>
        <tr>
        	<td class="none_record" align="center"  ><?php echo $this->lang->line('none_record_ads_favorite'); ?></td>
		</tr>
        <?php } ?>
        <tr>
            <td>
