...
<div id="main" class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            <h4 class="page-header text-uppercase" style="margin-top:10px">Sản phẩm đã đăng</h4>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="searchBox" id="searchBox" method="post" action="<?php echo getAliasDomain() ;?>account/emp-product">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-5">
                                <a href="<?php echo getAliasDomain() ;?>account/product/product/post" class="btn btn-success btn-block">
                                    <i class="fa fa-plus"></i> Đăng Sản phẩm</a>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($item->pro_status == 1) { ?>
                                            <img src="<?php echo getAliasDomain() ;?>templates/home/images/public.png" onclick="ActionLink('<?php echo getAliasDomain() ;?>account/product/product/status/deactive/id/<?php echo $item->pro_id ;?>')" style="cursor:pointer;" border="0" title="Ngưng kích hoạt" alt="Ngưng kích hoạt">
                                        <?php } else {?>
                                            <img src="<?php echo getAliasDomain() ;?>templates/home/images/unpublic.png" onclick="ActionLink('<?php echo getAliasDomain() ;?>account/product/product/status/active/id/<?php echo $item->pro_id ;?>')" style="cursor:pointer;" border="0" title="Kích hoạt" alt="Kích hoạt">
                                        <?php } ?>
                                        </div>
                                    </div> 
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if($this->session->userdata('sessionUser') == $item->pro_user_up) { ?>
                                        <button type="button" class="btn btn-azibai" onclick="ActionLink('<?php echo getAliasDomain() ;?>account/product/product/edit/<?php echo $item->pro_id ;?>')">
