...
?>
<style>
    #user_province_get, #user_district_get {
        padding-left: 35px;
    }
</style>
<!--BEGIN: LEFT-->
                    ...
                    <div class="row wrap_regis">
                        <div id="box_regis_1" class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="checkdongy form-group  text-center">
                                <div class="col-sm-12">
                                    <label>
                                        <input type="checkbox" name="checkDongY" id="checkDongY" checked="checked"/>Tôi đã đọc và đồng ý với <a href="<?php echo base_url(); ?>content/391" target="_blank"><strong>Quy chế Cộng tác viên online</strong></a>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 checkup" style="text-align: center">
                            <input type="button" onclick="CheckInput_Emp_Af_Register(<?php echo $uid; ?>);" id="confirmBtn" name="submit_register" value="&nbsp; Đăng ký &nbsp;" class="btn btn-azibai">
