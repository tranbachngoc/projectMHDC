...
<script type="text/javascript">
    ...
    <!--BEGIN: CENTER-->
    <div id="baseUrl" style="display:none;"><?php echo (getAliasDomain() != '') ? getAliasDomain() : base_url(); ?></div>
        ...
        <div class="row">
            <div class="col-lg-12 showcart">
                ...
                <script type="text/javascript">
                    ...
                    var shop_district = '<?php echo $shop['district']; ?>';
                    var ship_fee = 0;
                ...
                <table id="row_<?php echo $key; ?>" class="table" width="100%" cellpadding="0"
                   ...
                   <?php //$this->load->view('home/advertise/center1');?>
                    ...
                    foreach ($cart as $key => $product):
                        ...
                        $link = (getAliasDomain() != '') ? getAliasDomain() : base_url() .'shop/'. $linkt .'/detail/'. $product->pro_id . '/' . RemoveSign($product->pro_name);
                        ...
                        <tr id="row_<?php echo $product->key; ?>">
                            ...
                            <?php
                                ...
                                <?php }else { ?>
                                    <img width="80" src="<?php echo (getAliasDomain() != '') ? getAliasDomain() : base_url() . 'images/img_not_available.png'?>" alt="">
                                <?php } ?>
                                    ...
                                    <?php
                                        ...
                                        if (($product->dp_image != "" || $img1[0] != "")) { // && file_exists($file_ex)?>
                                            <img width="75"
                                                 ...
                                                 alt="" />
                                        <?php } else { ?>
                                            <img width="75" src="<?php echo (getAliasDomain() != '') ? getAliasDomain() : base_url() . 'images/img_not_available.png' ?>"
                                                 alt="" />
                                        <?php } ?>
                                    </p>
                                </div><!--/col4-->
...
<!--                </div>-->
                ...
                <form id="frmShowCart" name="frmShowCart" method="post"
                      action="<?php echo (getAliasDomain() != '') ? getAliasDomain() : base_url(); ?>showcart/order_cart">
