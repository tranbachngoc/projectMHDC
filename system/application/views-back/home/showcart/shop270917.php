    ...
    <div id="main" class="container">
        <div class="row">
            ...
            <div class="col-lg-12 showcart">
                ...
                <?php if (!empty($cart)) { ?>
                <script type="text/javascript" src="/templates/home/js/jquery.validate.min.js"></script>
                <script type="text/javascript">
                    ...
                    function getShippingFee(){
                        ...
                        $.ajax({
                            type: "POST",
                            //url: siteUrl + "showcart/shipping_fee",
                            url: "/showcart/shipping_fee",
                                ...
                                for (var j = 0, prolen = cart[i].products.length; j < prolen; ++j) {
                                    if (cart[i].products[j].key == pKey) {
                                        ...
                                        $.ajax({
                                            ...
                                            data: $('#frmShowCart').serialize()+'&qty='+cart[i].products[j].qty+'&pro_id='+cart[i].products[j].pro_id+'&key='+cart[i].products[j].key+'&dp_id='+dpId,
                                            dataType: "json",
                                            success: function (data) {
                                                if (data.error == false) {
                ...
                <table id="row_<?php echo $key; ?>" class="table" width="100%" cellpadding="0"
                   ...
                   <?php //$this->load->view('home/advertise/center1');?>
                    ...
                    <tr class="table_head">
                        ...
                        <td width="2%" class="hidden-xs">STT</td>
                        <td width="20%">
                        ...
                        <tr id="row_<?php echo $product->key; ?>">
                            ...
                            <?php
                                ...
                                if($product->dp_id > 0){
                                    ...
                                    $link_image = base_url() . 'media/images/product/' . $product->pro_dir . '/' . show_thumbnail($product->pro_dir, $product->dp_image, 1);
                                } else {
                                    $file_ex = 'media/images/product/' . $product->pro_dir . '/' . show_thumbnail($product->pro_dir, $img1[0], 1);
                                    $link_image = base_url() . 'media/images/product/' . $product->pro_dir . '/' . show_thumbnail($product->pro_dir, $img1[0] , 1);    
                                }                                       
                            ...
                            <td class="text-danger" style="" align="right">
                                ...
                                <br/>
                                <span
                                    id="dc_<?php echo $product->key; ?>"><?php echo  $product->em_discount > 0 ? 'Giảm sỉ: '.lkvUtil::formatPrice($product->em_discount, 'đ') : ''; ?></span>
                            </td>
                ...
                <?php } else {?>
                    ...
                    <ul id="row_<?php echo $key; ?>" class="wrap_mobile">
                        <p><i>Bán từ shop: <a href="<?php echo '/'.$shop['sho_link']; ?>"><?php echo $shop['sho_name']; ?></a></i></p>
                        <?php
                        $total = 0;
                        foreach ($cart as $key => $product):
                        $total += ($product->pro_cost * $product->qty - $product->em_discount + $product->shipping_fee);
                                    ...
                                    <div class="qty_row" id="bt_<?php echo $product->key; ?>">
                                        <p class="qty_group">
                                                <span class="add-qty" title="Thêm"
                                                      onclick="cart_update_qty('<?php echo $product->key; ?>', 1, <?php echo $product->dp_id; ?>);">+</span>
...
<!--                </div>-->
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body form_table_revice<?php echo $key ?> form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label for="ord_address_get" class="col-sm-2"><span class="text-danger"></span><strong><span
                                            ...
                                            <div class="form-group">
                                                <label for="ord_smobile_get" class="col-sm-2"><span
                                                        class="form_asterisk"></span><strong><span
                                                            class="info_required">*</span> Số điện
                                                        thoại:</strong></label>
                                            ...
                                            <div class="form-group">
                                                <label for="ord_semail_get" class="col-sm-2">
                                                    <span
                                                        class="form_asterisk"></span>
                                                    <strong><span
                                                            class="info_required">*</span>Email :</strong>
                                                </label>
                                                <div class="col-sm-10 form_text">
                                                    <input type="text" maxlength="250" placeholder="Nhập email" value="<?php echo isset($user['use_email']) ? $user['use_email'] : ''; ?>" name="ord_semail" id="ord_semail_get" title=" " autocomplete="off" class="form-control email" required="required">
                                                </div>
                                                ...
                                                <li>Thông qua :
                                                    <select name="company" id="company" class="form-control">
                                                        <?php foreach ($company as $key => $vals): ?>
                                                            <option
                                                                value="<?= $key; ?>" <?= ($shipping_fee[$product->pro_id]['shipping_fee']) ? "selected='selected'" : ""; ?> ><?= $vals ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </li>
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    ...
                    orderForm.validate({
                        ...
                        $.ajax({
                            type: "POST",
                            //url: siteUrl + "showcart/place_order",
            ...
            <?php } else { ?>
                <div class="alert alert-info" role="alert">
                    <?php echo $this->lang->line('none_record_showcart_defaults'); ?>! Vui lòng trở lại <a href="/">Trang chủ Azibai</a> tìm sản phẩm và chọn thêm vào Giỏ hàng!
                </div>
            <?php } ?>
        </div>
    </div>
...
<?php if (isset($fullProductShowcart) && $fullProductShowcart == true) { ?>
    <script>
        alert('<?php echo $this->lang->line('full_product_showcart_defaults'); ?>');
    </script>
<?php } ?>
