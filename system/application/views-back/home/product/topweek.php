        ...
        <tr>
            <td>
                <div class="temp_3">
                	<div class="title">
                    	<div class="fl">
                        	<h2><?php if($categoryName!=''&& isset($categoryName)){ echo $categoryName." - "; } ?><?php echo $this->lang->line('title_topweek_feauture'); ?></h2>
                        </div>
                    </div>
                </div>
            </td>
        ...
        <?php /*?><tr>
            <td>
                <div class="temp_3">
                	<div class="title">
                    	<div class="fl">
                        	<h2><?php if($categoryName!=''&& isset($categoryName)){ echo $categoryName." - "; } ?><?php echo $this->lang->line('title_topweek_new'); ?></h2>
                        </div>
                    </div>
                </div>
            </td>
                         ...
                         <div class="showCateGoRyScren">
                            ...
                            <div class="showbox_1 showbox_1q" id="DivReliableProductBox_<?php echo $idDiv; ?>" onmouseover="ChangeStyleBox('DivReliableProductBox_<?php echo $idDiv; ?>',1)" onmouseout="ChangeStyleBox('DivReliableProductBox_<?php echo $idDiv; ?>',2)">
                        	   ...
                        	   <?php for($vote = 0; $vote < (int)$reliableProductArray->pro_vote_total; $vote++){ ?>
                                     ...
                                     <img src="<?php echo base_url() ?>media/images/product/<?php echo $reliableProductArray->pro_dir; ?>/<?php echo show_thumbnail($reliableProductArray->pro_dir, $reliableProductArray->pro_image, 3); ?>" onmouseover="tooltipPicture(this,'<?php echo 'f'.$reliableProductArray->pro_id;?>')" id="<?php echo $reliableProductArray->pro_id;?>"  class="image_boxpro" alt="<?php echo ($reliableProductArray->pro_name);?>"/>                                        
                                        </td>    
                                      </tr> 
                                    </table>
                                ...
                                <div class="icon-saleoff" ><span class="giamgia"><?php if($reliableProductArray->pro_saleoff==1) {?>Khuyến mãi<?php } ?> </span></div>
                                    <div class="cost_showbox" id="price-<?php echo $reliableProductArray->pro_id;?>">
                                        <span id="DivCostReliablenwe_<?php echo $idDiv; ?>"></span>&nbsp;<?php echo $reliableProductArray->pro_currency; ?>
                                    </div>
                                    <script type="text/javascript">FormatCost('<?php 
if($reliableProductArray->pro_type_saleoff==1) echo $reliableProductArray->pro_cost-(($reliableProductArray->pro_cost*$reliableProductArray->pro_saleoff_value)/100); else echo $reliableProductArray->pro_cost-$reliableProductArray->pro_saleoff_value;?>', 'DivCostReliablenwe_<?php echo $idDiv; ?>');</script>
                            </div>
                            <?php $idDiv++; ?>
                            <?php } ?>
                            </div>
                            ...
                            <table align="center" style="margin-top:6px;" width="100%" border="0" cellpadding="0" cellspacing="0">
                        	   ...
                        	   <?php for($vote = 0; $vote < (int)$favoriteProductArray->pro_vote_total; $vote++){ ?>
                                                ...
                                                <div style="display:none" id="price-<?php echo 'fr'.$favoriteProductArray->pro_id;?>">
                                                     <span id="DivCostReliable_<?php echo 'fr'.$favoriteProductArray->pro_id; ?>"></span>&nbsp;<?php echo $favoriteProductArray->pro_currency; ?>
                                                </div>
                                                <script type="text/javascript">FormatCost('<?php 
                        if($favoriteProductArray->pro_type_saleoff==1) echo $favoriteProductArray->pro_cost-(($favoriteProductArray->pro_cost*$favoriteProductArray->pro_saleoff_value)/100); else echo $favoriteProductArray->pro_cost-$favoriteProductArray->pro_saleoff_value;?>', 'DivCostReliable_<?php echo 'fr'.$favoriteProductArray->pro_id; ?>');
                                                </script>
                                                <img src="<?php echo base_url() ?>media/images/product/<?php echo $favoriteProductArray->pro_dir; ?>/<?php echo show_thumbnail($favoriteProductArray->pro_dir, $favoriteProductArray->pro_image); ?>" onmouseover="tooltipPicture(this,'<?php echo 'fr'.$favoriteProductArray->pro_id;?>')" id="<?php echo 'fr'.$favoriteProductArray->pro_id;?>"  class="image_boxpro"/>
                                            </a>
                                        </div>
                                    </td>
