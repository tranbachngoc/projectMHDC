                  ...
                  <div class="show-photo-nav list-slider" data-id="333">
                    ...
                    <?php 
                      ...
                      <li class="" data-dp1="<?php echo $color;?>" data-dp2="<?php echo $size;?>" data-dp3="<?php echo $material;?>">
                        <a href="#" data-image="<?php echo DOMAIN_CLOUDSERVER . 'media/images/product/' . $product->pro_dir . '/' . $value;?>" data-zoom-image="<?php echo DOMAIN_CLOUDSERVER . 'media/images/product/' . $product->pro_dir . '/' . $value;?>" <?php echo $class_act; ?>>
...
<script type="text/javascript">
    ...
    $.ajax({
      ...
      success: function(result){
        ...
        if(tqc == 1){
          ...
          if($(window).width() < 768){
            $('dl#dp_color dt .txt_color').text($('.tqc1:contains("'+selected.dp_color+'")').text());
          }
          // process tqc
          var html = '';
        ...
        if(tqc == 2){
          ...
          if($(window).width() < 768){
            $('dl#dp_size dt .txt_size').text($('.tqc2:contains("'+selected.dp_size+'")').text());
          }
          // change tqc 3
          var html = '';
          if(selected.dp_material.toString() != ''){
        ...
        if(tqc == 3){
          ...
          if($(window).width() < 768){
            $('dl#dp_meterial dt .txt_material').text($('.tqc3:contains("'+selected.dp_material+'")').text());
          }
        }
  ...
  $('.popup-detail-image').click(function(){
    ...
    if(length_material > 0 || length_size > 0 || length_color > 0){
      var text_qc = class_ = '';
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          if(tqc == 1){
            $('.tqc1').removeClass("is-active");
            $('.tqc1:contains("'+txt_color+'")').addClass("is-active");
            if($(window).width() < 768){
              $('dl#dp_color dt .txt_color').text($('.tqc1:contains("'+selected.dp_color+'")').text());
            }
            // process tqc
          ...
          if(tqc == 2){
            ...
            $('.tqc2').removeClass("is-active");
            $('.tqc2:contains("'+txt_size+'")').addClass("is-active");
          ...
          if(tqc == 3){
            $('.tqc3').removeClass("is-active");
            $('.tqc3:contains("'+txt_material+'")').addClass("is-active");
  ...
  function slick_gall02(){
    if($('.gallery_02').hasClass('slick-slider') === true){
