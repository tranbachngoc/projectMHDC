        ...
        <tr>
            <td>
                <div class="temp_3">
                	<div class="title">
                    	<div class="fl">
                        	<h2><?php if($categoryName!=''&& isset($categoryName)){ echo $categoryName." - "; } ?><?php echo $this->lang->line('title_cheapest_feauture'); ?></h2>
                        </div>
                    </div>
                </div>
            </td>
        ...
        <?php /*?><tr>
            <td>
                <div class="temp_3">
                	<div class="title">
                    	<div class="fl">
                        	<h2><?php if($categoryName!=''&& isset($categoryName)){ echo $categoryName." - "; } ?><?php echo $this->lang->line('title_cheapest_new'); ?></h2>
                        </div>
                    </div>
                </div>
            </td>
                        ...
                        <td valign="top" align="center">
                           ...
                           <div class="showbox_1 showbox_1q" id="DivReliableProductBox_<?php echo $idDiv; ?>" onmouseover="ChangeStyleBox('DivReliableProductBox_<?php echo $idDiv; ?>',1)" onmouseout="ChangeStyleBox('DivReliableProductBox_<?php echo $idDiv; ?>',2)">
                        	   ...
                        	   <?php for($vote = 0; $vote < (int)$reliableProductArray->pro_vote_total; $vote++){ ?>
                                ...
                                <div class="icon-saleoff" ><span class="giamgia"><?php if($reliableProductArray->pro_saleoff==1) {?>Khuyến mãi<?php } ?> </span></div>
                                    <div class="cost_showbox" id="price-<?php echo $reliableProductArray->pro_id;?>">
                                        <span id="DivCostReliablegiaNew_<?php echo $idDiv; ?>"></span>&nbsp;<?php echo $reliableProductArray->pro_currency; ?>
                                    </div>
                                    <script type="text/javascript">FormatCost('<?php 
if($reliableProductArray->pro_type_saleoff==1) echo $reliableProductArray->pro_cost-(($reliableProductArray->pro_cost*$reliableProductArray->pro_saleoff_value)/100); else echo $reliableProductArray->pro_cost-$reliableProductArray->pro_saleoff_value;?>', 'DivCostReliablegiaNew_<?php echo $idDiv; ?>');</script>
                            </div>
