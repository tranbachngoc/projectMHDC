...
<link rel="stylesheet" href="/templates/home/boostrap/css/bootstrap-datetimepicker.min">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script>
<script src="/templates/home/boostrap/js/bootstrap-datetimepicker.min"></script>
  ...
  <main class="sanphamchitiet">      
      <section class="main-content">
        ...
        if($shop->domain != ''){
          ...
          $sholink = $shop->sho_link.'.'.domain_site;
        }
        ...
        <div class="container">
          <div class="info-shop">
            <div class="left">
              ...
              <div class="logo">
                <a href="<?php echo get_server_protocol().$sholink; ?>">
                  <?php
              ...
              <div class="name">
                <h3>
                  <a href="<?php echo get_server_protocol().$sholink; ?>"><?php echo $shop->sho_name ?></a>
                  <br>
          ...
          <div class="sanphamchitiet-content box-detailpro row content-posts">
            <div class="col-md-5">
              <?php if ($this->session->userdata('sessionUser') == $product->pro_user) : ?>
                  <div class="button-chinh-sua sm hidden">
                      <a href="<?php echo base_url() ?>product/edit/<?php echo $product->pro_id.'/'.RemoveSign($product->pro_name) ?>"
                         target="_blank">
              ...
              <div class="sanphamchitiet-content-gallery">
                <div class="show-photo">
                  <div class="show-photo-nav list-slider" data-id="333">
                    <ul class="slider sliderpro gallery_01" id="slider-for_333"><!-- slider-for  -->
                    <?php 
                  ...
                  <div class="show-photo-main">
                    <img id="zoom_03" src="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/' . $product->pro_dir . '/' . $pro_image[0];?>" data-zoom-image="<?php echo DOMAIN_CLOUDSERVER .'media/images/product/' . $product->pro_dir . '/' . $pro_image[0];?>" alt="">
                  </div>
                </div>
                <div class="show-info-product">
                  ...
                  <div class="button-buy-product md">
                    ...
                    <div class="buttons-group">
                      ...
                      <button class="btn-bg-gray" onclick="buyNowQty(<?php echo $product->pro_id; ?>);">Mua ngay</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-7">
              ...
              <div class="sanphamchitiet-content-detail">
                ...
                ?>
                <div class="price">
                  <div class="no-sale md"><strong class="dong">đ</strong><span class=""><?php echo number_format( ($giagoc), 0, ",", "."); ?></span></div>
                  ...
                  <div class="no-sale sm"><strong class="dong">đ</strong><span class=""><?php echo number_format( ($giagoc), 0, ",", "."); ?></span></div>
                </div>
                <?php } else {
                ?>
                <div class="price">
                    ...
                    <dd>
                      <ul class="buttons">
                        <?php foreach ($ar_color as $key => $value) { ?>
                          <li class="tqc1 <?php if($value == $product_check_TQC->dp_color) echo 'is-active' ?>"><?php echo $value; ?></li>
                        <?php } ?>
                      </ul>
                    </dd>
                  </dl>
                    ...
                    <dd>
                      <ul class="buttons">
                        <?php foreach ($ar_size as $key => $value) { ?>
                          <li class="tqc2 <?php if($value == $product_check_TQC->dp_size) echo 'is-active' ?>"><?php echo $value; ?></li>
                        <?php } ?>
                    ...
                    <dd>
                      <ul class="buttons">
                        <?php foreach ($ar_material as $key => $value) { ?>
                          <li class="tqc3 <?php if($value == $product_check_TQC->dp_material) echo 'is-active' ?>"><?php echo $value; ?></li>
                        <?php } ?>
                ...
                <div class="show-info-product ml00 mb20 sm">
                  <div class="add-minus-product pl10" id="bt_<?php echo $product->pro_id; ?>">
                    ...
                    <p class="sanco"><?php echo $product->pro_instock .' có sẵn';?></p>
                  </div>
          ...
          <div class="fix-thieudiv-2">
                ...
                <ul class="slider recent-slider">
                  ...
                  <li class="item-li">
                    ...
                    <div class="text-right" id="bt_<?php echo $item_pro->pro_id?>">
                      <!-- <button onclick="addCart(<?php echo $item_pro->pro_id; ?>);"><a class="btn btn-default addToCart" href="javascript:void();">Thêm vào giỏ</a></button> -->
                      <input type="hidden" name="product_showcart" value="<?php echo $item_pro->pro_id; ?>">
                      <input type="hidden" name="af_id" value="<?php echo $af_id; ?>">
                      <input type="hidden" name="dp_id" id="dp_id" value="<?php echo $item_pro->dp_id; ?>">
            ...
            <div class="fix-gnav-sm sm">
              ...
              <div class="buttons-group"><button class="btn-bg-gray" onclick="buyNowQty(<?php echo $product->pro_id; ?>);">Mua ngay</button></div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <ul class="show-more-detail">
                <a href="<?php echo get_server_protocol().$sholink; ?>"><li>Đến trang của gian hàng</li></a>
                ...
                <?php } ?>
                <a href="javascript:void(0)" onclick="copylink('<?php echo get_server_protocol().$sholink ?>')"><li>Sao chép liên kết gian hàng</li></a>
      ...
      <div class="modal fade" id="reportpopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body" id="">
              <div class="title">Gửi báo cáo cho sản phẩm này</div>
              <div class="close-popup">
                <img src="/templates/home/styles/images/svg/close_.svg" data-dismiss="modal">
              </div>
              <form class="report">
                ...
                <?php } ?>
                <textarea type="text" class="rpd_reason hidden" id="" placeholder="Nhập nội dung báo cáo" class="" maxlength="255" rows="5" style="resize: none; width: 100%; padding: 5px; margin-bottom: 10px;"/></textarea>
                <div class="button-report">
                  <button class="btn-report btn-close" data-dismiss="modal">Đóng</button>
    ...
    $.ajax({
      ...
      success: function(result){
        ...
        if(tqc == 1){
          ...
          if($(window).width() < 768){
            $('dl#dp_color dt div').text($('.tqc1:contains("'+selected.dp_color+'")').text());
          }
          // process tqc
          var html = '';
          ...
          if(selected.dp_material.toString() != ''){
            ...
            $.each(arr_meterial, function(i, val){
              if(selected.dp_material.toString() == val.toString()){
                ...
                if($(window).width() < 768){
                  $('dl#dp_meterial dt div').text(val);
                }
              }else{
        ...
        if(tqc == 2){
          ...
          if($(window).width() < 768){
            $('dl#dp_size dt div').text($('.tqc2:contains("'+selected.dp_size+'")').text());
          }
          // change tqc 3
          var html = '';
          if(selected.dp_material.toString() != ''){
            $.each(arr_tqc, function(i, val){
              if(selected.dp_material.toString() == val.material.toString()){
                html += '<li class="tqc3 is-active">'+val.material+'</li>';
                if($('body').width() < 768){
                  $('dl#dp_meterial dt div').text(val.material);
                }
              }else{
        ...
        if(tqc == 3){
          ...
          $('.tqc3:contains("'+selected.dp_material+'")').addClass("is-active");

          if($(window).width() < 768){
            $('dl#dp_meterial dt div').text($('.tqc3:contains("'+selected.dp_material+'")').text());
          }
        }
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    ...
    $('body').on('click', '#reportpopup form label', function(){
      ...
      if(text.includes('Nhập') == true || $(this).find('input').val() == 11){
        $('.rpd_reason').removeClass('hidden');
      }else{
        $('.rpd_reason').addClass('hidden');
      }
    });

    $('body').on('click', '.btn-send', function(){
      var sho_name = $('.info-shop .name h3 a').text();
      var sho_link = $('.info-shop .name h3 a').attr('href');
      var pro_id = (window.location.pathname).split('/')[2];
      var pro_name = $('.sanphamchitiet-content-detail .tit').text();
      var pro_link = window.location.href;
      var rp_id = $('input[name="rp_id"]:checked').val();
      var rpd_reason = '';
      var error = false;

      if($('.rpd_reason').hasClass('hidden') == false)
      {
        if($('.rpd_reason').val() == ''){
          error = true;
