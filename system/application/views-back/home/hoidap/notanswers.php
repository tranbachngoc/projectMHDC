...
<div class="temp_3">
	<div class="title" style="margin-right:10px; margin-bottom:5px;">
    	<div class="fl">
            <h2><?php echo $this->lang->line('title_not_answers'); ?></h2>
        </div>
        <div class="fr" style="margin-top:10px;">
            <ul>
              <li><a title="" href="<?php echo base_url() ?>hoidap/latest"><?php echo $this->lang->line('title_top_news'); ?></a></li>
              <li><a title="" href="<?php echo base_url() ?>hoidap/topanswers"><?php echo $this->lang->line('title_top_answer'); ?></a></li>
