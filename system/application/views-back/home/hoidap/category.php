...
<div class="hoidapBackrum">
   <?php if($CategorysiteGlobalRoot->cat_id=="") { ?>
                ...
                <div class="bgrumQHome" >          
                	<a  href="<?php echo base_url() ?>" class="home">Home</a>         <img src="<?php echo base_url(); ?>templates/shop/style2/images/navigate_icon.gif" alt="" />           </div>
          ...
          <div class="sub_cateory_bgrum"> 
        	<?php echo $raovat_sub; ?>
                    ...
                    <a href="<?php echo base_url()?>hoidap/<?php echo $CategorysiteGlobalRoot->cat_id; ?>/<?php echo RemoveSign($CategorysiteGlobalRoot->cat_name);?>"><?php echo mb_substr($CategorysiteGlobalRoot->cat_name,0,30,'UTF-8'); ?></a>                    
                 ...
                 <?php    } ?>
                    ...
                    <a  href="<?php echo base_url()?>hoidap/<?php echo $CategorysiteGlobal->cat_id; ?>/<?php echo RemoveSign($CategorysiteGlobal->cat_name);?>"><?php echo mb_substr($CategorysiteGlobal->cat_name,0,30,'UTF-8'); ?></a>
...
<!--<div class="temp_3">
    ...
    <div class="title" style="margin-right:10px; margin-bottom:5px; height:auto; padding-left:10px;">
    	<?php if(isset($categorylv1) && count($categorylv1) > 0){
			foreach($categorylv1 as $catitem){
			$subcat = $catitem->cat_level2;
		?>
        	<div class="sub_cat"><a onmouseover="hoverpop('<?php echo count($subcat);?>','<?php echo $catitem->cat_id;?>',this)" <?php if(count($subcat) >0){echo 'class="has_child"';}?> href="<?php echo base_url()?>hoidap/<?php echo $catitem->cat_id; ?>/<?php echo RemoveSign($catitem->cat_name);?>"><?php echo $catitem->cat_name;?></a></div>
            <div class="sub_sub_cat" id="sub_sub_cat_<?php echo $catitem->cat_id;?>">
                ...
                <div class="sub_sub_cat_item">
                	<a href="<?php echo base_url()?>hoidap/<?php echo $suvcatitem->cat_id; ?>/<?php echo RemoveSign($suvcatitem->cat_name);?>"><?php echo $suvcatitem->cat_name;?></a>
                </div>
                <?php } }?>
		...
		?>
        	<div class="sub_cat"><a href="<?php echo base_url()?>hoidap/<?php echo $catitem->cat_id; ?>/<?php echo RemoveSign($catitem->cat_name);?>"><?php echo $catitem->cat_name;?></a></div>
		 <?php } }?>
        <div style="clear:both"></div>
    </div>
    <?php } ?>
    <div class="content">
    	<?php foreach($cat as $item){ ?>
        	<div style="height: auto; margin-bottom:5px;">
               ...
               <a href="<?php echo base_url(); ?>user/profile/<?php echo $item->use_id; ?>"><img alt="<?php echo ($item->hds_title);?>" width="50" height="50" src="<?php if($item->avatar !=''){echo base_url().'media/images/avatar/'.$item->avatar;}else{echo  base_url().'media/images/avatar/default.png';}?>"  onmouseover="tooltipPictureUser(this,'<?php echo $item->use_id;?>')" /></a> 
                </div>
                <div class="data">
                	<div class="name">
                      <input type="hidden" id="title-<?php echo $item->hds_id;?>" value="<?php echo $item->hds_title;?>"/>
                		...
                		<a href="<?php echo base_url(); ?>user/profile/<?php echo $item->use_id; ?>" class="text_link_bold"><?php echo $item->hds_username;?></a> 
...
<a href="<?php echo base_url(); ?>hoidap/post">
<img src="<?php echo base_url(); ?>/templates/home/images/danghoidap.png"  />
</a>
