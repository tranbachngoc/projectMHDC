...
<div class="bosuutap-content">
  <div class="bosuutap-tabbosuutap-xemluoi append-box">
    <?php foreach ($items as $key => $item) {
      $this->load->view('home/personal/collection-ver2/element/item-collection-link', ['item' => $item, 'link_categories_p' => $link_categories_p, 'profile_url' => $info_public['profile_url']], FALSE);
    }?>
  </div>
</div>
</div>
...
<?php $this->load->view('home/personal/collection-ver2/popup/popup-collection-link-filter-category', ['link_categories_p' => $link_categories_p, 'profile_url' => $info_public['profile_url'], 'url_javascript' => $url_javascript]);?>
<?php $this->load->view('home/personal/collection-ver2/popup/popup-collection-link-menu-item');?>
