	...
	<section class="main-content">
      ...
      <?php $this->load->view('home/personal/affililate-shop/common/sidebar_menu');?>
		...
		<div class="shop-product">
			<div class="container">
				<!-- bộ filter -->
				<?php $this->load->view('home/personal/affililate-shop/element/shop_slash_pro_coup');?>
				<!-- END bộ filter -->

				<div class="shop-product-items">
          <?php foreach ($items as $key => $item) { ?>
						<?php $this->load->view('home/personal/affililate-shop/ajax_html/item-shop-slash-pro-coup', ['item'=>$item]);?>
					<?php } ?>
				</div>
