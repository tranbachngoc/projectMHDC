          ...
          <div class="permision">
            ...
            <div class="permision-list">
              <ul class="item-check">
                ...
                <li>
                  <label class="checkbox-style-circle">
                    <input type="radio" name="edit_album_permission" value="2" data-text="Bạn bè" <?=$album_info->album_permission == PERMISSION_SOCIAL_FRIEND ? 'checked' : ''?>>
                    <span>Bạn bè</span>
                  </label>
                </li>
                <li>
...
<script>
  ...
  */
  ...
  $('.js-edit-album-img .js-edit-popup-album-img-update').click(function () {
    ...
    $.ajax({
      type: "post",
      url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/update',
      data: edit_formData,
      processData: false,
      contentType: false,
