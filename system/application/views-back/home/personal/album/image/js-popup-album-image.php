...
<script>
  ...
  */
  ...
  $('input[name="img_upload"]').change(function (event) {
    function readAndPreview(file, i, max_i) {
      ...
      reader.onload = function (e) {
        ...
        $.ajax({
          type: "post",
          url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/upImage',
          data: formData,
          processData: false,
          contentType: false,
  ...
  $('.js-popup-album-img-create').click(function (event) {
    ...
    $.ajax({
      type: "post",
      url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/create',
      data: formData,
      processData: false,
      contentType: false,
  ...
  $('.js-popup-select-library .block-content').scroll(function (event) {
    if ($(this).scrollTop() + $(this).find('.col-item').height() >= $(this).height()) {
      ...
      $.ajax({
        type: 'post',
        dataType: 'html',
        url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/load-img-lib',
...
<script>
  ...
  $('.js-act-set-top').on('click', function() {
    ...
    $.ajax({
      type: "post",
      url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/off-set',
      data: formData,
      processData: false,
      contentType: false,
      success: function (response) {
  ...
  $('.js-comfirm-delete').on('click', function () {
    ...
    if($(this).attr('data-deleteFor') == 'ALBUM'){
      ...
      $.ajax({
        type: "post",
        url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/delete-album',
        data: formData,
        processData: false,
        contentType: false,
        success: function (response) {
    ...
    if($(this).attr('data-deleteFor') == 'IMAGE'){
      ...
      $.ajax({
        type: "post",
        url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+ "/library/album-image/remove-item-library",
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
  ...
  $('.js-act-edit-album').on('click', function () {
    ...
    $.ajax({
      type: "post",
      url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>"+'/library/album-image/getInfoAlbum',
      data: formData,
      processData: false,
      contentType: false,
      success: function (response) {
...
<script>
  ...
  $('body').on('click', '.js-ghim-album', function () {
    ...
    $.ajax({
      type: 'post',
      dataType: 'html',
      url: siteUrl + 'profile/'+"<?=$current_profile['use_id']?>" + '/library/album-image/openPopupGhim',
