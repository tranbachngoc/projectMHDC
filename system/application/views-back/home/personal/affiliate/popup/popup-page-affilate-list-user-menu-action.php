        ...
        <ul class="show-more-detail">
          <li class="level-3">
            <label class="checkbox-style-circle">
              <input type="radio" name="level" value="3"><span>Đại lý (D3)</span>
            </label>
          </li>
          <li class="level-2">
            <label class="checkbox-style-circle">
              <input type="radio" name="level" value="2"><span>Tổng đại lý (D2)</span>
            </label>
          </li>
        </ul>
      </div>
...
<script>
  ...
  $('body').on('click', '.js-menu-item', function () {
    ...
    $('#js-menu-item .js-action-service-item-step1').attr('data-name',name);
  ...
  $('body').on('click', '.js-action-service-item-step1', function () {
    ...
    var url = "<?=azibai_url('/affiliate/user/')?>" + id + '<?="?type_sv=1&href=".urlencode(get_current_full_url())?>' + '&name='+encodeURI(__name);
