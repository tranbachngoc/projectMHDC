...
$link = azibai_url("/{$item['pro_category']}/{$item['id']}/") . RemoveSign($item['name']) . $af_key;
?>
<div class="item">
  <div class="img hovereffect">
    <img class="img-responsive" src="<?=$item['sImage']?>" alt="">
    <div class="action">
  ...
  <div class="text">
    <a href="<?=$link?>">
      <p class="tensanpham two-lines">
        ...
        <?=$item['name']?></p>
      <div class="giadasale"><span class="dong">đ</span><?=number_format($item['iDiscountPrice'],0,'.',',')?></div>
      <div class="giachuasale"><?=number_format($item['iPrice'],0,'.',',')?></div>
    </a>
