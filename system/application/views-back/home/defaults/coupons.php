...
<!--    <div class="row">
    ...
    <div class="row text-center">
        <div class="active col-xs-6 col-sm-3 col-sm-offset-3" style="margin-top:0px;margin-bottom:20px;">
            <a class="btn btn-lg btn-default btn-block" href="/shop/products"><i class="fa fa-shopping-cart fa-fw"></i> Sản phẩm</a>
        </div>
        <div class="col-xs-6 col-sm-3" style="margin-top:0px;margin-bottom:20px;">
            <a class="btn btn-lg btn-default1 btn-block" href="#"><i class="fa fa-tags fa-fw"></i> Coupon</a>
        </div>	    
    </div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">	    
            <div style="background: #fff; padding: 10px 0px 0; border:1px solid #ddd; border-radius: 4px;">
				...
				$imgsrc = '/images/noimage.jpg';
                            ...
                            <img style="height:70px; border-radius:50%; border:1px solid #999;  margin-bottom: 10px;" src="<?php echo $imgsrc ?>"/>
                            <span style="display: block; height: 50px; overflow: hidden; margin-top: 10px;">
    ...
    <div id="products" class="products text-center row">
                <?php foreach ($allcoupons as $key => $product) {
                    $idDiv = 1;
                    $afSelect = false;
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #eee;">                
                ...
                <form id="formfilter" method="get" action="<?php echo base_url() . 'shop/coupons' ?>" class="form">
                    ...
                    <div class="row">
                        <?php foreach ($azitab['cat_coupon'] as $k => $catitem) {
