    ...
    <div class="container">
        <div class="cover-content">
            ...
            <div class="avata-part-left">
                ...
                <?php if ($is_owner) {?><div class="edit"><span><img src="/templates/home/styles/images/svg/pen.svg" alt=""></span></div><?php } ?>
                </div>
            ...
            <div class="avata-part-right">
              ...
              <?php if ($is_owner) {?><div class="xemthem"><img src="/templates/home/styles/images/svg/3dot_white.svg" alt=""></div><?php } ?>
            </div>
            </div>
        </div>
    </div>
    <div class="container bosuutap">
        <div class="bosuutap-header">
            ...
            <ul class="bosuutap-tab-content">
                <li class="is-active"><a href="<?php echo base_url() . 'shop/collection/' . $uid;?>">Tất cả </a></li>
                <li><a href="<?php echo base_url() . 'shop/collection/' . $uid . '/select';?>">Bộ sưu tập</a></li>
            </ul>
            </div>
