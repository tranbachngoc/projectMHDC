...
<form  name="NLpayBank" action="<?php echo base_url(); ?>payment/addWallet/payment_nl" method="post">
    ...
    <div class="payment_info" id="payment_info_nganluong">
        <input required="required" class="form-control" id="amount" placeholder="Nhập số tiền cần nạp" type="text" style="display:inline-block;width:72%;vertical-align: top;" name="amount" >
