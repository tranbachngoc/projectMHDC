...
<?php if((int)$advertiseArray->adv_position ==16 ){ ?>
...
<?php }else { ?>
	    ...
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank">
	        ...
	        <?php }else{ ?>
			<img border="0" src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" class="advertise_right" alt="giang hang phai"/>
			<?php } ?>
		</a>
<?php } ?>
<?php } ?>
