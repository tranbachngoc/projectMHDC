...
<?php if(((int)$advertiseArray->adv_position == 1 || (int)$advertiseArray->adv_position == 2) && $advertiseArray->cat_id == $id ){ 
...
<?php if($counter == 0){ ?>
<img class="img-responsive" border="0" src="<?php echo base_url(); ?>media/banners/default/default_980_250.jpg" />
<?php	} ?>
