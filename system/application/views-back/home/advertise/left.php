...
<?php if((int)$advertiseArray->adv_position == 3){ ?>
<tr>
	<td align="left">
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank" >
	        <?php if(strtolower(substr($advertiseArray->adv_banner, -4)) == '.swf'){ ?>
	        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" class="advertise_left_flash" id="FlashID_<?php echo $advertiseArray->adv_id; ?>" alt="<?php echo $advertiseArray->adv_title; ?>">
	        ...
	        <?php }else{ ?>
			<img alt="<?php echo($advertiseArray->adv_title);?>" border="0" src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" class="advertise_left" />
			<?php } ?>
		</a>
	</td>
</tr>
