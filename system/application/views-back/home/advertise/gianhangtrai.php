...
<?php if((int)$advertiseArray->adv_position ==15 ){ ?>
	    ...
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank">
	        ...
	        <?php }else{ ?>
			<img border="0" src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" class="advertise_left" alt="gian hang trai" />
			<?php } ?>
		</a>
