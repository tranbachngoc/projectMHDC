...
<?php if((int)$advertiseArray->adv_position == 11  && $advertiseArray->adv_page == 'home' && $advertiseArray->cat_id == $id){ 
$counter = $counter +1;
	if ($counter>1) 
	{
		break;
...
if ($counter==0) 
{
	?><img class="img-responsive" border="0" src="<?php echo base_url(); ?>media/banners/default/default_425_600.jpg" /><?php
