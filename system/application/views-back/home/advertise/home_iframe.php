...
<?php if((int)$advertiseArray->adv_position == 18 ){ ?>
<?php if($advertiseArray->adv_iframe != "") { ?>
<tr>
	<td>
    	<?php echo '<iframe scrolling="no" frameborder="0" style="border:none; width:130px; height:1080px;" src="'.$advertiseArray->adv_iframe.'">';
        ?>
...
<tr>
	<td align="center">
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank" title="<?php echo $advertiseArray->adv_title; ?>">
	        ...
	        <?php }else{ ?>
			<img border="0" src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" class="" />
			<?php } ?>
		</a>
	</td>
</tr>
