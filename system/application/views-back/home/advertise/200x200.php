...
foreach($advertise as $advertiseArray){ ?>
	<?php if((int)$advertiseArray->adv_position == 6 && $advertiseArray->adv_page == 'home'  && $advertiseArray->cat_id == $id){
	//echo $advertiseArray->adv_id;
	$counter = $counter +1;
	if ($counter>2) 
	{
		break;
	 ...
	 ?>
		<div class="left20 pull-left">
			<a href="<?php echo base_url().'adv/'.$advertiseArray->adv_id; ?>" target="_blank" >
				...
				<?php }else{ ?>
				<img border="0" src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" />
				<?php } ?>
			</a>
		</div>
	<?php } elseif((int)$advertiseArray->adv_position == 7  && $advertiseArray->adv_page == 'home'   && $advertiseArray->cat_id == $id){ ?>
		<div >
			<a href="<?php echo base_url().'adv/'.$advertiseArray->adv_id; ?>" target="_blank" >
				<?php if(strtolower(substr($advertiseArray->adv_banner, -4)) == '.swf'){ ?>
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" class="advertise_top_flash" id="FlashID_<?php echo $advertiseArray->adv_id; ?>" title="<?php echo $advertiseArray->adv_title; ?>">
...
if ($counter==0) 
{
	for($i=0;$i<4;$i++)
	{
	?><img style="width:50%" border="0" src="<?php echo base_url(); ?>media/banners/default/default_200_200.jpg" /><?php
	}
}
?>
