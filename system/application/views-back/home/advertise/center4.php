...
<?php if((int)$advertiseArray->adv_position == 13){ ?>
<tr>
	<td align="center">
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank" >
	        ...
	        <?php }else{ ?>
			<img class="banner-advertisement" border="0" width="562" src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" />
			<?php } ?>
		</a>
	</td>
</tr>
