       ...
       <tr>
        ...
        <tr>
            <td background="<?php echo base_url(); ?>templates/home/images/bg_tinraovat.jpg" height="29">
                <table align="center" height="29" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="300" class="title_boxemploy_1">
            ...
            <td  >
                <table align="center"  border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'f1f9ff';}else{echo 'FFF';} ?>;" id="DivRowEmploy_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRowEmploy_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRowEmploy_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                        <td width="25" height="32" class="line_boxemploy_1" ><img src="<?php echo base_url(); ?>templates/home/images/icon_tieudeemploy.gif" /></td>
                        <td width="238" height="32" class="line_boxemploy_1"><a class="menu" href="<?php echo base_url(); ?>employ/field/<?php echo $searchEmployArray->emp_field; ?>/detail/<?php echo $searchEmployArray->emp_id; ?>" onmouseover="ddrivetip('<?php echo $this->lang->line('level_tip'); ?>&nbsp;<?php echo $searchEmployArray->emp_level; ?><br /><?php echo $this->lang->line('position_like_tip'); ?>&nbsp;<?php echo $searchEmployArray->emp_position; ?>',300,'#F0F8FF');" onmouseout="hideddrivetip();"><?php echo sub($searchEmployArray->emp_title, 60); ?></a>&nbsp;<span class="number_view">(<?php echo $searchEmployArray->emp_view; ?>)</span>&nbsp;</td>
