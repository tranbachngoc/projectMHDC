...
<div class="shop-breadcrumb">
  ...
  <a href="javascript:void(0)" class="ml10">
    <img src="/templates/home/styles/images/svg/next.svg" width="10" class="mt05" alt="">&nbsp; <?=@$_REQUEST["keyword"]?></a>
</div>
<!-- END LOAD breadcrumb -->
    ...
    <div class="show-product">
      <div class="shop-product-items catalogue-product-items">
        <?php foreach ($items as $key => $value) {
          $this->load->view('e-azibai/search-product/item',['item'=>$value]);
        }?>
      </div>
    </div>
  </div>
