<div class="product-owl-carousel-2 owl-carousel" id="<?php echo$cat_id?>">
<div class="rowitem">
    <div class="row">
        <?php
		...
		<div class="col-xs-6 col-sm-3 product-item">                                        
			...
			<div class="product-item-detail text-center">
			    <span class="product-item-name"><a href="<?php echo $a ?>" title="<?php echo $item->pro_name ?>"><?php echo $item->pro_name ?></a></span>					
			    <div class="product-item-price">
				<div class="price">
                                <?php if ($discount['salePrice'] < $item->pro_cost) { ?>
