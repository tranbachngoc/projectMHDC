...
<div id="main" class="container">
    <ol class="breadcrumb">                  
        ...
        <li><a href="/grtshop/product">Sản phẩm</a> | <a href="/grtshop/coupon">Coupon</a></li>
    </ol>
    <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7">
                        <div class="page-title">                            
                            <h3 style="margin-top: 0;"><i class="fa fa-list-ul" aria-hidden="true"></i> Sản phẩm và coupon đã thích</h3>
                        </div>
                    </div>
