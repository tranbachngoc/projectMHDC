...
<div id="main" class="container-fluid">
    <div class="row">
	    ...
	    <h4 class="page-header text-uppercase" style="margin-top:10px">Thống kê thu nhập thuê kênh</h4>
            <div class="dashboard">
                <!-- ========================== Begin Content ============================ -->                    
                        ...
                        <table class="table table-bordered">
                            <thead style="background:#eee">
                                <tr>
                                    ...
                                    <th class="text-center">Hoa hồng thuê kênh</th>
                                ...
                                foreach ($shop_grt as $keys => $items) {
                                    ...
                                    <?php foreach ($arr_grt[$items->order_saler] as $key => $item) { ?> 
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo $item['shopname'].' ['.$item['shoplink'].']' ?></td>
                                            <td class="text-right"><?php echo number_format($item['total']) ?> đ</td>
                                            <td class="text-center"><?php echo $item['cmss_for_shop'] ?> %</td>
                                            <td class="text-right"><strong class="text-danger"><?php echo number_format($item['doanhthu_shop']) ?> đ</strong></td>
                                        </tr>
                                    <?php 
                                    $total += $item['doanhthu_shop'];
                                    } ?>
                                <?php } ?>
                            </tbody>
                ...
                <?php } else { ?>
                    <div class="alert alert-warning text-center" role="alert">Chưa có dữ liệu thống kê thu nhập thuê kênh.</div>
                <?php } ?>
                <!-- ========================== End Content ============================ -->
            </div>
        </div>
