...
$item_link = getAliasDomain('grtnews/detail/' . $item->not_id . '/' . RemoveSign($item->not_title));
    ...
    <div class="rowtop">        
	    ...
	    <span>
            ...
            <?php else : ?>
                <ul class="more dropdown-menu" aria-labelledby="dLabel">
                    <li>
                        <a href="<?php echo $shopdomain ?>/shop">
                            <i class="azicon icon-store"></i> &nbsp; Đi đến gian hàng
                        </a>          
                    </li>
                    <li>
				...
				<i class="azicon icon-message"></i>&nbsp; Gửi tin nhắn
                        ...
                        <li>
                            <a target="_blank" href="<?php echo $messages ?>">
				<i class="azicon icon-message"></i> &nbsp; Gửi tin nhắn SMS
			    </a>
                        </li>
                    <?php } ?>
		    <li>
		...
		<?php if ($item->not_video_url1) { ?>			
            <div class="embed-responsive embed-responsive-16by9" style="margin-bottom: 1px;">
                <video controls class="embed-responsive-item">
                    ...
                    Trình duyệt của bạn không hỗ trợ chơi video này.
               </video>
            </div>
        <?php } ?> 
        ...
        <div class="rowpro" style="padding: 0 10px">		
            <div class="owl-carousel">
                ...
                foreach ($item->listPro as $k => $value) {                    
                    ...
                    $linktoproduct = getAliasDomain('grtshop/' . $pro_type . '/detail/' . $value->pro_id . '/' . RemoveSign($value->pro_name));
                    ?>
	    ...
	    <?php if($item->not_permission == 1){ ?>
            <span>
                ...
                <ul class="dropdown-menu" aria-labelledby="dLabel2" style="left: 0px; right:0px;">
                    ...
                    <li class="social-share">
                        <div>
                            <a href="javascript:void(0)" onclick="
                                    window.open(
                                            'https://www.facebook.com/sharer/sharer.php?u=<?php echo $item_link . $suffix ?>&amp;app_id=<?php echo app_id ?>',
                            ...
                            <a href="javascript:void(0)" onclick="
                                    window.open(
                                            'https://twitter.com/share?text=<?php echo $item->not_title ?>&amp;url=<?php echo $item_link . $suffix ?>',
                            ...
                            <a href="javascript:void(0)" onclick="
                                    window.open(
                                            'https://plus.google.com/share?url=<?php echo $item_link . $suffix ?>',
                                            'google-share-dialog',
                                            'width=800,height=600');
                                    return false;">
                    ...
                    <li>
                        <a href="javascript:void(0)" onclick="copylink('<?php echo $item_link . $suffix ?>');">
