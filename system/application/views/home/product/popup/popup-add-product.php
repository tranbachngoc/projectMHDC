...
<!-- product basic popup -->
<div class="modal" id="modal-pro-basic">
          ...
          <div class="p20" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-xs-12 control-label">
                  <input class="pro_name" maxlength="100" name="pro_name" type="text" placeholder="Nhập Tên <?php echo $text; ?> (tối đa 100 ký tự)">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-xs-12">
                  <input class="pro_sku" maxlength="35" name="pro_sku" type="text" placeholder="Nhập Mã <?php echo $text; ?> (tối đa 35 ký tự)">
            ...
            <div class="form-group row">
              <div class="col-sm-4 col-xs-12 control-label">
                  <font color="#FF0000"></font> <?php echo $text; ?> nổi bật :
              </div>
              <div class="col-sm-3 col-xs-12 wp10">
            ...
            <div class="form-group row">
              <div class="col-sm-4 col-xs-12 control-label">
                  <font color="#FF0000"></font> <?php echo $text; ?> có khuyến mãi :
              </div>
                  ...
                  <div class="child_saleoff col-sm-12 col-xs-12 wp10 m00 p00 mt10 row" style="display:none;">
                    ...
                    <div class="col-sm-4 col-xs-12 wp10 mb15">
                     ...
                     <div class="col-sm-6 col-xs-12 wp10">
                      <input class="datepicker begin_date_sale" name="begin_date_sale" type="text" placeholder="Ngày bắt đầu">
                    </div>
                    <div class="col-sm-6 col-xs-12 wp10">
                      <input class="datepicker end_date_sale"  name="end_date_sale" type="text" placeholder="Ngày kết thúc">
                    </div>
        ...
        <div class="tab-content">
          ...
          <div class="p20" id="infoProduct" role="tabpanel" aria-labelledby="infoProduct-tab">
                ...
                <!-- <div class="form-group row">
                  ...
                  <div class="col-sm-8 col-xs-12">
                     Khi đăng <?php echo $text; ?> này tức là bạn chấp nhận với phí mua bán của danh mục <?php echo $text; ?> đã chọn ở trên là <span id="fee_cate">0</span>(%).
                  </div>
                </div> -->
          </div>
          <!-- end thông tin cơ bản -->
...
<script id="js-template-basic" type="text/template">
  ...
  <p class="small-text">
    ...
    <span>Mã <?php echo $text; ?>: {{PRO_SKU}}</span>
  </p>
...
<script type="text/javascript">
  ...
  function qcColor() {
    if (!$('#qcColor').is(':checked')) {
      if (!$('#qcSize').is(':checked') && !$('#qcMaterial').is(':checked')) {
        ...
        alert('Bạn phải có 1 qui cách cho <?php echo $text; ?> của bạn!')
      }else {
  ...
  function show_basic(element) {
    ...
    if (data_product.product.pro_saleoff == 1) {
        ...
        if (data_product.product.pro_saleoff_type == 1) {
          ...
          saleoff_percent = parseFloat(data_product.product.pro_saleoff_value)/ 100;
        } 
        ...
        saleoff_day = '<img src="/templates/home/styles/images/svg/flashsale_pink.svg" alt=""> <span>';
        if (diff.days > 0) {
  ...
  function show_qc(element) {
    ...
    if (data_product.pro_qc.length > 0) {
      ...
      if(min_dp_cost > 0){
        ...
        {
          var pro_saleoff_type = $('.pro_saleoff_value').val();
  ...
  var data_product = {
    'product': {
      ...
      'pro_type'        : <?php echo $pro_type; ?>,
      'pro_name'        : '',     // * tên <?php echo $text; ?>
      'pro_sku'         : '',     // * mã <?php echo $text; ?>
      ...
      'pro_hot'       : 0,    // * <?php echo $text; ?> hot
      'pro_weight'      : 0,    // * trọng lượng <?php echo $text; ?>

      'pro_descr'       : '',  // wait
      'pro_keyword'     : '',  // wait
      'pro_hondle'        : 0, // wait

      'pro_saleoff'     : 0,    //  <?php echo $text; ?> có giảm giá
      ...
      'pro_category'      : 0,    // * danh mục <?php echo $text; ?>
      'pro_category_name'      : '',    // tên danh mục <?php echo $text; ?>
      ...
      'pro_attach'      : [],   // <?php echo $text; ?> thường mua kèm
      'pro_attach_temp'      : [],   // <?php echo $text; ?> thường mua kèm tem
    },
  ...
  $( document ).ready(function() {
    ...
          }
      ...
      $('#modal-pro-basic .save-basic').click(function(e){
          ...
          if ($('#modal-pro-basic input.pro_saleoff').is(':checked')) {
            ...
            if (isNaN(Date.parse(begin_date_sale)) || isNaN(Date.parse(end_date_sale)) || begin_date_sale === '' || end_date_sale === '') {
              ...
              e.preventDefault();
              return false;
            } else if(Date.parse(end_date_sale) <= Date.parse(begin_date_sale)){
          ...
          if($.trim(pro_cost) == '')
          {
            $('#modal-pro-basic .error_pro_cost').text('Vui lòng giá <?php echo $text; ?>.');
            $('#modal-pro-basic .error_pro_cost').show();
            $('#modal-pro-basic input.pro_cost').focus();
            error_basic = true;
            e.preventDefault();
            return false;
          } else if (parseInt(pro_cost) == 0) {
            $('#modal-pro-basic .error_pro_cost').text('Giá <?php echo $text; ?> lớn hơn 0.');
            $('#modal-pro-basic .error_pro_cost').show();
            $('#modal-pro-basic input.pro_cost').focus();
            error_basic = true;
            e.preventDefault();
          ...
          {
            $('#modal-pro-basic .error_pro_weight').text('Vui lòng nhập trọng lượng <?php echo $text; ?>.');
            ...
            $('#modal-pro-basic .error_pro_weight').text('Trọng lượng <?php echo $text; ?> lớn hơn 0.');
            $('#modal-pro-basic .error_pro_weight').show();
            $('#modal-pro-basic input.pro_weight').focus();
            error_basic = true;
            e.preventDefault();
          ...
          if($('#modal-pro-basic input.pro_saleoff').is(':checked') == true && ((pro_saleoff_type == 1 && (pro_saleoff_value >= 100 || (giacuoi * (1 - (pro_saleoff_value/100))) < uudai)) || (pro_saleoff_type == 2 && (pro_saleoff_value >= giacuoi || (giacuoi - pro_saleoff_value) < uudai))))
          {
            ...
            if(pro_saleoff_type == 1)
            {
              ...
              else if($('#modal-pro-ctv input[name="apply"]:checked').val() > 0 && (giacuoi * (1 - (pro_saleoff_value/100)) < uudai)){
                alert('Giá khuyến mãi phải lớn hơn ưu đãi hệ thống bán hộ');
                return false;
              }
            }
            ...
            $.ajax({
              ...
              success: function (r) {
                  if (r[1] > 0) {
                      ...
                      str += '<option data-title="" value="0">--Chọn danh mục cho <?php echo $text; ?>--</option>';
                      for (i = 0; i < r[1]; i++) {
      ...
      $('#modal-pro-detail .save-basic').click(function(){
        ...
        if ($.trim(pro_descr) == '')
        {
          $('#modal-pro-detail .error_pro_descr').text('Bạn phải nhập mô tả sản phẩm');
           $('#modal-pro-detail .error_pro_descr').show();
            error_check = true;
        }

        if (error_check == false) {
          $('.add-product-detail').html(pro_detail);
                ...
                if ($.trim(row_cost.val()) == '') {
                  ...
                  if(list_qc.length == 1){
                    ...
                    for(var i = 0; i < list_qc.length; i++){
                      ...
                      {
                        min_ = list_qc.eq(i).find('input.dp_cost').val();
                      }
                    }
                  }
                }
      ...
      $('#popup-image-list').on('shown.bs.modal', function() {
        var length_dark = $('.slider-img-big .darkroom-container').length;
        if(length_dark == 0)
        {
      ...
      $('body').on('click', '#popup-image-list .item_image_img', function(){
                        ...
                        if (file_img_list.length > 0) {
                            ...
                            if (list_default.length > 0) {
                              $.each(list_default, function( key_link, value_link ) {
                                  ...
                                  // Tài fix
                                  $('#popup-image-list .slider-img-small').slick('slickRemove', 0);
                                  // end
                              });
                            }
      ...
      $('.up-product').click(function(){
          ...
          if (error_add_product === false) {
            $('.load-wrapp').show();
              $.ajax({
                url: siteUrl +"product/ajaxAdd",
                method: "POST",
                data: {product: data_product, use_param: <?php echo $use_param; ?>},
                dataType: "json",
                success: function(result) {
                  if (result.error == false) {
                    $('.load-wrapp').hide();
                    alert('Thêm <?php echo $text; ?> thành công');
                    location.reload();
                  }else{
                    alert('Thêm <?php echo $text; ?> thất bại');
                    $('.load-wrapp').hide();
                  }
                },
                error: function(){
      ...
      $('#modal-pro-ctv .save-basic').click(function(e){
          ...
          if (apply_aff > 0) 
          {
              ...
              else  
              {
                ...
                pro_dc_affiliate_value = $(aff_dc_amt).find('.js-aff-dc-value').val();
