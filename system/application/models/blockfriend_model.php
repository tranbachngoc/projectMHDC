...
class Blockuser_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_user_social_blocks");
		$result = $query->result();
		$query->free_result();
		return $result;
	}
    ...
    function add($data){
		...
		$this->db->insert("tbtt_user_social_blocks", $data);
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_user_social_blocks", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_user_social_blocks");
    }
