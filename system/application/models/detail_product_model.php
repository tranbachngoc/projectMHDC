...
#****************************************#
# * @Author:    Bao Tran                 #
# * @Email:     trabaothe@gmail.com      #
# * @Website: 	tranthebao.wordpress.com #
# * @Copyright: 06-2017                  #
#****************************************#
class Detail_product_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_detail_product");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	function add($data)
	{
		return $this->db->insert("tbtt_detail_product", $data);
	}
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_detail_product", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_detail_product");
    }
