...
#****************************************#
# * @Author: tuanflour                   #
# * @Email: tuanflour@icsc.vn        #
# * @Website: http://www.icsc.vn  #
# * @Copyright: 2009 - 2012              #
#****************************************#
class Master_shop_rule_model extends MY_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_master_shop_rule");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	function add($data)
	{
		...
		$this->db->set($data);
		return $this->db->insert("tbtt_master_shop_rule");
	}
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_master_shop_rule", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_master_shop_rule");
    }
}
?>