...
# * @Copyright: 2009 - 2012              #
#****************************************#
class Shop_rule_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_shop_rule");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	function add($data)
	{
		...
		$this->db->set($data);
		return $this->db->insert("tbtt_shop_rule");
	}
	...
	function update($data, $where = "")
	{
		...
		$this->db->set('up_date', 'NOW()',false);
		return $this->db->update("tbtt_shop_rule", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_shop_rule");
    }
}
?>