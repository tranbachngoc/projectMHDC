...
# * @Copyright: 2008 - 2009              #
#****************************************#
class Report_detail_model extends CI_Model
{
    ...
    function get($select = "*", $where = "")
    {
        ...
        #Query
        $query = $this->db->get("tbtt_report_detail");
        $result = $query->row();
        $query->free_result();
        return $result;
    }
    ...
    function add($data)
    {
        ...
        return $this->db->insert("tbtt_report_detail", $data);
    }
    ...
    function update($data, $where = "")
    {
        ...
        return $this->db->update("tbtt_report_detail", $data);
    }

    function delete($value, $field = "rpd_id", $in = true)
    {
        $this->db->cache_delete_all();
        if(!file_exists('system/cache/index.html'))
        {
        ...
        return $this->db->delete("tbtt_report_detail");
    }
}