...
# * @Copyright: 2008 - 2009              #
#****************************************#
class Uprated_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_require_uprated");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	{
		$this->db->set($data);
		return $this->db->insert("tbtt_require_uprated");
	}
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_require_uprated", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_require_uprated");
    }
}