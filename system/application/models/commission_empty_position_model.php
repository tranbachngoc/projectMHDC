...
# * @Copyright: 2008 - 2009              #
#****************************************#
class Commission_empty_position_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_commission_empty_position");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	function add($data)
	{
		return $this->db->insert("tbtt_commission_empty_position", $data);
	}
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_commission_empty_position", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_commission_empty_position");
    }
}