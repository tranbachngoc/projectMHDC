...
class Baokim_model extends CI_Model
{
	...
	private $baokim_url = 'https://www.baokim.vn/payment/customize_payment/product';

	// Mã merchante site 
	private $merchant_id = '3787';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site	
	// Mật khẩu bảo mật
	private $secure_pass = '51b840446efea589'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	function createRequestCart($business,$product_name,$product_price,$product_quantity,$total_amount,$url_detail,$url_success,$url_cancel,$product_description){
		$params = array(
			'business'				=>	strval($business),
			'product_name'			=>	strval($product_name),
			'product_price'			=>	strval($product_price),
			'product_quantity'		=>	strval($product_quantity),
			...
			'product_description'	=>	strtolower($product_description),
		);
		ksort($params);
	...
	public function createRequestUrl($order_id,  $total_amount, $shipping_fee, $tax_fee, $order_description, $url_success, $url_cancel, $url_detail,$business="huynhnhumail@gmail.com")
	{
