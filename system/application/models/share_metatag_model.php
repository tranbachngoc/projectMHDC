...
class Share_metatag_model extends CI_Model
{
    ...
    function get($select = "*", $where = "")
    {
        ...
        #Query
        $query = $this->db->get("tbtt_metatag_share");
        $result = $query->result();
        $query->free_result();
        return $result;
    }
    ...
    function add($data){
        ...
        $this->db->insert("tbtt_metatag_share", $data);
    ...
    function update($data, $where = "")
    {
        ...
        return $this->db->update("tbtt_metatag_share", $data);
    }
    ...
    function delete($value, $field = "id", $in = true)
    {
        ...
        return $this->db->delete("tbtt_metatag_share");
    }
