...
class Shop_customer_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_shop_customer");
		$result = $query->result();
		$query->free_result();
		return $result;
	}
    ...
    function add($data){
		...
		$this->db->insert("tbtt_shop_customer", $data);
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_shop_customer", $data);
	}
	...
	function delete($value, $field = "id", $in = true)
    {
		...
		return $this->db->delete("tbtt_shop_customer");
    }
