...
class Collection_content_image_link_model extends MY_Model
{
    ...
    function __construct()
    {
        parent::__construct();
        $this->select = "*";
        $this->table  = 'tbtt_collection_content_image_links';
    }
    ...
    public function delete_link_in_collection_by($link_id ,$shop_id = 0, $user_id = 0)
    {
        ...
        $sql = 'DELETE tbtt_collection_content_image_links
                FROM tbtt_collection_content_image_links LEFT JOIN tbtt_collection ON tbtt_collection.id = tbtt_collection_content_image_links.collection_id ';
        $where = 'WHERE tbtt_collection_content_image_links.content_image_link_id = '.$link_id;
        if($shop_id){
    ...
    public function link_belong_to_many_collections($link_id, $shop_id = 0, $user_id = 0, $is_owner = false)
    {
        ...
        $where = 'tbtt_collection_content_image_links.content_image_link_id =' .$link_id.  ' AND tbtt_collection.type = ' . COLLECTION_CUSTOMLINK;
        ...
        return $this->gets([
            ...
            'joins'         => [
                [
                    ...
                    'where'     => 'tbtt_collection.id = tbtt_collection_content_image_links.collection_id',
                    'type_join' => 'LEFT'
                ],
            ]
        ]);
