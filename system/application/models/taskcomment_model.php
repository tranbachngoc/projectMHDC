...
class Taskcomment_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_task_comment");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	function add($data)
	{
		return $this->db->insert("tbtt_task_comment", $data);
	}
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_task_comment", $data);
	}

	function delete($value_1, $field_1 = "id", $value_2 = "", $field_2 = "", $in = true)
	{
		if($in == true)
		{
		...
		return $this->db->delete("tbtt_task_comment");
	}
}