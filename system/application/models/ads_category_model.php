...
# * @Copyright: 2008 - 2009              #
#****************************************#
class Ads_category_model extends CI_Model
{
	...
	function get($select = "*", $where = "")
	{
		...
		#Query
		$query = $this->db->get("tbtt_ads_category");
		$result = $query->row();
		$query->free_result();
		return $result;
	}
	...
	function add($data)
	{
		...
		return $this->db->insert("tbtt_ads_category", $data);
	}
	...
	function update($data, $where = "")
	{
		...
		return $this->db->update("tbtt_ads_category", $data);
	}
	...
	function delete($value, $field = "cat_id", $in = true)
    {
		...
		return $this->db->delete("tbtt_ads_category");
    }
}