...
if($_POST)
{
    ...
    $user_Lastname       = filter_var($_POST["user_lastname"], FILTER_SANITIZE_EMAIL);
    ...
    'X-Mailer: PHP/' . phpversion();
        ...
        // send mail
    $sentMail = @mail($to_Email, $subject, 'Subscribe using flatpack form, Name: '. $user_Name .'   -- Number: '. $user_Number .'   -- Email: '.$user_Email' -- Last name: '. $userLastname , $headers);
