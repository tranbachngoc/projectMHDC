...
if($_POST)
{
    ...
    if( !isset($_POST["user_name"]) || !isset($_POST["user_number"]) || !isset($_POST["user_email"]) || !isset($_POST["user_country"])  )
    {
    ...
    'X-Mailer: PHP/' . phpversion();
        ...
        // send mail
    $sentMail = @mail($to_Email, $subject, 'Subscribe using flatpack form, Name: '. $user_Name .'   -- Number: '. $user_Number .' -- Country: '. $user_Country .'   -- Email: '.$user_Email , $headers);
