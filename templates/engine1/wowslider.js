...
function wowsliderPreloader(n, d) {
    ...
    if (e("img", l).length) {
        ...
        l.find(">a").each(function(w, v) {
            if (k[w]) {
                v.href = "#";
                if (!k[w].thumb) {
                    k[w].thumb = k[w].src.replace(/\/images\/([^\/]+)$/, "/tooltips/$1")
                }
                if (/^\./.test(k[w].thumb)) {
    ...
    var c = e("<div class='ws_logo'></div>").hide().appendTo(n.find(".ws_images"));
    var u;
    var m;
