...
document.write('<img id="dhtmlpointer" src="http://clients.icsc.vn/18giay/templates/home/images/arrow_tootips.gif">'); //write out pointer image
...
function ddrivetip_image_1(obj,id){
if (ns6||ie){
tipobj.style.width="auto"//Chieu Rong Cua Hinh La Auto
tipobj.style.border="1px solid #0F8CB5"//Kieu Cua Khung
tipobj.style.backgroundColor='#FFFFFF';
tipobj.innerHTML='<div class="pro_name">'+jQuery('#name-'+id).val()+'</div><div class="pro_cost">Giá: <span style="color:#FF0000;font-weight:bold;">'+jQuery('#cost-'+id).val()+'</span>&nbsp;&nbsp;<span>(Lượt xem: '+jQuery('#view-'+id).val()+')</span></div><div class="pro_del">Tại gian hàng:<span style="font-weight:bold; color:#2460D7">'+jQuery('#shop-'+id).val()+'</span></div><div class="pro_del">Vị trí:<span style="font-weight:bold;">'+jQuery('#pos-'+id).val()+'</span>&nbsp;&nbsp;Ngày tham gia:<span style="font-weight:bold;">'+jQuery('#date-'+id).val()+'</span></div><div style="text-align:center"><img class="my_img" src="'+jQuery(obj).attr("src")+'"/></div';
enabletip=true;
return false
};;
}
