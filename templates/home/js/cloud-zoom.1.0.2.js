...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
				...
				if(widthScreen >1024){ w = 500;}else{w = 400;}
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:225px;top:-8px;width:%2px;height:300px;background-image:url(\'%4\');z-index:99;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');
        ...
        this.each(function () {
            ...
            if (jQuery(this).is('.cloud-zoom')) {
                ...
                if (jQuery(this).parent().attr('id') != 'wrap') {
                    jQuery(this).wrap('<div id="wrap" style="top:0px;z-index:9999;position:relative;"></div>');
                }
