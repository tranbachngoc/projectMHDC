! function() {
    ...
    element.id = "darkroom-icons", element.style.height = 0, element.style.width = 0, element.style.position = "absolute", element.style.visibility = "hidden", element.innerHTML = '<!-- inject:svg --><svg xmlns="http://www.w3.org/2000/svg"><symbol id="close" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/><path d="M0 0h24v24H0z" fill="none"/></symbol><symbol id="crop" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M17 15h2V7c0-1.1-.9-2-2-2H9v2h8v8zM7 17V1H5v4H1v2h4v10c0 1.1.9 2 2 2h10v4h2v-4h4v-2H7z"/></symbol><symbol id="done" viewBox="0 0 48 48" id=".3675341205703093" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#000" stroke-width="2" stroke-miterlimit="10"><path d="M12.682 0v35.623h34.713M.605 11.775h12.077M18.482 11.775h18.885M36.438 11.697v23.926M36.438 41.49V48"/></g></symbol><symbol id="redo" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7l-3.6 3.6z"/></symbol><symbol id="rotate-left" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#000" stroke-width="2" stroke-miterlimit="10"><path d="M1.291 22.097h24.904V47H1.291zM20.834 9.239l-7.716-.522L13.643 1"/><path d="M13.531 8.055c3.449-2.516 7.698-4 12.294-4 11.533 0 20.884 9.35 20.884 20.884 0 4.628-1.505 8.903-4.054 12.364"/></g></symbol><symbol id="rotate-right" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M15.55 5.55L11 1v3.07C7.06 4.56 4 7.92 4 12s3.05 7.44 7 7.93v-2.02c-2.84-.48-5-2.94-5-5.91s2.16-5.43 5-5.91V10l4.55-4.45zM19.93 11c-.17-1.39-.72-2.73-1.62-3.89l-1.42 1.42c.54.75.88 1.6 1.02 2.47h2.02zM13 17.9v2.02c1.39-.17 2.74-.71 3.9-1.61l-1.44-1.44c-.75.54-1.59.89-2.46 1.03zm3.89-2.42l1.42 1.41c.9-1.16 1.45-2.5 1.62-3.89h-2.02c-.14.87-.48 1.72-1.02 2.48z"/></symbol><symbol id="save" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M17 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4zm-5 16c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm3-10H5V5h10v4z"/></symbol><symbol id="undo" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#000" stroke-width="2" stroke-miterlimit="10"><path d="M47 20.116l-5.105 4.449-4.455-5.098"/><path d="M34.496 39.798a20.386 20.386 0 0 1-13.023 4.675C10.167 44.473 1 35.308 1 24 1 12.693 10.167 3.527 21.473 3.527c11.307 0 20.473 9.166 20.473 20.473"/></g></symbol></svg><!-- endinject -->', document.body.appendChild(element)
}(),
function() {
    "use strict";
...
function() {
    ...
    Darkroom.plugins.rotate = Darkroom.Plugin.extend({
        initialize: function() {
            ...
            this.leftButton.addEventListener("click", this.rotateLeft.bind(this)), this.rightButton.addEventListener("click", this.rotateRight.bind(this))
        },
        rotateLeft: function() {
            this.rotate(-90)
        },
    ...
    Darkroom.plugins.crop = Darkroom.Plugin.extend({
        ...
        requireFocus: function() {
            this.cropZone = new CropZone({
                ...
                lockRotation: !1,
                hasRotatingPoint: !1
            }), null !== this.options.ratio && this.cropZone.set("lockUniScaling", !0), this.darkroom.canvas.add(this.cropZone), this.darkroom.canvas.defaultCursor = "default", this.cropButton.active(!0), this.okButton.hide(!1), this.cancelButton.hide(!1)
        },
