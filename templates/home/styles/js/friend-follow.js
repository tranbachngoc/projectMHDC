$( document ).ready(function() {
        ...
        else
        {
          if(result.confirmFriend == false){
            ...
            if(result.follow == false){
              ...
              $('.btn-follow-'+id_user).html('<img class="hasfriend-'+id_user+' hasfriend show" src="/templates/home/styles/images/svg/banbe.svg" alt="Bạn bè"><span class="text"> Bạn bè</span>');
              $('.btn-follow-'+id_user).attr('class','btn unfriend btn-friend-'+id_user);
            }
          }
        }
      },
  ...
  //Follow profile
  $('body').on('click', '.js-follow-user-profile', function(){
    $('.load-wrapp').show();
    $('#modal_mess .modal-body p').html('');
    var id_user = $(this).attr('data-id');
    var _this = $(this);
      ...
      success:function(result){
        ...
        else
        {
          if(result.addFriend == false){
            ...
            _this.find('span').text('Đã gửi yêu cầu');
            _this.find('img').attr('src', '/templates/home/styles/images/svg/daguiloimoi.svg');
  ...
  $('body').on('click', '.unfriend, .js-cancelfollow-user', function(){
    var id_user = $(this).attr('data-id');
      ...
      success:function(result){
        ...
        else
        {
          if(result.cancelFriend == false){
            ...
            $('.item-status .btn-friend-'+id_user).html('<img src="/templates/home/styles/images/svg/ketban.svg">');
