$(document).ready(function() {
    ...
    $(".js-submit-form-upload-image").submit(function( event ) {
        ...
        $.ajax({
            url: DOMAIN_SHOP + 'shop/update/banner',
            type: 'post',
            data: formData,
            dataType: "json",
            contentType: false,
    ...
    $(document).on('click', '.js-button-save-cover', function (event) {
        ...
        $.ajax({
            url: DOMAIN_SHOP + 'shop/update/banner_save',
            type: 'POST',
            dataType: 'json',
            data: crop_position,
            success: function (response) {
    ...
    $(".js-submit-form-upload-avatar").submit(function( event ) {
        ...
        var formData = new FormData($(this)[0]);
        $.ajax({
            url: DOMAIN_SHOP + 'shop/update/logo',
            type: 'post',
            data: formData,
            dataType: "json",
            contentType: false,
    ...
    $(document).on('click', '.js_btn-avatar-save', function (event) {
        ...
        console.log(crop_position);
        // return;
        $('.js_avatar-modal-sm').modal('hide');
        $._loading('show', 'body');
        $.ajax({
            url: DOMAIN_SHOP + 'shop/update/logo_save',
            type: 'POST',
            dataType: 'json',
            data: crop_position,
            success: function (response) {
    ...
    var mc;
    function demoMain () {
        mc = $('.cropper-image .js_cropper-avatar');
        mc.croppie({
